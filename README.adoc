...
This repository is an a collection of asciidoc markup files converted to a ruleset (http://rules.expgame.com[EXP most recent, window="_blank", rel="noopener noreferrer"]) using Antoradocs.
