...
C:\Users\mobil\Documents\EXP_Documents\modules\ROOT\images\all_those_rolls..drawio.svg


:art: all_those_rolls..drawio.svg
:width: 600px
:snark: This is an SVG test
:artist: HM
:date: 2023
:license: CC 4.0
:description: test.
...
There is no trouble with changing PSTR to STR. 
This attribute change is comprehensible. 
The challenge is what is MSTR changed too. 
...
* Physical Strength (PSTR)-> Strength (STR)
* Mental Strength (MSTR) -> Mind (MND)
...
* BP (Bonus Proficient) -> *Skilled*
* BNP (Bonus Non Proficient) -> *Raw*
* MR (Maximum Roll) -> *Max*
