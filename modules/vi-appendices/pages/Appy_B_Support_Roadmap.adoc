...
== Nomenclature Change Proposal

Proposed rework of the Combat Table and its ancillary components. Goal is to reduce complexity and improve understanding.
...
* Type E -> *Sotto*: Semi auto *Shooting* 2 attacks per unit
