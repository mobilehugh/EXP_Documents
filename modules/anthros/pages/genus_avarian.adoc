...
Some avarians from popular culture are https://en.wikipedia.org/wiki/Ekek[ekek,window=_blank, rel="noopener noreferrer"], https://en.wikipedia.org/wiki/Karura[kakura,window=_blank, rel="noopener noreferrer"], https://en.wikipedia.org/wiki/Garuda[garuda,window=_blank, rel="noopener noreferrer"], and https://en.wikipedia.org/wiki/Thoth[Thoth,window=_blank, rel="noopener noreferrer"].
