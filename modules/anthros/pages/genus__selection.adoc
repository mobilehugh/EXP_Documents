...
include::anthros:partial$anthro_genus_selection.adoc[]
...
A player has generated a persona with the following attributes:  AWE 6, CHA 15, CON 17, DEX 9, INT 14, MND 12, STR 6 AND HPM 42.
The player can choose from the following anthro types avarian, florian, humanoid, insectoid, purestrain and rodentia.

include::anthros:partial$anthro_genus_selection_example.adoc[]
