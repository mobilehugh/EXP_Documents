...
. xref:anthros:generate_attributes.adoc[Generate Attributes,window=_blank]
. xref:anthros:genus_selection.adoc[Select Type,window=_blank]
. xref:anthros:generate_hit_points.adoc[Hit Points,window=_blank]
.. xref:anthros:generate_hit_points.adoc#_damage_system_shock_dss[System Shock, title="DSS is optional",window=_blank]
.. xref:anthros:generate_hit_points.adoc#_recovery_roll_rec[Recovery, title="REC is optional",window=_blank]
...
. xref:roll_playing_system:CH08_Vocations_.adoc[Vocation,window=_blank]
. xref:roll_playing_system:CH10_Incidentals.adoc[Incidentals,window=_blank]
. xref:hardware:An_index_hardware.adoc[TOY Check,window=_blank]
