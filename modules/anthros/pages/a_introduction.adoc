...
. xref:anthro:generate_attributes.adoc[Generate Attributes,window=_blank]
...
. xref:athros:age.adoc[Age,window=_blank]
. xref:CH04_Anthros_Size.adoc[Size,window=_blank]
. xref:CH04_Anthros_Mutations.adoc[Mutation Check,window=_blank]
. xref:role_playing_system:CH08_Vocations_.adoc[Vocation,window=_blank]
. xref:role_playing_system:CH10_Incidentals.adoc[Incidentals,window=_blank]
