...
The anthro delivery checklist is ordered for convenience, and decision making.
For example, mutation check precedes vocations as mutations can heavily impact vocation choice.
The checklist represents a full implementation of an anthro persona with all its complexity and challenges.
The delivery checklist is a tool not a rule.
Just use the steps you need to have fun. 

. xref:appendices:printables.adoc[Get Anthro Persona Record, window=_blank, rel="noopener noreferrer"]
.. Save a tree and use https://xournalpp.github.io/[Xournal, window=_blank, rel="noopener noreferrer"]
. xref:anthros:generate_attributes.adoc[Attributes, window=_blank, rel="noopener noreferrer"]
. xref:anthros:generate_hit_points.adoc[Hit Points, window=_blank, rel="noopener noreferrer"]
. xref:anthros:genus__selection.adoc[Select Genus, window=_blank, rel="noopener noreferrer"]
. xref:anthros:age.adoc[Age, window=_blank, rel="noopener noreferrer"]
. xref:anthros:anthro_size.adoc[Size, window=_blank, rel="noopener noreferrer"]
. xref:anthros:mutation_check.adoc[Mutation Check, window=_blank, rel="noopener noreferrer"]
. xref:vocations:a_introduction.adoc[Vocation, window=_blank, rel="noopener noreferrer"]
. xref:anthros:attack_table[Attack Table, window=_blank, rel="noopener noreferrer"]
. xref:anthros:movement_rate.adoc[Movement Rate, window=_blank, rel="noopener noreferrer"]
. xref:anthros:defence_rating.adoc[Defence Rating, window=_blank, rel="noopener noreferrer"]
. xref:anthros:wate_allowance.adoc[Wate Allowance, window=_blank, rel="noopener noreferrer"]
. xref:hardware:startifacts.adoc[TOY Check, window= _blank]
. xref:roll_playing_system:incidentals.adoc[Incidentals, window=_blank, rel="noopener noreferrer"]
. xref:anthros:name.adoc[Name, window=_blank, rel="noopener noreferrer"]
. *Have fun!*
