...
The delivery checklist is a tool no a rule.
Just use the steps you need to have fun. 

. xref:ROOT:attachment$anthro_record_v7.pdf[Download Anthro Record Sheet,window=_blank]
...
. xref:anthros:defence_rating.adoc[Defence Rating,window=_blank]
. xref:anthros:wate_allowance.adoc[Wate Allowance,window=_blank]
