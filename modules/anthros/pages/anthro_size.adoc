...
* xref:anthros:anthro_hite_calc.adoc[Calculate Hite, window=_blank, rel="noopener noreferrer"]
* xref:anthros:anthro_wate_calc.adoc[Calculate Wate, window=_blank, rel="noopener noreferrer"]
