...
.List of Genera
* xref:anthros:genus_aquarian.adoc[Aquarian, window=_blank, rel="noopener noreferrer"]
* xref:anthros:genus_avarian.adoc[Avarian, window=_blank, rel="noopener noreferrer"]
* xref:anthros:genus_canine.adoc[Canine, window=_blank, rel="noopener noreferrer"]
* xref:anthros:genus_equine.adoc[Equine, window=_blank, rel="noopener noreferrer"]
* xref:anthros:genus_feline.adoc[Feline, window=_blank, rel="noopener noreferrer"]
* xref:anthros:genus_florian.adoc[Florian, window=_blank, rel="noopener noreferrer"]
* xref:anthros:genus_humanoid.adoc[Humanoid, window=_blank, rel="noopener noreferrer"]
* xref:anthros:genus_insectoid.adoc[Insectoid, window=_blank, rel="noopener noreferrer"]
* xref:anthros:genus_purestrain.adoc[Pure Strain, window=_blank, rel="noopener noreferrer"]
* xref:anthros:genus_reptilian.adoc[Reptilian, window=_blank, rel="noopener noreferrer"]
* xref:anthros:genus_rodentia.adoc[Rodentia, window=_blank, rel="noopener noreferrer"]
* xref:anthros:genus_ursidae.adoc[Ursidae, window=_blank, rel="noopener noreferrer"]
