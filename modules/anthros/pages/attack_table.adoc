...
This section covers the details of how to calculate a attack table for an anthro persona.
The anthro attack table is the same as a vocation-based attack table.
Aliens and robots have their attack tables, but they will use the attack table found here if either has a vocation.
