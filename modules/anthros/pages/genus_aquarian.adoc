...
3+<|xref:anthros:anthro_size.adoc[Calculate Hite and Wate,window=_blank, rel="noopener noreferrer"]
...
Some aquarians from popular culture are https://en.wikipedia.org/wiki/Merman[mermaids,window=_blank, rel="noopener noreferrer"], https://en.wikipedia.org/wiki/Yacuruna[yakaruna, window=_blank, rel="noopener noreferrer"], https://en.wikipedia.org/wiki/Abe_Sapien[Abe Sapien,window=_blank, rel="noopener noreferrer"], https://en.wikipedia.org/wiki/Creature_from_the_Black_Lagoon[Gill Man,window=_blank, rel="noopener noreferrer"], and https://youtu.be/xEIpzBPUjEo[Adam, window=_blank, rel="noopener noreferrer"].
