...
There is a more detailed discussion found under xref:combat:defence_rating.adoc[Defence Rating,window=_blank, rel="noopener noreferrer"] in the tactical combat rules. 
...
Jump to xref:hardware:mundane_equipment.adoc#_armour[Mundane Armour,window=_blank, rel="noopener noreferrer"] to learn about norm tech armour types
Jump to xref:hardware:armour.adoc[Armour,window=_blank, rel="noopener noreferrer"] for artifact armour. 