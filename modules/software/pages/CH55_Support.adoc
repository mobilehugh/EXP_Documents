...
Second, the player and referee decide if the fuel is for a vehicle or a spacecraft.
...
One would expect that large spacecraft would have spaceports for filling up.
...
=== Spacecraft Computer Programmes
...
Whether the programme is an AI programme, a vocation programme or a spacecraft programme, it works in any inorganic computer brain.
