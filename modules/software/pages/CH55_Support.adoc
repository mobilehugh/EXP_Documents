...
. xref:software:CH56_Tech_Level.adoc[Tech Level,window=_blank] (optional) 
...
For more info jump to xref:wetware:CH69_AI.adoc[Autonomous Intelligence,window=_blank]
...
If the referee chooses to have a completely random spare part jump to -> xref:hardware:An_index_hardware.adoc#_toy_type[Toy Type,window=_blank]. 
