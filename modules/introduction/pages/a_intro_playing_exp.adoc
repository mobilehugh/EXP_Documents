...
You xref:introduction:a_intro_playing_exp.adoc[play EXP with dice and real people,window=_blank] all sitting in the same room. 
Enjoy.
...
There are more exhaustive, and exhausting, xref:appendices:Appy_A_Glossaries.adoc[Glossaries,window=_blank] in the appendix. 
...
Mind::
This is an attribute of the persona.
Mind represents will power, resilience and psionic connection.
