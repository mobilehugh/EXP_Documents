...
For downloadable PDF persona records jump to xref:appendices:printables.adoc[Persona Record Sheets,window=_blank, rel="noopener noreferrer"]
...
In other role-playing games, an expedition is called a party or horde.
...
By design, role-playing games are a social endeavour. 
