...
* You like details
* xref:roll_playing_system:a_introduction.adoc[Take me there NOW!, window=_blank, rel="noopener noreferrer"]

== Role-Playing System
The Role-Playing System uses the theatrical combat rules and the xref:role_playing_system:four_dee_two_mechanic.adoc[4D2 Mechanic, window=_blank, rel="noopener noreferrer"].
...
* xref:role_playing_system:a_introduction.adoc[Take me there NOW!, window=_blank, rel="noopener noreferrer"]
