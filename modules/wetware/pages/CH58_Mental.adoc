...
. <<_psionic_mutation_attribute_explanations,Psionic Mutation Attribute Explanations>>
...
For combined attacks the players may need consult the xref:roll_playing_system:CH16_Special_Rolls_Asshole.adoc[Sphincter Dice,window=_blank].
...
Jump to xref:roll_playing_system:CH13_Health.adoc#_death[Death,window=_blank] for more info about persona death.
...
include::ROOT:partial$a_defect_disclaimer.adoc[]
...
If a fight does break out between expedition members, it will always be xref:roll_playing_system:CH37_Non_Lethal_Combat.adoc[Non-Lethal Combat,window=_blank].
...
Levitation cannot overcome a failed gravity system in xref:roll_playing_system:CH38_Space_Vehicle_Combat.adoc[Space Vehicle Combat,window=_blank]. 
...
If there is discussion about whether an object has enough 'metal' to be attracted consult the xref:roll_playing_system:CH16_Special_Rolls_Asshole.adoc[Sphincter Dice,window=_blank].
...
If intense discussions arise remember that xref:roll_playing_system:CH16_Special_Rolls_Asshole.adoc[Sphincter Dice,window=_blank] can help answer the unanswerable. 
...
If an active discussion erupts the players can consult the xref:roll_playing_system:CH16_Special_Rolls_Asshole.adoc[Sphincter Dice,window=_blank].
...
The horrendous specifics of suffocation are covered under xref:roll_playing_system:CH19_Terrain.adoc#_atmosphere[Terrain,window=_blank].
...
If an active discussion arises regarding whether, or not, something is metallic consult the xref:roll_playing_system:CH16_Special_Rolls_Asshole.adoc[Sphincter Dice,window=_blank]
...
The xref:roll_playing_system:CH04_Anthros_Move.adoc[Movement Rate,window=_blank] table is consulted replacing Dexterity with the mutant's Mind. 
...
Regular xref:roll_playing_system:CH19_Terrain.adoc#_falling[Falling,window=_blank] damage applies.
...
When throwing random objects at targets the most complicated ruleset to use is xref:roll_playing_system:CH31_Robotic_Combat.adoc#_ramming[Robotic Ramming,window=_blank].
...
Using the xref:roll_playing_system:CH18_Encumbrance.adoc#_encumbrance_levels[Movement Rate,window=_blank] rules the mutant must be un-encumbered.
...
The mutant uses her MND instead of her DEX on the xref:roll_playing_system:CH04_Anthros_Move.adoc[Movement Rate,window=_blank] table.
...
// todo correct telekinetic flight too fucking fast
...
She can lift ten times her xref:roll_playing_system:CH18_Encumbrance.adoc[Wate Allowance,window=_blank] using her MND instead of STR.
