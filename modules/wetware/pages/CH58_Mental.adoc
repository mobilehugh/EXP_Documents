...
The xref:roll_playing_system:CH03_AttributesDEX.adoc#_moverate[Movement Rate,window=_blank] table is consulted replacing Dexterity with the mutant's Mind. 
...
Using the xref:roll_playing_system:CH18_Encumbrance.adoc[Encumbrance,window=_blank] rules the mutant must be un-encumbered.
...
The mutant uses her MND instead of her DEX on the xref:roll_playing_system:CH03_AttributesDEX.adoc#_moverate[Movement Rate,window=_blank] table.
