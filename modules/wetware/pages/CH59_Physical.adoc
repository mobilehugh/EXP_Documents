...
The plume of smoke can have a strong xref:aliens:biology.adoc#_aroma[Aroma,window=_blank] and distinct xref:software:CH55_Appearances.adoc#_colour_your_whirled[Colour,window=_blank].
