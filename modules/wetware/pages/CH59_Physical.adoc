...
If you need a random xref:software:CH55_Appearances.adoc#_colour_your_whirled[Colour,window=_blank].
...
The player can choose the colour (not black) or generate it at xref:software:CH55_Appearances.adoc#_colour_your_whirled[Colour,window=_blank].
...
The beam is her head's size and usually has a distinct xref:software:CH55_Appearances.adoc#_colour_your_whirled[Colour,window=_blank].
...
Or the player can let the dice decide by jumping to xref:software:CH55_Appearances.adoc#_colour_your_whirled[Colour,window=_blank].
...
The plume of smoke can have a strong xref:roll_playing_system:CH06_Aliens_12_Biology.adoc#_aroma[Aroma,window=_blank] and distinct xref:software:CH55_Appearances.adoc#_colour_your_whirled[Colour,window=_blank].
