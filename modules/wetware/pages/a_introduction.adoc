...
=== xref:wetware:phenomics.adoc#_defect_mutations[Phenomic Uncombat,window=_blank]
...
=== xref:wetware:psionics.adoc#_defective_mutations[Psionic Uncombat,window=_blank]
