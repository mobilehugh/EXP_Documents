...
=== xref:wetware:phenomics.adoc#_combat_mutations[Combat,window=_blank]

=== xref:wetware:phenomics.adoc#_uncombat_mutations[Uncombat,window=_blank]

=== xref:wetware:phenomics.adoc#_defect_mutations[Defective,window=_blank]
...
=== xref:wetware:psionics.adoc#_combat_mutations[Combat,window=_blank]

=== xref:wetware:psionics.adoc#_uncombat_mutations[Uncombat,window=_blank]

=== xref:wetware:psionics.adoc#_defective_mutations[Defective,window=_blank]
