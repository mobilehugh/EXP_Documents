...
Psionic mutations function through the thinkspace of the xref:appendices:Appy_C_Mythos_Generic.adoc#_the_spaces[Spaces,window=_blank].
...
* Purestrains cannot have a psionic mutation defect
