...
The player can choose the colour, or generate it at xref:hardware:appearance.adoc#_colour_your_whirled[Colour,window=_blank].
...
If you want a raw roll (combat, uncombat and defects) xref:wetware:phenomics.adoc#_phenomic_mutations_list[jump here,window=_blank].
