...
Mutants may have certain personality traits because oftheir unique nature.
...
If a robot decay table is being used simply move the bot down two levels on the decay table.
