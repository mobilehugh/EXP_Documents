...
It may seem very provincial and humanocentric to have all the races bipedal, earthbound humanoids.
...
//table 4.1 
include::ROOT:partial$anthro_attributes_table.adoc
...
The racial minimums do not apply and the racial maximums are firmly in plac.
