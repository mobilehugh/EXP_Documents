...
For a description of leet speak jump to https://en.wikipedia.org/wiki/Leet[Leet Speak Wikipedia,window=_blank, rel="noopener noreferrer"]

If some inspiration is needed jump to xref:referee_personas:rp_story_cues.adoc[Referee Persona Story Cues,window=_blank, rel="noopener noreferrer"]
