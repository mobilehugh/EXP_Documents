...
We can thank https://en.wikipedia.org/wiki/Isaac_Asimov[Asimov,window=_blank, rel="noopener noreferrer"] and our mundane terran fears of robots for the persistence of this belief.
There are no https://en.wikipedia.org/wiki/Three_Laws_of_Robotics[Three Laws of Robotics,window=_blank, rel="noopener noreferrer"] in EXP.
