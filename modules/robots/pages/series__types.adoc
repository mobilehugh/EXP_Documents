...
* xref:robots:series_android.adoc[A-Android,window=_blank, rel="noopener noreferrer"]
* xref:robots:series_combot.adoc[C-Combot,window=_blank, rel="noopener noreferrer"]
* xref:robots:series_datalyzer.adoc[D-Datalyzer,window=_blank, rel="noopener noreferrer"]
* xref:robots:series_exploration.adoc[E-Explorations,window=_blank, rel="noopener noreferrer"]
* xref:robots:series_hobbot.adoc[H-Hobbot,window=_blank, rel="noopener noreferrer"]
* xref:robots:series_industrial.adoc[I-Industrial,window=_blank, rel="noopener noreferrer"]
* xref:robots:series_janitorial.adoc[J-Janitorial,window=_blank, rel="noopener noreferrer"]
* xref:robots:series_maintenance.adoc[M-Maintenance,window=_blank, rel="noopener noreferrer"]
* xref:robots:series_policing.adoc[P-Policing,window=_blank, rel="noopener noreferrer"]
* xref:robots:series_rescue.adoc[R-Rescue,window=_blank, rel="noopener noreferrer"]
* xref:robots:series_social.adoc[S-Social,window=_blank, rel="noopener noreferrer"]
* xref:robots:series_transport.adoc[T-Transport,window=_blank, rel="noopener noreferrer"]
* xref:robots:series_veterinarian.adoc[V-Veterinarian,window=_blank, rel="noopener noreferrer"]
...
For more information, jump to xref:robots:damage_and_demolition.adoc[Robot Hit Points,window=_blank, rel="noopener noreferrer"].
...
For detailed information jump to xref:robots:adaptability.adoc[Adaptability,window=_blank, rel="noopener noreferrer"].
...
For more information jump to xref:robots:size.adoc[Size,window=_blank, rel="noopener noreferrer"].
...
For more info jump to to xref:robots:value.adoc[Value,window=_blank, rel="noopener noreferrer"].
