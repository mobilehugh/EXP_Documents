...
For more info about robot combat jump to xref:combat:combat_and_robots.adoc[Robotic Combat,window=_blank, rel="noopener noreferrer"].

.*Offensive Peripherals Decode*
* Nil: No offensive peripheral. 
...
The referee and players should limit the amount and lethality of robotic offensive peripherals for campaign balance and fun.
...
This base level of ramming is not a robotic offensive peripheral. 
...
Jump to xref:robots:peripherals_defensive.adoc[Defensive Peripherals,window=_blank, rel="noopener noreferrer"].
...
For more info jump to xref:hardware:armaments.adoc#_electro_weapon[Electro Weapon,window=_blank, rel="noopener noreferrer"].

Inertia::
This Strike attack increases its density on contact.
The inertia weapon does triple the weapon damage plus ten hit points.
For more info jump to xref:hardware:armaments.adoc#_inertia_weapon[Inertia Weapon,window=_blank, rel="noopener noreferrer"].
...
For more info jump to xref:hardware:armaments.adoc#_stun_weapons[Stun Weapon,window=_blank, rel="noopener noreferrer"].
...
For more info jump to xref:hardware:armaments.adoc#_vibro_weapon[Vibro Weapon,window=_blank, rel="noopener noreferrer"].
...
To determine the aerosol type jump to xref:hardware:aerosols.adoc[Aerosols,window=_blank, rel="noopener noreferrer"].
...
To determine the bomb type jump to to xref:hardware:bombs.adoc[Bombs,window=_blank, rel="noopener noreferrer"].
...
If the player rolls less than her constitution score on 1d100, the attack has a xref:wetware:phenomics.adoc#_combat_mutations[Phenomic Mutation,window=_blank, rel="noopener noreferrer"] effect.
If the 1d100 roll is greater than her constitution score, the attack has a xref:wetware:psionics.adoc#_combat_mutations[Psionic Mutation,window=_blank, rel="noopener noreferrer"] effect.

=== Disregard Fabricator
This offensive peripheral disengages any connection to the persona's fabricator type.
