...
If the retrieval robot is rescuing a persona against her will, the robot must grapple the __rescuee__.
...
For more info on this weapon jump to xref:hardware:armaments.adoc#_web_gun[Web Gun,window=_blank, rel="noopener noreferrer"].
