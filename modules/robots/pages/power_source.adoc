...
For a detailed explanations of the power sources jump to xref:appendices:generic_mythos.adoc#_energy_and_power[Energy Sources,window=_blank, rel="noopener noreferrer"]
