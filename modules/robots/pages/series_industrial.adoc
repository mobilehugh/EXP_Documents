...
The player must win a xref:robots:control_factor.adoc[Control Factor,window=_blank, rel="noopener noreferrer"] roll to drop an object successfully.

Dropping things leads to them falling. 
For more info about sudden stops jump to xref:uncombat:terrains.adoc#_falling[Falling,window=_blank, rel="noopener noreferrer"].
