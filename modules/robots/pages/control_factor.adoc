...
== Make the Roll
The player always rolls a 1d100 and adds her control factor to the roll.
...
=== Control Factor Roll
.1d100 + Control Factor >= Difficulty
****
With a 12 CF  the 1d100 roll must be 12 or higher to beat difficulty 24. 
****
