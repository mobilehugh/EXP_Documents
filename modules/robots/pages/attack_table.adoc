...
A Vocationized weapon weilding robot fabricates an attack using the xref:anthros:attack_table[Anthro Attack Table,window=_blank, rel="noopener noreferrer"].
