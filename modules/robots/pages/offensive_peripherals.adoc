...
For more info about robot combat jump to xref:roll_playing_system:CH31_Robotic_Combat.adoc[Robotic Combat,window=_blank].
...
Jump to xref:roll_playing_system:CH05_Robots_Z_Defensive.adoc[Defensive Systems,window=_blank].
...
To determine the aerosol type jump to xref:hardware:CH43_Aerosols.adoc[Aerosols,window=_blank].
