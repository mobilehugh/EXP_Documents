...
For more info jump to xref:uncombat:experience.adoc[Experience,window=_blank, rel="noopener noreferrer"]

.*Sources of Robot EXPS*
* <<_damage,Damage>>
* <<_combat,Combat>>
* <<_denial_of_service,Denial of Service>>
* xref:uncombat:experience.adoc#_experience_for_role_playing[Experience for Role-Playing,window=_blank, rel="noopener noreferrer"]
