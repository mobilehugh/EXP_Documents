...
|01-03
|Vocation Computer
|From xref:hardware:devices.adoc#_computers[Computers,window=_blank]. 

|04-05
|Cybernetic Part
|See xref:wetware:phenomics.adoc#_mechanical_insertion[Mechanical insertion,window=_blank]. No defects.
...
|19-21
|Detectors
|From xref:hardware:devices.adoc#_detectors[Detectors,window=_blank]. 
...
|57-59
|Psionic Mutation
|Consult xref:wetware:psionics.adoc[Psionic Mutations,window=_blank]. No defect.

|60-72
|Miscellaneous Device
|From xref:hardware:devices.adoc[Misc. Equipment,window=_blank]. 
...
|See xref:hardware:pharma.adoc[Pharma,window=_blank]

|82-84
|Phenomic Mutation
|See xref:wetware:phenomics.adoc[Phenomic Mutations,window=_blank]. No defects.
