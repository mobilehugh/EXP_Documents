...
Size::
Alien personas have an attribute unique to them called size.
...
Personas can earn the MSTR attribute by completing an MSTR testing storyline laid out by the referee.
MSTR can be assigned by suffering and surviving a mortal wound in combat.
