...
=== Skill Learning
.Outcome = +10 (Immaculate) or +9 (Wondrous) success
****
...
In hand-to-hand combat, a player can use PSTR as a shift.
...
The Tactical Combat System calls these Type A attacks.
...
The Tactical Combat System calls these Type B attacks.
...
The Tactical Combat System calls these Type C attacks.
...
The Tactical Combat System calls these Type AOE attacks.
