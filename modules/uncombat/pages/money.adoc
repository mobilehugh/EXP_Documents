...
https://en.wikipedia.org/wiki/Loonie[Canadian Loonie,window=_blank, rel="noopener noreferrer"].
...
The players may prefer to have dice rolling from xref:uncombat:negotiations.adoc#_social_interaction_tables[Social Interactions,window=_blank, rel="noopener noreferrer"] replace ing barter.
