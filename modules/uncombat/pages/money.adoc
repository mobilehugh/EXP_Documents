...
A bartering system does conjure up an infinite supply of roleplaying situations.
The players may prefer to have dice rolling from xref:uncombat:negotiations.adoc#_social_interaction_tables[Social Interactions,window=_blank] replace ing barter.
