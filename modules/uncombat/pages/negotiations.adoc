...
The players cannot use interactions to replace roleplaying between player and referee personas.
...
The referee should always defer to roleplaying leads from the players. 
...
The most important modifier is how the players choose to roleplay.
