...
[quote, Edgar A. Guest (kinda)]
____
She was right, dead right, as she sped along +
She is just as dead as if she'd been wrong.
____

Driving involves the manual control of any inatmo vehicle.
An inatmo vehicle is any vehicle that is not a spacecraft.
The central assumption is that a persona controls the vehicle as the vehicle's driver.
This section is not for autonomous vehicles or vehicles driven by transportation robots.  
This section is for the tactical driving of vehicles from xref:hardware:vehicles.adoc[Vehicles,window=_blank].
...
:description: Feline quadruped staring at box shaped hover car.
include::ROOT:partial$articulate.adoc[]

[discrete]
== TLDR
.Handling + Expertise * 2 + Level > Difficulty (maneuver + speed)= Success
****
3rd level nomad (DEX 10) with driving 3 is driving a handling class of 7 is driving straight at 100 kmh +
1d100 plus 16 competency must beat 30 (maneuver 12 and speed 18) or lose control 
****
...
== How to Check
In short the player must roll higher than the difficulty on the 1d100 roll.
If they fail the persona has lost control of the vehicle.
...
== Difficulty
The difficulty of a driving task roll is determined by speed and nature of the maneuver.
Driving straight ahead at normal speeds will be very low difficulty.
Turning a sharp corner at high speeds will be very high difficulty.

=== Maneuver
The maneuver determines the level of the difficulty.
Speed must always be taken into account, but the core difficulty is determined by the maneuver. 

include::uncombat:partial$driving_maneuvers.adoc[]
...
Handling is the handling class of vehicle.
Some vehicles are designed to make handling them safer.

==== Speed Penalty
.Speed penalty  (DD) = (speed  h/u - Dexterity - Handling) 
****
Note a negative speed penalty may act as a bonus.
Driving at 25 h/u with a 10 DEX in car with handling 5 is a +10 DD penalty. +
****
...
.Competency = Knowledge * 2 + Aptitude + Handling 
****
Handling level 5 and driving skill 2 gives a driving competency of 7.
****

=== Knowledge
If the persona has any expertise in driving they get to include this in competency.
At the moment there is no interest that is applied to driving checks.
...
Driving aptitude is different from regular task roll aptitude in that it is a straight value.
There is no increasing value of aptitude at higher levels.
EXPS level 4 adds 4 to the competency and level 12 adds 12 to the competency when making a driving task roll.
...
Many referees will offer task roll bonuses for good roleplaying descriptions.

== Success 
If the difficulty of the task is exceeded, or equalled, the persona reaps the reward of the successful task.
In the case of a driving check the expedition continues on their reckless (literally) way.


== Failure
If the player rolls less than the difficulty of the driving task she has lost control of the vehicle.
Loss of control does not automatically result in collision or disaster for the expedition in the vehicle.
The referee may make a qualitative decision that the failed driving task has a particular storyful result.
However, the table may choose to let the dice decide.


=== Loss of Control
To arrive here, the player has lost both her driving roll and her rally roll.
The loss of control could be just plain unlucky, but more often speed is to blame.
...
If the vehicle is traveling at 10 h/u and loses control for three units, the vehicle will travel 30 hexes out of control.
...
A 50% deceleration indicates that the vehicle will be traveling at half its original speed.
...
.Deceleration = 1d6-1 times 10%
****
A 1d6 result of 1 =  0% deceleration. + 
A 1d6 result of 3 = 20% deceleration.
****
...
:art: Figure_facet_the_music.png
:width: 400px
...
include::uncombat:partial$driving_loss_of_control.adoc[]


== Collision
Losing control of a vehicle __may__ result in a collision.
...
:date: 1991
:license: CC BY-SA 4.0
:description: Three futuristic hover vehicles in a tussle on a futuristic highway.
include::ROOT:partial$articulate.adoc[]
...
include::uncombat:partial$inatmo_collision_damage.adoc[]
...
A vehicle traveling 35 h/u would do 6d10 to a pedestrian.
...
Vehicle damage resembles robot, spacecraft, and artifact damage.
...
== Hex Mat
Vehicles travel at tremendous speeds.
