...
This section is for the tactical driving of vehicles from xref:hardware:vehicles.adoc[Vehicles,window=_blank, rel="noopener noreferrer"].
...
A xref:uncombat:sphincter_rolls.adoc[Sphincter Roll,window=_blank, rel="noopener noreferrer"] is required to determine if there is a fire complication.
