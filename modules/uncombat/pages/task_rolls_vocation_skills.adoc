...
If the persona needs to bake a cake after drinking a https://en.wikipedia.org/wiki/Zaphod_Beeblebrox#Pan-Galactic_Gargle_Blaster[PGGB], then a task roll is part of the fun.
