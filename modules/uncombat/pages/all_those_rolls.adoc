...
WARNING: Tasks are in flux 1d100 may be replaced by a 1d20 this under dev.
...
Crits are so import they have their own section, jump to xref:roll_playing_system:CH16_Special_Rolls_Critical.adoc[Critical Checks,window=_blank].
