...
Attribute rolls have there own subsection, jump there xref:CH16_Special_Rolls_Attributes.adoc[Attribute Rolls]
...
For more about saving rolls jump here xref:CH16_Special_Rolls_Saves.adoc[Saving Rolls,window=_blank]
...
Challenge rolls with attributes are covered with excoriating detail elsewhere, jump there xref:CH16_Special_Rolls_Attributes.adoc[Attribute Rolls]
