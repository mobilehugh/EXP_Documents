...
In previous versions of EXP there were many  decision tables.
...
For more info about rolling 1d1000 jump here xref:roll_playing_system:kilo_die_mechanic.adoc[Jump here.,window=_blank, rel="noopener noreferrer"]
...
The target roll gets higher the more complex the task.
Jump to xref:uncombat:task_rolls.adoc[Task Rolls,window=_blank, rel="noopener noreferrer"]
...
Jump to xref:uncombat:driving.adoc[Driving,window=_blank, rel="noopener noreferrer"]
...
For more about saving rolls jump here xref:uncombat:saving_rolls.adoc[Saving Rolls,window=_blank, rel="noopener noreferrer"]
...
Jump to xref:robots:control_factor.adoc[Control Factor,window=_blank, rel="noopener noreferrer"].
...
For knock out info about DSS jump to xref:anthros:generate_hit_points.adoc#_system_shock[Damage System Shock,window=_blank, rel="noopener noreferrer"]
...
For more info about DSS jump to xref:anthros:generate_hit_points.adoc#_recovery[Damage System Shock,window=_blank, rel="noopener noreferrer"]
...
Jump there xref:combat:initiative.adoc[Initiative,window=_blank, rel="noopener noreferrer"]
...
Jump there xref:combat:ambush.adoc[Ambush,window=_blank, rel="noopener noreferrer"]
...
Jump there xref:uncombat:critical_checks.adoc[Critical Checks,window=_blank, rel="noopener noreferrer"].
...
For more details about these rolls jump to xref:uncombat:sphincter_rolls.adoc[Sphincter Roll,window=_blank, rel="noopener noreferrer"]

== Yummy Rolls
Jelly, sushi and bread rolls are yummy. 
EXP does not recommend jelly rolls when playing with hex mats and minis. 
For more information about these tasty treats jump to https://en.wikipedia.org/wiki/Swiss_roll[Jelly Rolls,window=_blank, rel="noopener noreferrer"].
