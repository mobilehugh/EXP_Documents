...
Creative players like to build things that don't exist. 
...
Referee personas can be included in the research team.
...
There is are two mechanics with competencies of 14 and 12, a mercenary with a competency 16, and a nothing with competency 4. 
All four players get to roll with a project competency of 30 (mechanic's 14 and mercenary's 16) to try and beat the difficulty.
It is possible that the mechanics and the merccenary fail their rolls, but the nothing wins the roll.
This would be a successful project, and a storyful outcome.  
...
== Make the Roll
Every player gets to roll 1d100 plus the research team's competency. 
If any payer beats the difficulty the project is a success
