...
However modifying a weapon to increase it's damage, or improving the speed of a vehicle is a reasonable project. 
...
A four players would get to roll with a bonus of 30 to try and beat the difficulty.
...
The expedition wants to upgrade their spacecraft special drive to double it's power level.
...
Rolling a natural 99 or 100 allows the player to add an additional 1d100 to their task roll. 
