...
[discrete]
== TLDR
.Interests + Expertise * 2 + Aptitude > Difficulty = Success
****
...
A mechanic that wants to use the easy (12) knite skill of kirlian sight should just be told no.
...
The more roleplaying is integrated into the roll playing system, the more fun the play is.
...
The roleplaying bonuses should be small since roleplaying has its benefit.
...
If the player is extremely close to being successful the referee may allow the player to go for an ing bonus. 
...
If spie with competency 21 decided to help out the merc and mech the bonus would remain 27.
However three players can roll but the bonus is still only 27.
This is a too many cooks spoil the broth limitation on the bonuses. 
...
For more byzantine complicated shenanigans these, jump to xref:uncombat:task_rolls_projects.adoc[Project]
