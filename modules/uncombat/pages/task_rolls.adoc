...
[discrete]
== TLDR
.1d100 + Interests + Expertise + Experience > Difficulty = Success
****
...
A research team is put together for a project that may take a long time with multiple attempts to complete (like cloning).

== Competency
The competency is a collective term for all the bonuses that the player adds to her 1d100 roll.
...
There are limitations to this bonus.
...
If the player is extremely close to being successful the referee may allow the player to go for an roll playing bonus. 
