...
NOTE: *Diffulty is shortened to DD for historical reasons and is an homage to Degree of Difficulty.*
...
A task team is for quick tasks where players can create a team competency that is larger than the sinlge persona.
...
=== Success 
If the difficulty of the task is equalled or beat the persona reaps the reward of the successful task. 
...
The consequences of a failure may be simple and apparaent. 
