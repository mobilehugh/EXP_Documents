...
The possible number of tasks is infinite, and there is no complete list of due to space reasons. 
...
[discrete]
== TLDR
.1d100 + Interests + Expertise * Level + Experience > Difficulty = Success
****
Task difficulty is 42: 1 Research interest, 2 Herbivore expertise, and 3 EXPS levels +
...
Competency is a combination of the persona's knowledge and levels.
...
Expertise is more specific, but contributes more to roll when applicable.
...
.Competency = Interests + Expertise*Level + Experience 
...
For each interest the player adds 1 point 1d100 roll.
...
An are of expertise is more focused than an an area of interest. 
It is quite possible that an area of expertise will not be applicable to a task.
When expertise aligns with a task the player can add their EXPS level for each point of expertise.
So a 1st level biologist with herbivore-2 could add 2 to her task roll, but at 3rd leve she can add 6. 

=== Experience
The persona's EXPS level impacts the task roll. 
The player can always add their player's experience bonus to the task roll. 
...
With this bonus comes limitations.
A high level veterinarian would not be able to carry out spie tasks like assassination. 
...
== Make the Roll
The player rolls the 1d100, adds in their competency and extra bonuses and hopes to beat the task difficulty. 
...
Competency is 69 (6 + 36 + 27), bonus 11 (DEX) for a plus of 80 to the 1d100 roll. 
