...
Ideally, personas figure out what equipment does by roleplaying.
...
Consider it a *descriptive mini-game* used to replace a process that is too complex to roleplay.
Role-playing has an impact on the flowchart.
The more roleplaying the players invest, the less likely they will blow themselves up.
