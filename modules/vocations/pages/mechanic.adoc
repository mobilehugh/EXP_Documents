...
If your table is using attribute determined vocations a biologist must have a total INT and DEX greater than or equal to 18. 
...
== Crafts
The mechanics crafts (gifts) are tasks where the persona automatically succeeds.
...
Mechanics earn experience points for completing procedures rolls (80 EXPS per DD) and role-playing within their vocation. 
