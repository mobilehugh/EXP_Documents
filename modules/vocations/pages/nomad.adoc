...
A nomads survival abilities may have appeared out of necessity due to some scarcity situation.
...
If the campaign has vocation attribute selection nomads require a combined Awareness and Constitution greater than 18. 
...
== Interests
Interests are broad areas of knowledge that can assist the nomad in performance of tasks. 
...
== Expertise
Expertise represents areas of knowledge that are narrower than an interest. 
While an interest is broad and easily applied an expertise is more focused and less likely to be applicable to a task.
However, when an expertise is applicable is benefits the persona much more on their task roll. 

At startup the persona gets one area of expertise per interest. 
So a nomad with Domesticate 2 and Survival 1 would get 2 rolls on the Domesticate expertise table and 1 roll on the Survival expertise table.
...
Nomads can separate their expertise. 
Maybe overlap is a better description.
If the nomad were doing a task in a Frigid forest biome she would get interest 3 (biomes - 3) and expertise 4 (Frigid - 2 and Forest - 2). 

== Experience
Nomads get half experience for combat and EXPS for successful task rolls.
