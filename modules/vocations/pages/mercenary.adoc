...
If your game requires attribute requirements for vocations a mercenary's HPM must beat 40. 
...
If the mercenary wants to avoid an ambush or organize a room entry, she calls on her tactical interests.
...
NOTE: Each combat expertise gives to +20 on her attack roll.
...
Some of the tactical expertises give attack roll bonuses.
...
For example, the submersed expertise will assist the persona in any underwater tasks.
...
They benefit from organization for ease of task use, and direct attack table benefit
...
=== List
This is a list of the tasks from the compendium, but in alphabetical order. 
