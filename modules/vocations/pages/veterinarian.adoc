...
== Interests
The interests of a Veterinarian indicate broad areas of knowledge.
...
A Veterinarian with a 12 INT would get 4 rolls on the Veterinarian Interest Table.
...
The player makes one roll on the expertise table per interest.
So if the persona has 2 interests in treatment she would get 2 rolls on the Treatment Expertise Table.
The persona acquires a new expertise at each new experience level.
...
== Gifts
Gifts are the inherent talents that define the persona as a Veterinarian.
The player does not have to win a task roll to succeed with a gift.

include::vocations:partial$veterinarian_gifts.adoc[]
...
The persona can have special tasks called gifts that the persona automatically succeeds at. 
...
The minimal equipment required by a Veterinarian is her smile and little black bag. 
...
Stasis Bag (18)::
    Safely put stuff into a stasis bag. 
