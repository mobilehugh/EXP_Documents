...
Knowing how to sharpen a knife is knowledge, actually sharpening the knife is a task. 
...
A biologist may be interested in taxonomy (which will help identify aliens), or culture (which will help them understand a cultural). 
...
Initially some tasks will be out of reach as the player could not beat the difficulty easily. 
...
These tasks may become tasks that the persona has or be disposable one offs. 
