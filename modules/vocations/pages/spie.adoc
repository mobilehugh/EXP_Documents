...
Expertise represents deeper and narrower area of knowledge. 
...
=== Infiltration
Expertise in getting into where one should not be. 
...
== Experience
The benefits of increasing experience levels are more tricks, improved task results, and improved combat skills. 
