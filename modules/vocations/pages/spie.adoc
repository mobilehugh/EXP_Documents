...
The spie can gather expertise with weapons or field expertise.
...
Attack Bonus::
The player uses the tasked Strike attack on the attack roll.
...
== Tricks
Spie tricks (gifts) are tasks that the player does not need to make a task roll for. 
