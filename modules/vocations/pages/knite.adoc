...
The referee should understand xref:appendices:generic_mythos.adoc#_the_spaces[The Spaces,window=_blank, rel="noopener noreferrer"] and xref:appendices:generic_mythos.adoc#_kirlian_energy[Kirlian Energy,window=_blank, rel="noopener noreferrer"] and how these impact the Knite vocation.
