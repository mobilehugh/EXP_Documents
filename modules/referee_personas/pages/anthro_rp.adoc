...
The anthro genus is generalis, as in a mutt for canines. 
...
Anthro canon fodder are minions, soldiers, and security staff.
...
include::referee_personas:partial$anthro_age_categories.adoc[]
...
All are optional. 
For setting up story cues for this referee persona jump to xref:referee_personas:rp_story_cues.adoc[Story Cues].
...
To generate a danger number for this persona jump to xref:referee_personas:rp_combat_ratio.adoc[Combat Ratio].
