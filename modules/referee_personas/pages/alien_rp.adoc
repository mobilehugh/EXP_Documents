...
Download the bare bones PDF (75K) at xref:appendices:printables.adoc[Alien Persona Record, window=_blank, rel="noopener noreferrer"]
...
include::aliens:partial$alien_size_cat_to_wate.adoc[]

== Hite

include::aliens:partial$alien_size_cat_to_hite.adoc[]
...
For more details about alien shape, jump to Detailed explanation exist at xref:aliens:alien_shape.adoc[Alien Shape,window=_blank, rel="noopener noreferrer"].
...
The referee can generate a random colour from the xref:referee_personas:rp_story_cues.adoc#_colour[Giant Colour Table,window=_blank, rel="noopener noreferrer"]. 
...
More detail is available at xref:aliens:movement.adoc[Alien Movement,window=_blank, rel="noopener noreferrer"]
...
To determine the evolutation jump to xref:wetware:psionics.adoc[Psionic Mutations,window=_blank, rel="noopener noreferrer"].
...
To determine the evolutation jump to xref:wetware:phenomics.adoc[Phenomic Mutations,window=_blank, rel="noopener noreferrer"].

== Life Span
Life expectancy is defining feature of organic life forms.
The alien life span is measured in mundane terran years.
The life span of an alien can range from 1 year (short) to 100000 years (long).
Extremely short, or extremely long, life spans are covered 

include::referee_personas:partial$alien_rp_life_span.adoc[]

=== Short Life
The referee may choose for the alien to have a very short life span. 
The referee persona alien may ascribed a short life span when rolling on the Alien RP Life Span Table.
Extremely short life spans __should__ influence the alien RP's biology and society.
Short-lived species often depend on large numbers of offspring requiring minimal energy exertion.
This reproductive approach is called progeny over prodigy.

The shortest possible life span is 10 minutes. 

[NOTE]
====
Only Minute, Tiny and Small aliens should have very short life spans. 
Re-roll on the Alien RP Life Span Table if the alien it too enormous to reproduce every few minutes. 
====

include::referee_personas:partial$alien_rp_short_life_spans.adoc[]

Extremely short life spans can generate issues when calculating life stages. 
If an alien's life span is only 1 minute the referee will likely need to convert the time unit to seconds.
It will be much easier to calculate percentages of from 60 seconds than from 1 minute.

=== Long Life
The referee may choose for the alien to have a very long span.
Extremely long life spans __should__ influence the alien RP's biology and society.
...
Extremely long life spans range from 10000 to 20 millions years. 
The abbreviations of cent (100 years) and mill (1000 years) are used for easier table renders. 

include::referee_personas:partial$alien_rp_long_life_spans.adoc[]
...
For a detailed explanation of alien attack tables jump to xref:aliens:attack_table.adoc[Alien Attack Table,window=_blank, rel="noopener noreferrer"].
...
For a refresher on the implications of alien society jump to xref:aliens:society.adoc[Alien Society,window=_blank, rel="noopener noreferrer"].
...
For a refresher on the implications of alien tool usage to xref:aliens:society.adoc[Alien Society,window=_blank, rel="noopener noreferrer"].
...
For Startifacts jump to xref:hardware:startifacts.adoc[Startifacts,window=_blank, rel="noopener noreferrer"]
...
For alien, naming shenanigans jump to xref:aliens:name.adoc[Alien Name,window=_blank, rel="noopener noreferrer"].
