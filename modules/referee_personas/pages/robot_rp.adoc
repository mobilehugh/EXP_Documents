...
Download the bare bones PDF (75K) at xref:appendices:printables.adoc[Robot Persona Record, window=_blank, rel="noopener noreferrer"]
...
For more information about the implications of the fabricator type jump to xref:robots:fabricator.adoc[Robot Fabricator,window=_blank, rel="noopener noreferrer"].
...
Typical size categories include: Tiny, Small, Medium, Large and Gigantic. 
There are some atypical robot sizes that really should only be referee personas.
...
=== Colossal
Any robot with a wate of 4200 kg or more has a chance of becoming a colossal machine.
The chance of the robot becoming a colossal machine is 1 in 6 (1d6).
...
However, in regards to ramming, colossal machines can increase their ramming ratio to 12 (versus 4).

NOTE: Colossal robots were formerly referred to as Mighty Machines.
...
=== Hite Wate Lookup Table

include::referee_personas:partial$rp_robot_hite_wate_lookup.adoc[]
...
For more information about carry stuff, jump to xref:uncombat:encumbrance.adoc[Encumbrance,window=_blank, rel="noopener noreferrer"].
...
For more info about robot ramming, ram your way over to xref:robots:peripherals_offensive.adoc#_ramming[Robot Ramming,window=_blank, rel="noopener noreferrer"].
...
For details about these attacks jump to  xref:robots:peripherals_offensive.adoc#_attack_table_one[Attack Table One,window=_blank, rel="noopener noreferrer"].
...
For details about these attacks jump to  xref:robots:peripherals_offensive.adoc#_attack_table_two[Attack Table Two,window=_blank, rel="noopener noreferrer"].
...
For details about these attacks jump to  xref:robots:peripherals_offensive.adoc#_attack_table_three[Attack Table Three,window=_blank, rel="noopener noreferrer"].
...
For details about these attacks jump to  xref:robots:peripherals_offensive.adoc#_attack_table_four[Attack Table Four,window=_blank, rel="noopener noreferrer"].
...
For more detailed explanations jump to xref:robots:peripherals_defensive.adoc[Defensive Peripherals,window=_blank, rel="noopener noreferrer"].
...
For more detailed explanations jump to xref:robots:peripherals_uncombat.adoc[Peripheral Systems,window=_blank, rel="noopener noreferrer"].
...
For more details jump to xref:robots:control_factor.adoc[Control Factor,window=_blank, rel="noopener noreferrer"].
...
== Appearance
The robot appearance is entirely up to the player running the persona. 
Following are some elements to help with generating an appearance. 
...
For more info and the effects of altering tech levels, jump to xref:hardware:tech_level.adoc[Tech Level,window=_blank, rel="noopener noreferrer"].
...
For general info about attack tables, jump to xref:combat:attack_table_details.adoc[Attack Tables,window=_blank, rel="noopener noreferrer"] in tactical combat.
For a detailed explanation of the outline below jump to xref:robots:attack_table.adoc[Robot Attack Table,window=_blank, rel="noopener noreferrer"].
...
For the vocation based attack table, jump to xref:anthros:attack_table[Anthro attack table,window=_blank, rel="noopener noreferrer"].
...
For more detailed information, jump to xref:robots:power_source.adoc[Power Source,window=_blank, rel="noopener noreferrer"].
...
For more detailed information, jump to xref:robots:sensors.adoc[Sensors,window=_blank, rel="noopener noreferrer"].

include::robots:partial$sensor_types.adoc[]

=== Locomotion
Robot locomotion allows the RP to get anywhere she can fit.
For more detailed information, jump to xref:robots:locomotion.adoc[Locomotion,window=_blank, rel="noopener noreferrer"].
...
For more details on naming shenanigans, jump to xref:robots:name.adoc[Robot Name,window=_blank, rel="noopener noreferrer"].

== Story Cues
There are all manner of story cues that the referee may wish to generate.
All are optional. 
For setting up story cues for this referee persona jump to xref:referee_personas:rp_story_cues.adoc[Story Cues,window=_blank, rel="noopener noreferrer"].
...
To generate a danger number for this persona jump to xref:referee_personas:rp_combat_ratio.adoc[Combat Ratio,,window=_blank, rel="noopener noreferrer"].
