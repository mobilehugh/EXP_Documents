...
This will require a build tool called https://docs.antora.org/antora/latest/[Antoradocs, window="_blank", rel="noopener noreferrer"].
The ruleset lives on Github at https://github.com/mobilehugh/EXP_Documents[EXP Documents, window="_blank", rel="noopener noreferrer"].
...
This will require an up to date install of https://www.python.org/downloads/[Python, window="_blank", rel="noopener noreferrer"].
The tool set lives on Github at https://github.com/mobilehugh/EXP_Game_Tools[EXP Game Tools, window="_blank", rel="noopener noreferrer"].
...
The website https://kilodie.expgame.com[kilo-die, window="_blank", rel="noopener noreferrer"] has what you need. 
...
The website https://4d2.expgame.com[4D2, window="_blank", rel="noopener noreferrer"] has what you need.
...
.*Playing EXP Online*
* https://shmeppy.com[Shmeppy for Maps, window="_blank", rel="noopener noreferrer"]
* https://rolz.org[Rolls for Dice Rolling, chat and persona records, window="_blank", rel="noopener noreferrer"]
* https://zoom.us[Zoom for Voice and video chat, window="_blank", rel="noopener noreferrer"]
...
.*These should work*
* https://foundryvtt.com[Foundry - For the devs!, window="_blank", rel="noopener noreferrer"]
* https://roll20.net[Roll20 - For their cash!, window="_blank", rel="noopener noreferrer"]
* https://www.rptools.net/[RPTools - For the FOSS!, window="_blank", rel="noopener noreferrer"]
...
|https://www.rptools.net/[RPTools, window="_blank", rel="noopener noreferrer"]
|Yes
|Yes
|FOSS!


|http://roll20.net[Roll20, window="_blank", rel="noopener noreferrer"]
|Yes
|Yes
|Apple of VTTs

|http://foundryvtt.net[Foundry, window="_blank", rel="noopener noreferrer"]
|Yes
|Yes
|Dev friendly. User unfriendly

|http://shmeppy.com[Shmeppy, window="_blank", rel="noopener noreferrer"]
|No
|No
|Lo Fi Maps.

|https://www.owlbear.rodeo/[Owlbear, window="_blank", rel="noopener noreferrer"]
|No
|Yes
|Easy onboarding

|https://lets-role.com/[Lets Role, window="_blank", rel="noopener noreferrer"]
|Yes
|Yes
|
