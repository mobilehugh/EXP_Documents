...
=== EXP Rule Set
The rule set allows players to build a static HTML website with all the rules and silliness on their local machine.
This will require a build tool called https://docs.antora.org/antora/latest/[Antoradocs].
The rule set lives on Github at https://github.com/mobilehugh/EXP_Documents[EXP Documents].
