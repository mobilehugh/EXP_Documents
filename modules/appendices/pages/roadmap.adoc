...
Progress is actively being worked at this moment.
...
* improv communication tools within rules
* high roll FTW
...
// how to tell story as in a storey modules\roll_playing_system


== Version 7.x (this version)
Active version as of 14-jan-2024.
This will be the first version as a 0.5 full time developer.
A detailed progress description is available at (http://expgame.com[expgame.com]).
A repository of progress is maintained at (http://expgame.com[expgame.com]).
...
Mind is the crucial attribute powering psionic mutations and psionic events. 
____
...
== PROPOSAL: Attack Table Nomenclature Simplification
Proposed rework of the Attack Table and its ancillary components. 
...
.*Proposed Changes to Attack Table*
