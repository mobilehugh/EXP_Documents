...
.*Generic Mythos*
* time and chronovores hideaways, teleport, time stop and planal hiders.
...
* VTT (virtual tabletop) world integration.
* appendiceal add ons 
** Alien Arena
** Space Opera
** Postapocalypso
...
* community building
* VTT (virtual tabletop) rule integration.
* images on or off 
...
A TTRPG or RPG 2.0 is a tabletop RPG designed for computer support from the ground up.
====
