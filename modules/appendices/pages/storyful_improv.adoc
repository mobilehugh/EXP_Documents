...
For the last 30 years EXP tables (referee and players) have been polluted with improv comedians.
So EXP development has grown hand in hand with improv comedy development. 
The style of improv comedy can be found online at https://learnimprov.com[learnimprov.com].
...
To be creative folks need to know that they are safe. 
Creativity is hampered by prejudgement.
There are ample safety tools in the https://www.dramadice.com/gm-tips/safety-tools-for-tabletop-rpgs/[TTRPG space].
The improv space uses the following approach:

====
We intentionally avoid sexist, racist, homophobic and transphobic tropes. 
In a broader sense we do not challenges those things that people cannot change about themselves. 
When improvising these elements will come up. 
...
We do not bring a fully built stone outhouse as an offer.
...
NOTE: We stopped using accept and "yes and" more than 15 years ago. Not all offers need be accepted, but they need to be acknowledged. 
