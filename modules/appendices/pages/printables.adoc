...
|xref:ROOT:attachment$robot_record_v7.pdf[Robot Record v7]
|PDF
|123k
...
|xref:ROOT:attachment$theme.yml[theme for PDF]
|YML
|600b

|xref:ROOT:attachment$svg.zip[SVGs for PDF]
|SVGs
|1.6k
