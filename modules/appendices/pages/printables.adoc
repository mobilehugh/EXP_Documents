...
.*Latest PDFs*
[width="90%",cols="<2,<3",frame="all", stripes="even"]
|===
...
|xref:ROOT:attachment$robot_record_2025_0408.pdf[Robot Record, window="_blank"]
|PDF, letter sized, portrait
...
|xref:ROOT:attachment$adoc_to_pdf_2025_0408.zip[Build your own zip, window="_blank"]
