...
Try the open source PDF tool https://xournalpp.github.io/[Xournal].
...
|xref:ROOT:attachment$anthro_record_v7.pdf[anthro_record_v7.pdf]
|Latest PDF for player persona record

|xref:ROOT:attachment$alien_record_v7.pdf[alien_record_v7.pdf]
|Latest PDF for player persona record

|xref:ROOT:attachment$robot_record_v7.pdf[robot_record_v7.pdf]
|Latest PDF for player persona record

2+^|Support PDFs

|xref:ROOT:attachment$campaign_sheet_v7.pdf[campaign_sheet_v7.pdf]
|PDF page for keeping campaign notes off of persona record

|xref:ROOT:attachment$role_playing_one_pager_v7.pdf[4d2_mechanic_v70.pdf]
...
|xref:ROOT:attachment$theme.yml[theme.yml]
|Config css for asciidoc-pdf

|xref:ROOT:attachment$svg.zip[svg.zip]
|Zip of SVGs needed for asciidoc-pdf

|xref:ROOT:attachment$anthro_record_v7.adoc[anthro_record_v7.adoc]
|asciidoc file to make PDF from asciidoc-pdf

|xref:ROOT:attachment$alien_record_v7.adoc[alien_record_v7.adoc]
|asciidoc file to make PDF from asciidoc-pdf
...
|xref:ROOT:attachment$exp_game_v401.pdf[exp_game_v401.pdf]
|32M PDF of EXP v4 from 1993

|xref:ROOT:attachment$anthro_record_sheet_v5.pdf[anthro_record_sheet_v5.pdf]
|PDF of EXP v5 persona record 2010

|xref:ROOT:attachment$robot_record_v5.pdf[robot_record_v5.pdf]
|PDF of EXP v5 persona record 2010

|xref:ROOT:attachment$alien_record_sheet_v5.pdf[alien_record_sheet_v5.pdf]
|PDF of EXP v5 persona record 2010

|xref:ROOT:attachment$toy_record_v5.pdf[toy_record_v5.pdf]
|PDF of EXP v5 toy record 2010

|xref:ROOT:attachment$4d2_mechanic_v61.pdf[4d2_mechanic_v61.pdf]
