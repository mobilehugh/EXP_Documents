...
|xref:ROOT:attachment$robot_portrait_2026_0326.pdf[Robot Record, window="_blank"]
|PDF, letter sized, portrait
...
|xref:ROOT:attachment$adoc_to_pdf_2026_0228.zip[Build your own zip, window="_blank"]
