...
|xref:ROOT:attachment$anthro_portrait_2025_1008.pdf[Anthro Record, window="_blank", rel="noopener noreferrer"]
|PDF, letter sized, portrait

|xref:ROOT:attachment$alien_portrait_2025_1008.pdf[Alien Record, window="_blank", rel="noopener noreferrer"]
|PDF, letter sized, portrait

|xref:ROOT:attachment$robot_portrait_2026_0326.pdf[Robot Record, window="_blank", rel="noopener noreferrer"]
|PDF, letter sized, portrait
...
|xref:ROOT:attachment$note_sheet_2025_1008.pdf[Note Taking Sheet, window="_blank", rel="noopener noreferrer"]
...
|xref:ROOT:attachment$role_playing_one_pager_v7.pdf[Role-Playing Game (one pager), window="_blank", rel="noopener noreferrer"]
|Role-Playing system, PDF, letter sized, portrait

2+^|Build your own

|xref:ROOT:attachment$adoc_to_pdf_2026_0228.zip[Build your own zip, window="_blank", rel="noopener noreferrer"]
...
File the file at https://rules.expgame.com/appendices/printables.html[Printables at EXP Game, window="_blank", rel="noopener noreferrer"]
...
.. https://docs.asciidoctor.org/pdf-converter/latest/install/[asciidoctor install instructions, window="_blank", rel="noopener noreferrer"]
. download and unzip folder adoc_to_pdf_yyyy_mmdd.zip
. navigate to the created folder (adoc_to_pdf_yyyy_mmdd)
...
. https://docs.asciidoctor.org/asciidoc/latest/[how to asciidoc, window="_blank", rel="noopener noreferrer"]
...
|xref:ROOT:attachment$exp_game_v401.pdf[exp_game_v401.pdf, window="_blank", rel="noopener noreferrer"]
|32M PDF of EXP v4 from (1993)

|xref:ROOT:attachment$anthro_record_sheet_v5.pdf[anthro_record_sheet_v5.pdf, window="_blank", rel="noopener noreferrer"]
|PDF of EXP v5 anthro record (2010)

|xref:ROOT:attachment$robot_record_v5.pdf[robot_record_v5.pdf, window="_blank", rel="noopener noreferrer"]
|PDF of EXP v5 robot record (2010)

|xref:ROOT:attachment$alien_record_sheet_v5.pdf[alien_record_sheet_v5.pdf, window="_blank", rel="noopener noreferrer"]
|PDF of EXP v5 alien record (2010)

|xref:ROOT:attachment$toy_record_v5.pdf[toy_record_v5.pdf, window="_blank", rel="noopener noreferrer"]
|PDF of EXP v5 toy record (2010)

|xref:ROOT:attachment$4d2_mechanic_v61.pdf[4d2_mechanic_v61.pdf, window="_blank", rel="noopener noreferrer"]
|Theatrical system one pager (2020)

|xref:ROOT:attachment$anthro_record_v7.pdf[anthro_record_v7.pdf, window="_blank", rel="noopener noreferrer"]
|PDF for Anthro record v7 from (2024)

|xref:ROOT:attachment$alien_record_v7.pdf[alien_record_v7.pdf, window="_blank", rel="noopener noreferrer"]
|PDF for Alien record v7 from (2024)

|xref:ROOT:attachment$robot_record_v7.pdf[robot_record_v7.pdf, window="_blank", rel="noopener noreferrer"]
|PDF for Robot record v7 from (2024)

|xref:ROOT:attachment$anthro_record_2025_0114.pdf[anthro_record_2025_0114.pdf, window="_blank", rel="noopener noreferrer"]
|Anthro Record from (2025)

|xref:ROOT:attachment$anthro_record_2025_0408.pdf[anthro_record_2025_0408.pdf, window="_blank", rel="noopener noreferrer"]
|PDF, letter sized, portrait

|xref:ROOT:attachment$anthro_record_land_2025_0408.pdf[anthro_record_land_2025_0408, window="_blank", rel="noopener noreferrer"]
|PDF, letter sized, landscape (hard to make :o)

|xref:ROOT:attachment$alien_record_2025_0408.pdf[alien_record_2025_0408.pdf, window="_blank", rel="noopener noreferrer"]
|PDF, letter sized, portrait

|xref:ROOT:attachment$robot_record_2025_0416.pdf[robot_record_2025_0416.pdf, window="_blank", rel="noopener noreferrer"]
|PDF, letter sized, portrait

|xref:ROOT:attachment$spacer_record_2025_0401.pdf[spacer_record_2025_0401.pdf, window="_blank", rel="noopener noreferrer"]
|Spacecraft details, PDF, letter sized, portrait

|xref:ROOT:attachment$note_sheet_2025_0408.pdf[note_sheet_2025_0408.pdf, window="_blank", rel="noopener noreferrer"]
|Sheets for stories, PDF, letter sized, portrait

|xref:ROOT:attachment$toy_sheet_2025_0408.pdf[toy_sheet_2025_0408.pdf, window="_blank", rel="noopener noreferrer"]
|Sheets for toys, PDF, letter sized, portrait

|xref:ROOT:attachment$adoc_to_pdf_2025_0416.zip[adoc_to_pdf_2025_0416.zip, window="_blank", rel="noopener noreferrer"]
