...
An artifact is anything that the players have not identified yet. 
...
In EXP, Kirlian energy, aura and forces are a Sciency Fiction extension of https://en.wikipedia.org/wiki/Kirlian_photography[Kirlian Auras,window=_blank, rel="noopener noreferrer"].
