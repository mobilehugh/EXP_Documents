...
// word for birthing a horse in modules\roll_playing_system\pages\CH04_AnthrosType_Equine.adoc
// word for birthing a cat
// rodentia.png is too small
// 250px is too small for the images 
// how to spell story as in a storey modules\roll_playing_system\pages\CH04_Anthros_Mutations.adoc
...
include::roll_playing_system:page$CH06_Aliens_9_Move.adoc[tag=blah] //blah blah blah
----
