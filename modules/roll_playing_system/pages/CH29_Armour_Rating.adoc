...
The only way that The referee can run mix and match armour is by using the xref:roll_playing_system:CH36_Hit_Locations.adoc[Hit Locations,window=_blank].
