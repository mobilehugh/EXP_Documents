...
* xref:roll_playing_system:CH04_Anthros_WA.adoc[Anthro Wate Allowance, window=_blank]
* xref:roll_playing_system:CH05_Robots_Z_WA.adoc[Robot Wate Allowance, window=_blank]
* xref:roll_playing_system:CH06_Aliens_9_WA.adoc[Alien Wate Allowance, window=_blank]
