...
Malfunctation randomly occur when generating the robot's peripherals.
...
To get the deets on alien evolutations, jump to xref:aliens:evolutations.adoc[Alien Mutations].