...
* Start Money
* Start Equipment
* Purchase from xref:hardware:a_introduction.adoc[Hardware,window=_blank, rel="noopener noreferrer"] 

=== Opulent
* Start Money not needed
* Start Equipment is all bespoke
* Pick from xref:hardware:a_introduction.adoc[Hardware,window=_blank, rel="noopener noreferrer"] 
...
For more details about money xref:uncombat:money.adoc[Jump here.,window=_blank, rel="noopener noreferrer"].
...
To engage in the vagaries of purchasing mundane equipment  xref:hardware:mundane_equipment.adoc[jump here.,window=_blank, rel="noopener noreferrer"]
...
To get some startifacts xref:hardware:startifacts.adoc[jump here,window=_blank, rel="noopener noreferrer"]
