...
* No Start Equipment
* No Startifacts
* One prized piece of xref:hardware:CH51_Random_Junque.adoc[Random Junque]
...
For more details about money xref:roll_playing_system:CH23_Money.adoc[Jump here.,window=_blank].
