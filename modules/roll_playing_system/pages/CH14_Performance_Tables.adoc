...
include::vocations:page$biologist.adoc[tag=biologist_maneuvers]

// Knite maneuvers tag
include::vocations:page$kn.adoc[tag=knite_maneuvers]

// Mechanic maneuvers tag
include::roll_playing_system:page$vocations:mechanic.adoc[tag=mechanic_maneuvers]
