...
Task rolls are made by players when their persona is attempting a maneuver.
...
Some maneuvers are pure sciency fiction, like strapping a grommet-sized oscillating refractometer onto a Fredericton di-collating time re-modulator.
Maneuvers include vocation skills, abilities and gifts as well. 
There is an entire section devoted to the maneuvering maneuvers called xref:roll_playing_system:CH17_Driving.adoc[Driving,window=_blank].
...
NOTE: *The Task Roll system is a rename of Performance Tables from previous versions.*

.*Steps To Task Rolls*
. <<_determine_skill_score,Determine Skill Score>>
...
The target roll is like the Defence Rating of a maneuver.
...
xref:roll_playing_system:page$CH14_Performance_Tables.adoc[tag=target_rolls]
...
For combat maneuvers, mercenaries can add their STR.
...
For more information about critical checks jump to xref:roll_playing_system:CH16_Special_Rolls_Critical.adoc[Critical Checks,window=_blank].
...
=== Driving Maneuvers
There is an entire section devoted to xref:roll_playing_system:CH17_Driving.adoc[Driving,window=_blank].
...
include::roll_playing_system:page$CH08_Vocations_Biologist.adoc[tag=biologist_maneuvers]

// Knite maneuvers tag
include::roll_playing_system:page$CH08_Vocations_Knite.adoc[tag=knite_maneuvers]

// Mechanic maneuvers tag
include::roll_playing_system:page$CH08_Vocations_Mechanic.adoc[tag=mechanic_maneuvers]

// Mercenary maneuvers tag
include::roll_playing_system:page$CH08_Vocations_Mercenary.adoc[tag=mercenary_maneuvers]

// nomad maneuvers tag
include::roll_playing_system:page$CH08_Vocations_Nomad.adoc[tag=nomad_maneuvers]

// nothing maneuvers tag
include::roll_playing_system:page$CH08_Vocations_Nothing.adoc[tag=nothing_maneuvers]

// spie maneuvers tag
include::roll_playing_system:page$CH08_Vocations_Spie.adoc[tag=spie_maneuvers]

// veterinarian maneuvers tag
include::roll_playing_system:page$CH08_Vocations_Veterinarian.adoc[tag=veterinarian_maneuvers]
