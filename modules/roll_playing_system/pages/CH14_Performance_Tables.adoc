...
include::vocations:page$mechanic.adoc[tag=mechanic_maneuvers]

// Mercenary maneuvers tag
include::vocations:page$mercenary.adoc[tag=mercenary_maneuvers]

// nomad maneuvers tag
include::vocations:page$nomad.adoc[tag=nomad_maneuvers]

// nothing maneuvers tag
include::vocations:page$nothing.adoc[tag=nothing_maneuvers]

// spie maneuvers tag
include::vocations:page$spie.adoc[tag=spie_maneuvers]

// veterinarian maneuvers tag
include::vocations:page$veterinarian.adoc[tag=veterinarian_maneuvers]
