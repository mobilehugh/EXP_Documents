...
.. xref:roll_playing_system:robots:control_factor.adoc[Control Factor,window=_blank] rolls may be required.
...
For a robot to intentionally harm a persona from her fabricator type would require a xref:roll_playing_system:robots:control_factor.adoc[Control Factor,window=_blank] Roll.
