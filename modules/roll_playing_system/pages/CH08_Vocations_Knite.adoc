...
The player must determine her knite's Mind wate allowance using her MND on the xref:roll_playing_system:CH04_Anthros_WA.adoc[Wate Allowance Table,window=_blank].
