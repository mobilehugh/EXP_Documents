...
On mundane terra, science uses genetics and observation to create a https://en.wikipedia.org/wiki/Taxonomy_(biology)[taxonomy of life,window=_blank, rel="noopener noreferrer"].
...
// FIXME family couch with anthros is gone

Anthros are organic upright bipedal humanoids that are immediately relatable to players.
Anthros have a shape, structure and physiology to the life form reading this document. 
...
.*Hominidae Rodens Battia*
* Family - anthro (Hominidae)
* Genus - Rodentia  (Rodens)
* Species - Bat (Battia)

== Alien Family (Diversidae)

// FIXME family couch with aliens is gone
...
.*Diversidae Tortillis Irritii*
* Family - alien (Diversidae)
* Genus - turtle body (Tortillis)
* Species - mosquito head (Irritii)

== Robot Family (Machinidae)



// FIXME family couch of robots
...
.*Mechanidae Janitorial Domestic*
* Family - Robot (Mechanidae)
* Series - Janitorial
* Model - Domestic

== AI (Autonomatae)

:art: family_couch_ai.png
:width: 450px
:snark: Family Photo
:artist: Dolly 3 prompt HM
:date: 2023
:license: CC BY-SA 4.0
:description: An AI couch.
include::ROOT:partial$articulate.adoc[]
...
To fabricate and AI port over to xref:referee_personas:ai_rp.adoc[Autonomous Intelligence,window=_blank, rel="noopener noreferrer"].

.*Autonomatae Sessile G3M*
* Family - AI (Autonomatae)
* Distro - Sessile (doesn't move)
* Branch - level 4 MOM (G3M)

== Random Family 
Random family determination is usually for referee personas.
Beginning players should use anthro personas to learn the EXP ruleset.
