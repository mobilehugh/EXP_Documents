...
The Roll Playing Rules allow the dice to have a greater on the storytelling.

NOTE: *Combat in the Roll Playing System works best with miniatures on hex paper.*

The Roll Playing Rules use the tactical combat system and the xref:roll_playing_system:CH00_kilo_die_mechanic.adoc[Kilodie Mechanic, window=_blank].
