...
For more detailed information about hit points, jump to xref:roll_playing_system:CH03_AttributesHPS.adoc[Hit Points,window=_blank].
...
For more details about anthro HPS, DSS and REC, jump to xref:roll_playing_system:CH04_Anthros_HPS.adoc[Anthro HPS,window=_blank].
...
To learm more about this convoluted and drawn-out process jump to xref:roll_playing_system:CH05_Robots_Z_HPS.adoc[mechanical decay, window=_blank].
...
Jump to process of xref:roll_playing_system:CH05_Robots_Z_HPS.adoc[mechanical decay, window=_blank] to get the rundown on robots running down.
