...
For the attribute adjustments levied for breaching life stages jump to xref:roll_playing_system:CH13_Health.adoc#_aging[Aging,window=_blank]. 
...
For the effects of these age changes jump to  jump to xref:roll_playing_system:CH13_Health.adoc#_aging[Aging,window=_blank]. 
