...
For more information about anthro hit points jump xref:roll_playing_system:CH04_Anthros_HPS.adoc[here,window=_blank].
...
For detailed info about the calculations below, jump to xref:roll_playing_system:CH04_Anthros_CT.adoc[Anthro attack table,window=_blank].
...
For anthro, naming shenanigans jump to xref:roll_playing_system:CH04_Anthros_Name.adoc[Anthro Name,window=_blank].
