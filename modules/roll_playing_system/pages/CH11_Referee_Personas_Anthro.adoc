...
For more information about anthro hit points jump xref:roll_playing_system:anthros:generate_hit_points.adoc[here,window=_blank].

==== HPMimum
include::anthros:generate_hit_points.adoc[tag=Anthro_HPS]

==== Damage System Shock
include::anthros:generate_hit_points.adoc[tag=Anthro_DSS]

==== Anthro RP Recovery
include::anthros:generate_hit_points.adoc[tag=Anthro_REC]
...
include::ROOT:partial$table/movement_rate_and_dexterity.adoc[]
