...
Sotto weapons are usually artifact weapons found in the xref:iii-hardware:CH46_Guns.adoc[Guns,window=_blank] section.
...
Flotto weapons are usually artifact weapons found in the xref:iii-hardware:CH46_Guns.adoc[Guns,window=_blank] section.
...
=== Area Weapons
Most Area Attacks are weapons like xref:iii-hardware:CH45_Grenades.adoc[Grenades,window=_blank] or
