...
== Driving Roll 
The driving roll is a xref:roll_playing_system:CH14_Performance_Tables.adoc[Task Roll,window=_blank] where the player must beat a target on 1d100 or lose control of her vehicle.
...
include::roll_playing_system:page$CH14_Performance_Tables.adoc[tag=target_rolls]
...
A xref:roll_playing_system:CH16_Special_Rolls_Asshole.adoc[Sphincter Roll,window=_blank] is required to determine if there is a fire complication.
