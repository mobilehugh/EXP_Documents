...
The tactical combat system is the keystone of the Roll Playing System.
All rules within the Roll Playing System complement the tactical combat system.
...
The theatrical combat system from the Role Playing System is a careful reduction of the tactical combat system.
...
NOTE: The tactical combat system developed before laptops, computer phones or the internet. + 
...
There is not theatre of the mind for the tactical combat system.
...
In the Roll Playing System' tactical combat system, the players use a kilo-die to make attack rolls.
...
Get more info at xref:roll_playing_system:CH03_AttributesHPS.adoc[Hit Points]
====
