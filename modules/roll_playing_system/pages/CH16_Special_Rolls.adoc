...
All critical checks are detailed in the section xref:roll_playing_system:CH16_Special_Rolls_Critical.adoc[Critical Checks,window=_blank].
...
.*Doing Tasks*
* xref:roll_playing_system:CH14_Performance_Tables.adoc[Task Rolls,window=_blank]
* xref:roll_playing_system:CH17_Driving.adoc[Driving Rolls,window=_blank]
...
.*Attribute Rolls*
* xref:roll_playing_system:CH16_Special_Rolls_Saves.adoc[Saving Rolls,window=_blank]
* xref:roll_playing_system:CH04_Anthros_HPS.adoc#_damage_system_shock[Damage System Shock Roll,window=_blank]
* xref:roll_playing_system:CH04_Anthros_HPS.adoc#_recovery_roll[Recovery Roll,window=_blank]
* xref:roll_playing_system:CH05_Robots_Z_CF.adoc[Control Factor Rolls,window=_blank]
...
* xref:roll_playing_system:CH16_Special_Rolls_Attributes.adoc[Attribute Rolls,window=_blank]
* xref:roll_playing_system:CH33_Initiative.adoc[Initiative Rolls,window=_blank]
* xref:roll_playing_system:CH34_Ambush.adoc[Ambush Rolls,window=_blank]
* xref:roll_playing_system:CH16_Special_Rolls_Asshole.adoc[Sphincter Rolls,window=_blank]
