...
* xref:anthros:generate_hit_points.adoc#_damage_system_shock[Damage System Shock Roll,window=_blank]
* xref:anthros:generate_hit_points.adoc#_recovery_roll[Recovery Roll,window=_blank]
* xref:roll_playing_system:robots:control_factor.adoc[Control Factor Rolls,window=_blank]
