...
:anthrogen: xref:anthros:a_introduction.adoc[Anthros,window=_blank]
:aliengen: xref:aliens:a_introduction.adoc[Aliens,window=_blank]
:robotgen: xref:robots:a_introduction.adoc[Robots,window=_blank]

ifeval::["{docname}" == "CH26_Role_Gen_Persona_Families"]

// substitution is for Roll Playing System
// when called from CH26_Role_Gen_Persona_Families.adoc
