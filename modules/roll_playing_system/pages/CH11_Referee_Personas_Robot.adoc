...
For example, security sentries protecting a plantation may only have a lazer and Skilled Bonus on her combat table.
...
For more information about the implications of the fabricator type jump to xref:roll_playing_system:CH05_Robots_Z_Fabricator.adoc[Robot Fabricator,window=_blank].
...
For more details jump to xref:roll_playing_system:CH05_Robots_Z_CF.adoc[Control Factor,window=_blank].
...
For more info and the effects of altering tech levels, jump to xref:iv-software:CH56_Tech_Level.adoc[Tech Level,window=_blank].
...
For a detailed explanation of the outline below jump to xref:roll_playing_system:CH05_Robots_Z_CT.adoc[Robot Combat Table,window=_blank].

This combat table is for baked-in offensive systems and ramming freedom.
...
If the robot type is Android (A), then the referee must make an anthro-like vocation-based combat table as well.
...
For more detailed information, jump to xref:roll_playing_system:CH05_Robots_Z_Power.adoc[Power Source,window=_blank].
...
For more detailed information, jump to xref:roll_playing_system:CH05_Robots_Z_Sensors.adoc[Sensors,window=_blank].
...
For more details on naming shenanigans, jump to xref:roll_playing_system:CH05_Robots_Z_Name.adoc[Robot Name,window=_blank].
