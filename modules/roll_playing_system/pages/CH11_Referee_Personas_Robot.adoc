...
For more information about the implications of the fabricator type jump to xref:roll_playing_system:robots:fabricator.adoc[Robot Fabricator,window=_blank].
