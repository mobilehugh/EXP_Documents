...
include::ROOT:robots$series_selection_single_roll.adoc[]
...
For more info about robot ramming, ram your way over to xref:robots:offensive_peripherals.adoc#_ramming[Robot Ramming,window=_blank].
...
For details about these attacks jump to  xref:robots:offensive_peripherals.adoc#_attack_table_one[Attack Table One,window=_blank].
...
For details about these attacks jump to  xref:robots:offensive_peripherals.adoc#_attack_table_two[Attack Table Two,window=_blank].
...
For details about these attacks jump to  xref:robots:offensive_peripherals.adoc#_attack_table_three[Attack Table Three,window=_blank].
...
For details about these attacks jump to  xref:robots:offensive_peripherals.adoc#_attack_table_four[Attack Table Four,window=_blank].
...
For more detailed explanations jump to xref:robots:defensive_peripherals.adoc[Defensive Systems,window=_blank].
...
For more detailed explanations jump to xref:robots:peripherals.adoc[Peripheral Systems,window=_blank].
...
// todo something broke regarding RP = speed of use
