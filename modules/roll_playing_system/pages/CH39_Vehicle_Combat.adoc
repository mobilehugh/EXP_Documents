...
The ruleset is faux realistic and designed for dice-rolling fun.
...
The speed of the vehicle determines its Defence Rating. 
Attacking a moving vehicle increases the target's Defence Rating.

=== Vehicle Defence Rating
...
. Defence Rating determined by speed differential.
...
The Defence Rating of the vehicle increases depending on the speed differential.
...
=== Combat Hardened
The base Defence Rating of 500 applies to an unarmoured civilian vehicle that has no combat hardening.
If the vehicle has an Defence Rating through combat hardening, that value becomes the base instead of 500.
A vehicle with an Defence Rating of 700 moving 30 h/u would have an Defence Rating of 1000.
...
Combat driving skill two increases the vehicle's base Defence Rating from 500 to 600. 
...
If the player's attack roll is 850 and the vehicle's Defence Rating is 800, her remaining Skilled Bonus is 50.
...
In vehicle combat the Area Attack Roll must beat the vehicle's speed-adjusted Defence Rating.
