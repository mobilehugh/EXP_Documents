...
Players can take their start money over to xref:hardware:mundane_equipment.adoc[Mundane Equipment,window=_blank]
...
If the milieu permits personas to have start toys head over to xref:hardware:a_introduction.adoc[Hardware,window=_blank] to get some toys.
It is also possible for personas in a high-tech world to purchase artifacts from shops.
If the milieu permits, players can use the xref:hardware:a_introduction.adoc[hardware section,window=_blank] like a shopping catalogue.
