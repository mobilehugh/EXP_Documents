...
* xref:roll_playing_system:CH04_Anthros_CT.adoc[Anthro Attack Table,window=_blank]
* xref:roll_playing_system:CH05_Robots_Z_CT.adoc[Robot Attack Table,window=_blank]
