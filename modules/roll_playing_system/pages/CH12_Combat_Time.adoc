...
For more details about non-combat time in EXP, jump to xref:roll_playing_system:CH12_Time_Movement.adoc[Time and Movement,window=_blank].
...
For details of tactical combat movement jump to xref:roll_playing_system:CH12_Combat_Movement.adoc[Combat Movement,window=_blank].
