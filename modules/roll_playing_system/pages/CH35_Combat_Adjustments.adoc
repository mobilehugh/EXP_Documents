...
If discussion about whether a feature offers cover or concealment becomes intense consult the xref:roll_playing_system:CH16_Special_Rolls_Asshole.adoc[Sphincter Dice,window=_blank].
...
If negotiation is not successful, remember the xref:roll_playing_system:CH16_Special_Rolls_Asshole.adoc[Sphincter Dice,window=_blank].
