...
If the player rolls less than her constitution score on 1d100, the attack has a xref:v-wetware:CH59_Physical.adoc#_combat_mutations[Phenomic Mutation,window=_blank] effect.
If the 1d100 roll is greater than her constitution score, the attack has a xref:v-wetware:CH58_Mental.adoc#_combat_mutations[Psionic Mutation,window=_blank] effect.
