...
The Roll-Playing System uses the tactical combat rules and the xref:roll_playing_system:kilo_die_mechanic.adoc[Kilodie Mechanic, window=_blank, rel="noopener noreferrer"].
...
To learn how to use it see xref:roll_playing_system:kilo_die_mechanic.adoc[Kilodie Mechanic, window=_blank, rel="noopener noreferrer"].
...
The gory details of all the possible rolls are discussed in xref:uncombat:all_those_rolls.adoc[All Those Rolls, window=_blank, rel="noopener noreferrer"].
...
There are more than fifteen sections under the heading of xref:combat:a_introduction.adoc[Tactical Combat, window=_blank, rel="noopener noreferrer"] that cover the finer details. 
