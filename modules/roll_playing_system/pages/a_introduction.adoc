...
==== Proficiency
Proficiency is a legacy term for weapon skills, and hails from the last millenium.
By strict definition, a skill is a proficiency and vice versa.
So the term proficiency has been dropped from the tactical combat rules
Don't worry the tactical combat rules are still byzantine and archaic to meet your weapon proficiency needs.
