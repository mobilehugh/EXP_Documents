...
|19-23
|Bot Power System
|xref:roll_playing_system:CH05_Robots_Z_Power.adoc[Robot Power,window=_blank]
...
|79-88
|Robotic Peripheral
|xref:roll_playing_system:CH05_Robots_Z_Peripherals.adoc[Peripherals,window=_blank]
