...
|===
3+<|Software to assist the space vehicle's computer in defensive situations. Computer level (1-10) times base value determines chance of software being onboard. Check for each software title. 
