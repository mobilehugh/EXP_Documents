...
|33-38
|Grenade Launcher
|xref:hardware:CH49_Misc_Weapons.adoc#_grenade_launcher[Grenade Launcher,window=_blank]

|39-40
|Rocket Launcher
|xref:hardware:CH49_Misc_Weapons.adoc#_rocket_launcher[Rocket Launcher,window=_blank]
...
|xref:hardware:CH49_Misc_Weapons.adoc#_miscellaneous_weapon_type[Miscellaneous Weapon,window=_blank]
