...
The extensive artifact system became a centrepiece of the game, and the official title became "EXP: The game of technological chaos." 
...
Better to start with some friends rather than strangers.
...
Roleplaying games must intentionally become more welcoming should create a safe space for all genders, races and sexualities. 
Using the pronouns 'her and she' is was prescient and is now outdated. 
