...
Example attributes are Strength, Intelligence, Charisma. 
...
The attributes in EXP are: Awareness, Charisma, Constitution, Dexterity, Intelligence, Strength, Mind and hit points. 
...
STR::
Abbreviation of the word Strength.
