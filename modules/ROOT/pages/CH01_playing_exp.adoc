...
The families, rules and technology are tongue in cheek and border on the ridiculous.
...
There will nuclear powered toasters, combat robots with welcome mats, and fun loving aliens. 
