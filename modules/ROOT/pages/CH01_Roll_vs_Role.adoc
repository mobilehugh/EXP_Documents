...
The theatrical combat system is a simplified version of the tactical combat rules.
The theatrical combat system simplifies the tactical combat rules by using simpler dice.
