...
== Example One "I like to swim"
This alien has a base movement rate of 12 h/u.
...
Quartering the movement of 12 h/u gives the following movement rates.

* Land: 3 h/u
* Air: --
* Water: 6 h/u

== Example Two "I like to run"
This alien has a base movement rate of 12 h/u.
...
Each of this alien's body parts has a land component. 
By having 4 land elements all of her movement rate can be used on land. 
Quartering the movement of 12 h/u gives the following movement rates.
