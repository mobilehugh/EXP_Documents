...
:description: Joke image of tiny dot representing a fly inside image border.
...
An insectoid receives a bonus of +1 for every 4 points of mental strength against such attacks.
For example, an insectoid with 15 mental strength would get a +4 in psionic roll against a mental mutation attack.