...
Type C attacks do not depend on the robot's Strength and have no Force Bonus.
...
Her ramming skill would use her Skilled for type A attacks.
Her baked-in pistol would use her Skilled for type C attacks.
