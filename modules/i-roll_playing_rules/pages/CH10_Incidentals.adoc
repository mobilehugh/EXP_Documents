...
Money nomenclature is discussed more thoroughly in the xref:i-roll_playing_rules:CH23_Money.adoc[Money] section.
If large amounts of money is needed refer to xref:iii-hardware:CH53_Treasure.adoc[Treasure].
...
Players can take their start money over to xref:i-roll_playing_rules:CH24_Mundane_Equipment.adoc[Mundane Equipment]
...
If the milieu permits personas to have start toys head over to xref:iii-hardware:An_index_hardware.adoc[Hardware] to get some toys.
