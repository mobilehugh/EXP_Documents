...
Money nomenclature is discussed more thoroughly in the xref:i-roll_playing_rules:CH23_Money.adoc[Money,window=_blank] section.
...
Players can take their start money over to xref:i-roll_playing_rules:CH24_Mundane_Equipment.adoc[Mundane Equipment,window=_blank]
