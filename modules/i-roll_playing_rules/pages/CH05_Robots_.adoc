...
. xref:CH05_Robots_Z_Attributes.adoc[Generate Attributes,window=_blank]
. xref:CH05_Robots_Z_Select_Types.adoc[Select Type,window=_blank]
. xref:CH05_Robots_Z_Fabricator.adoc[Fabricator Type,window=_blank]
. xref:CH05_Robots_Z_AR.adoc[Defence Rating,window=_blank]
...
. xref:CH05_Robots_Z_CF.adoc[Control Factor,window=_blank]
. xref:CH05_Robots_Z_HPS.adoc[Hit Points,window=_blank]
. xref:CH05_Robots_Z_Adapt.adoc[Adaptability,window=_blank]
. xref:i-roll_playing_rules:CH05_Robots_Z_CT.adoc[Combat Table,window=_blank]
...
. xref:i-roll_playing_rules:CH05_Robots_Z_Name.adoc[Name,window=_blank]
. *Have Fun!*
