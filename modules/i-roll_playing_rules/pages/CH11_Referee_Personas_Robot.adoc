...
. <<_farbricator_type,Fabricator Type>>
...
For example, security sentries protecting a plantation may only have a lazer and bonus proficient on her combat table.
...
For more information about the implications of the fabricator type jump to xref:i-roll_playing_rules:CH05_Robots_Z_Fabricator.adoc[Robot Fabricator,window=_blank].
...
Robotic acceleration is one hex per unit per PSTR prime score.
...
Physical strength determines the weight allowance of the robot.
...
For more information about carry stuff, jump to xref:i-roll_playing_rules:CH18_Encumbrance.adoc[Encumbrance,window=_blank].
...
For more info about robot ramming, ram your way over to xref:i-roll_playing_rules:CH05_Robots_Z_Offensive.adoc#_ramming[Robot Ramming,window=_blank].
...
For details about these attacks jump to  xref:i-roll_playing_rules:CH05_Robots_Z_Offensive.adoc#_attack_table_one[Attack Table One,window=_blank].
...
For details about these attacks jump to  xref:i-roll_playing_rules:CH05_Robots_Z_Offensive.adoc#_attack_table_two[Attack Table Two,window=_blank].
...
For details about these attacks jump to  xref:i-roll_playing_rules:CH05_Robots_Z_Offensive.adoc#_attack_table_three[Attack Table Three,window=_blank].
...
For details about these attacks jump to  xref:i-roll_playing_rules:CH05_Robots_Z_Offensive.adoc#_attack_table_four[Attack Table Four,window=_blank].
...
For more detailed explanations jump to xref:i-roll_playing_rules:CH05_Robots_Z_Defensive.adoc[Defensive Systems,window=_blank].
...
For more detailed explanations jump to xref:i-roll_playing_rules:CH05_Robots_Z_Peripherals.adoc[Peripheral Systems,window=_blank].
...
For more details jump to xref:i-roll_playing_rules:CH05_Robots_Z_CF.adoc[Control Factor,window=_blank].

include::i-roll_playing_rules:page$CH05_Robots_Z_CF.adoc[tag=control_factor]
...
For a detailed explanation of the outline below jump to xref:i-roll_playing_rules:CH05_Robots_Z_CT.adoc[Robot Combat Table,window=_blank].
...
If a robot RP manages to use a gun, her BP is zero.
...
For more detailed information, jump to xref:i-roll_playing_rules:CH05_Robots_Z_Power.adoc[Power Source,window=_blank].
...
For more detailed information, jump to xref:i-roll_playing_rules:CH05_Robots_Z_Sensors.adoc[Sensors,window=_blank].

include::ROOT:partial$CH05_Table_Robotic_Sensors.adoc[]

=== Robot RP Locomotion
Robot locomotion allows the RP to get anywhere she can fit.
For more detailed information, jump to xref:i-roll_playing_rules:CH05_Robots_Z_Locomotion.adoc[Locomotion,window=_blank].
...
For more details on naming shenanigans, jump to xref:i-roll_playing_rules:CH05_Robots_Z_Name.adoc[Robot Name,window=_blank].
