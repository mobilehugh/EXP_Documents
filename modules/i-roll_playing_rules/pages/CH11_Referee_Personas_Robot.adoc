...
Those robots which move faster than 8 h/u, must accelerate the same as vehicles.
...
// change to a link or cut and paste
...
// use a tag include from the VERY DIFFERENT robot combat table
