...
=== Religion Check
.Chance = 2*INT score - MSTR score
****
An alien with a 12 INT and a 12 MSTR has 12% chance of having religion. 
****
...
None::
The alien species has no concept of a tool. They would never consider an artifact as anything other than a rock or branch to step over.
