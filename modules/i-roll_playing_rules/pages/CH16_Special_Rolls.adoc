...
* xref:i-roll_playing_rules:CH14_Performance_Tables.adoc[Performance Rolls,window=_blank]
...
=== Performance Rolls
Performance Rolls are made by the player when her persona is attempting to perform a maneuver.
These maneuvers are vocation-related skills, abilities, tricks or gifts. 
The player needs to roll higher than, or equal to, the target roll to win her performance roll.
...
A driving roll is a performance roll dedicated to driving tasks.
