...
The wate is 25 gm, and 42 coins have a wate of 1 kg.
...
The players may prefer to have dice rolling from xref:i-roll_playing_rules:CH22_Negotiations.adoc[Social Interactions,window=_blank] replace role playing barter.
