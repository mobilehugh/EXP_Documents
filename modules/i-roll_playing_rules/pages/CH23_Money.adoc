...
The players may prefer to have dice rolling from xref:i-roll_playing_rules:CH22_Negotiations.adoc#_social_interaction_tables[Social Interactions,window=_blank] replace role playing barter.
