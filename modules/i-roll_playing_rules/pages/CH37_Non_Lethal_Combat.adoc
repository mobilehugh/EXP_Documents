...
=== Physical Strength Competition
The player must win a physical strength vs physical strength challenge to immobilize the target.
...
If the grappled target wins the physical strength challenge, they can break free, move and attack.

=== Physical Strength Competition
.1d20 + PSTR + Level both personas
****
...
The player must win an attack roll, a dexterity competition and a physical strength competition to wrestle a weapon from the target. 
...
****
Whichever player rolls higher wins the challenge. +
Grappler wins; move onto the PSTR competition. +
...
If the grabber fails this physical strength competition, they have placed themselves in danger.
...
The player must win an attack roll and a physical strength competition to get a chance to trip.
