...
AWE -1, CHA +4, CON -3, DEX +2, INT -2, MND -4, PSTR -3, and HPS Max -20%.
...
A person ascending into adolescence would suffer/enjoy the following attribute adjustments: AWE +1, CHA -5, CON +2, DEX -3, INT -1, MND -2, PSTR +2, and HPS +20%.
...
Attribute changes are: AWE +0, CHA +1, CON +1, DEX +1, INT +1, MND +2, PSTR +1, and HPS +0%.
...
Attribute changes are: AWE -1, CHA +0, CON -2, DEX -2, INT +2, MND +2, PSTR -2, and HPS -10%.
...
Attribute changes are: AWE -2, CHA +0, CON -3, DEX -4, INT +1, MND +1, PSTR -4, and HPS -20%.
...
NOTE: *Charisma of zero is fatal for a robot. Robots start with an MND of zero.*
