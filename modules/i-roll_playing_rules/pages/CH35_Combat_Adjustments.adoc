...
A skilled persona with a high bonus proficient can overcome weather and range penalties.
...
So a bonus can allow a persona to exceed her maximum roll (MR).
...
A payer with a Maximum Roll (MR) of 763 is making an attack roll against an Armour Rating (AR) of 793.
...
The final attack roll could be as high as 883 (MR of 793 plus 90), making a successful attack roll possible.
