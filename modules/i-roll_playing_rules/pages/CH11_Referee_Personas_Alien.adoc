...
Being Minute decreases the alien's PSTR and HPS but does not affect other attributes. 
...
Minute aliens must apply their PSTR modification before determining their damage per attack.
...
For instance, an alien with three attacks per unit could have three Type A attacks or two Type A attacks and one Type B attack.
...
== Alien RP Mutations
include::i-roll_playing_rules:page$CH06_Aliens_10_Mutations.adoc[tag=alien_mutations]
...
For a refresher on the implications of alien society jump to xref:i-roll_playing_rules:CH06_Aliens_13_Society.adoc[Alien Society,window=_blank].
...
If the referee persona is an alien knite, her mental strength jumps to 18.
Other than the mental strength limitation, no other attribute limitations or adjustments apply.
...
The alien can use all xref:i-roll_playing_rules:CH24_Mundane_Equipment.adoc[Mundane Equipment].
...
For a detailed explanation of the outline below jump to xref:i-roll_playing_rules:CH06_Aliens_6_CT.adoc[Alien Combat Table,window=_blank].
...
For the vocation based combat table, jump to xref:i-roll_playing_rules:CH04_Anthros_CT.adoc[Anthro combat table,window=_blank].
...
For alien, naming shenanigans jump to xref:i-roll_playing_rules:CH06_Aliens_14_Name.adoc[Alien Name,window=_blank].