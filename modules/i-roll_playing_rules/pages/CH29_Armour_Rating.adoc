...
The armour rating (AR) is a universal measure of how difficult something is to damage in combat.
The armour rating is a collection of hide thickness, dexterity, armour and luck.
The armour rating represents a single number that determines how difficult a target is to hit and damage.
The higher the armour rating, the more difficult it is to damage the persona.

An attack roll must be greater than the target's armour rating to do damage.
Referees must roll an attack roll higher than the persona's armour rating to do damage.
...
== Naked Armour Rating
The naked armour rating is the persona's base armour rating when wearing no protection at all. 
...
=== Dekes and Dodges 
The persona's armour rating includes all the dekes and dodges that one would use to avoid getting damaged in combat.
Extra descriptions of the perfect defensive move can earn EXPS but do not alter armour rating.
...
Restrictive armour can slow the persona down, impair her performance rolls and impair initiative.
...
The player adds the armour rating bonus to her persona's naked armour rating.
While it seems overly apparent, the persona must be wearing the armour to get the armour rating bonus.
...
A persona carrying her leather armour increases her wate allowance by 3 kg and does not get an armour rating bonus.
A persona wearing her leather armour gets an armour rating bonus of +50, and there is no impact on her wate allowance.
...
This armour type has no movement or restrictiveness penalties and grants the maximum dexterity bonus to the persona's armour rating.
...
Synthetix::
Any synthetic (Kevlar, fibreglass, plastix) composition arranged in sheet form.
This armour type has a high armour rating bonus and is both light and non-restrictive.
...
== Cost
The cost includes body armour, helmet and gauntlets.
...
Helmets and gauntlets offer no armour rating bonus.
Not wearing a helmet or gauntlets does not affect the armour rating bonus.
Like in the movies, personas can engage in combat with the same armour rating with or without a helmet.
...
This shielding is ineffective against Attack Type C (powered projectile weapons).
If an attacker using a Type A weapon critically fails her attack roll, the persona can disarm her with chain shielding.
The player must win a physical strength challenge to disarm her attacker.

Net::
Any strong sheet can become a shielding net.
The net mostly entangles an incoming attack but can also deflect and block Type A attacks.
This shielding is ineffective against Attack Type C (powered projectile weapons).
If an attacker using a Type A weapon critically fails her attack roll, the persona can disarm her with chain shielding.
The player must win a physical strength challenge to disarm her attacker.
...
=== Armour Rating Bonus
The whole purpose of shielding is to protect the persona from being damaged in combat.
The player adds the armour rating bonus of the shielding to her persona's naked armour rating.

=== Wate
The armour wate indicates the wate of the shielding in kilograms.
Shielding wate adds to the persona's encumbrance regardless of being carried or borne for combat.

== Cost
The cost includes shielding.
Otherwise self-explanatory.
...
Reducing restrictiveness by physical strength only decreases movement and armour bonus penalties.
The minimum restrictiveness earned from physical strength is zero.
...
The table uses the physical strength adjusted restrictiveness. 
This table does not have negative values, and the minimum restrictiveness is zero.
A persona with a 16 PSTR wearing leather armour has a restrictiveness of zero and zero movement penalty.

=== Performance Rolls and Restrictiveness
The restrictiveness of armour impairs performance rolls.
...
Physical strength does not overcome the Performance roll penalties of restrictive armour. 
...
Restrictiveness can reduce the persona's armour rating by removing a persona's dexterity bonus.
...
Choosing armour in the tactical combat system becomes a balance of armour rating bonus and dexterity bonus.
A persona with high dexterity and normal physical strength may have a better armour rating with lighter armour.
If the amour's restrictiveness causes her to lose her dexterity bonus, restrictive armour may decrease her armour rating. 
Physical strength can overcome this restrictiveness penalty.
...
At zero hit points, the armour loses armour rating and structural integrity.
...
The only way that The referee can run mix and match armour is by using the xref:i-roll_playing_rules:CH36_Hit_Locations.adoc[Hit Locations,window=_blank].
The ref determines where the attack will land and then rolls to hit against the appropriate armour rating.
...
These armour ratings are for targeting non-combat targets, like those described above.
