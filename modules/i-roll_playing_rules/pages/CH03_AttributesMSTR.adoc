...
This attribute is a sciency fiction one with no physiologic connection to our world, yet.
...
Psionic is the sciency fiction of the occult fantasy term psychic.
____
