...
The referee should understand xref:vi-appendices:Appy_C_Mythos_Generic.adoc#_the_spaces[The Spaces,window=_blank] and xref:vi-appendices:Appy_C_Mythos_Generic.adoc#_kirlian_energy[Kirlian Energy,window=_blank] and how these impact the knite vocation.
