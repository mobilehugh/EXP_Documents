...
=== Knite Gifts
Knites are the only vocation that calls their gifts that are called gifts. 
...
== Skill Explanations
For some reason there is a lot of detail available regarding knite skills. 
This is probably the because of edge cases with past knite personas. 
