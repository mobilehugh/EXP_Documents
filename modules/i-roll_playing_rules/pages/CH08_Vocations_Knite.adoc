...
The player must determine her knite's Mind wate allowance using her MND on the xref:i-roll_playing_rules:CH04_Anthros_WA.adoc[Wate Allowance Table,window=_blank].
...
The player must make a combat table for this attack where her MND replaces her STR.
