...
The knite must make a task roll against a DD equal to 1/100 of the target's armour rating.
...
When in combat the knite may be able to get a MSTR Task Roll bonus.
