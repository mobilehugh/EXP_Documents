...
== Spie Abilities
The three primary spy abilities are assassination, disguise and martial arts. 
Abilities are different from skills in that only a spie can carry out these maneuvers. 
...
== Spie Experience
The benefits of increasing experience levels are more tricks, improved performance, and improved combat skills. Spies earn experience points for completing procedures rolls (50 EXPS per DD) and role-playing within their vocation. Only 75% of combat experience can go towards a spie's experience point total.
