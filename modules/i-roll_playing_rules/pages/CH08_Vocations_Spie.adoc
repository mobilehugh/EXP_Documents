...
The attack roll uses the Skilled Bonus (Skilled) from the Strike line on the combat table.
The Force Bonus (Force) is from the Fling line on the combat table.
