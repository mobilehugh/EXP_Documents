...
A successful attack roll will limit the damage to area of effect damage.
...
No attack roll is necessary as this is an area of effect attack.
...
== Artifact Armour
This robot's hull is replaced by fancy armour from xref:iii-hardware:CH42_Armour.adoc[Armour]
...
== Force Field
This is the classic sciency fiction defensive force field.
