...
== Psionic Mutation
This robot has a peripheral that functions the same as a non-combat psionic mutation.
...
To generate the mutation jump to the specific table xref:v-wetware:CH58_Mental.adoc#_non_combat_mutations[Non Combat Psionic Mutations,window=_blank].
Ideally, the mutation will be a defensive one, but any non-combat psionic mutation will work if used defensively. 
