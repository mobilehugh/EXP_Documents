...
For a robot attack to inflict damage the player must make a successful attack roll.
...
To inflict damage while ramming, the robot must make a successful attack roll.
