...
. Reflect these actions on a https://en.wikipedia.org/wiki/Hex_map[hex mat,window=_blank] using link:"https://en.wikipedia.org/wiki/Miniature_model_(gaming)"[minis,window=_blank]
