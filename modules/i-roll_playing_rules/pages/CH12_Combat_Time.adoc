...
. Reflect these actions on a https://en.wikipedia.org/wiki/Hex_map[hex mat,window=_blank] using https://en.wikipedia.org/wiki/Miniature_model_%28gaming%29[minis,window=_blank]
