...
:description: Drawing of mangy humanoid rabbit with a club of nails hiding behind a wall.
...
Ambushed personas maintain their armour rating but are sitting ducks.
...
include::ROOT:partial$CH34_Table_Ambush_Anatomy.adoc[]

:art: ambush_van_raptors.png
:width: 450px
:snark: The vangaurd of guarding vans.
:artist: JEShields
:date: 2016-2021
...
They are not defenceless, and their armour rating is unchanged, but they cannot move nor attack in response.
