...
The tactical combat system does not automatically use hit locations.
...
The tactical combat system does not take hit locations into account. 
...
The player can move the hit location up or down the hit location chart depending on her bonus proficient (BP).
In this case, the mercenary persona has a BP of +150 for her weapon.
...
The persona's bonus proficient is divided by 10 when shifting on the alien and robot hit location tables.