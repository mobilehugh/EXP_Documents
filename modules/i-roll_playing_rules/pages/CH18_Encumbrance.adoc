...
Each PSTR has its own assigned Wate Allowance. 
...
The persona with the 11 PSTR would be over-encumbered when carrying between 24 and 40 kgs of equipment.
...
The persona needs to set the stuff down to avoid the performance roll penalty.
