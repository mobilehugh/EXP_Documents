...
She could immediately regain those lost hit points with a healing pharmaceutical.
...
WARNING: There is a move afoot to replace HPS Max with HPM and HPS Total with HPT. 
