...
. Head Part
.. <<_alien_head_adornment,Alien Head Adornment>> (optional)
. Torso Part
.. <<_alien_torso_adornment,Alien Torso Adornment>> (optional)
. Arms Part
.. <<_alien_arms_adornment,Alien Arms Adornment>>(optional)
. Legs Part
. Coat and Colour

The player generates a head, torso, arms and legs.
Each body part represents the shape of each animal. 
The body part does *NOT* and special functions the animal may have.
...
The player may add an optional <<_alien_head_adornment,Alien Head Adornment>> later.
...
The player may add an optional <<_alien_torso_adornment,Alien Torso Adornment>> later.
...
The player may add optional <<_alien_arms_adornment,Alien Arms Adornment>> later.
...
To create a de novo coat colour jump to xref:iv-software:CH55_Appearances.adoc#_colour_your_whirled[Colour,window=_blank].
...
For a detailed rendering jump to xref:i-roll_playing_rules:CH06_Aliens_9_Move.adoc[Alien Movement,window=_blank].
