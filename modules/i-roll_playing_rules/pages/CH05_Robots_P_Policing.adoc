...
A successful to hit roll will immobilize the rioter and prepare them for detention.
...
If a to hit roll is required the player must make a successful to hit roll.
To hit rolls are usually reserved for targeted attacks.
A successful to hit roll vs the target's AR indicates the effect takes hold.
