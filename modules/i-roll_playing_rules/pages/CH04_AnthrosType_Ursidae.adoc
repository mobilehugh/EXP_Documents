...
Each attack is a non-powered thrusting and striking attack (type A). 
A successful hit inflicts 1-6 (1d6) hit points of damage.
A 6th level ursidae with an eighteen physical strength would get six attacks per unit, capable of inflicting 10 to 15 hit points of damage
