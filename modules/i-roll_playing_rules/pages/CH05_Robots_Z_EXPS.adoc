...
For more info jump to xref:i-roll_playing_rules:CH15_Experience.adoc[Experience,window=_blank]
...
A bot with a painting peripheral would not earn EXPS for painting a house but would make EXPS for blinding attackers with the same peripheral.
