...
An industrial janitorial bot is supposed to clean the factory and nothing else. 
...
For example, a domestic janitorial bot could find itself in a messy bathroom.
