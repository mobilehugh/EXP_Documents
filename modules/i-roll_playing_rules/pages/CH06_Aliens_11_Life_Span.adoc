...
For the attribute adjustments levied for breaching life stages jump to xref:i-roll_playing_rules:CH13_Health.adoc#_aging[Aging,window=_blank]. 
...
For the effects of these age changes jump to  jump to xref:i-roll_playing_rules:CH13_Health.adoc#_aging[Aging,window=_blank]. 
