...
There is a more detailed discussion found under xref:i-roll_playing_rules:CH29_Armour_Rating.adoc[Defence Rating,window=_blank] in the tactical combat system. 
