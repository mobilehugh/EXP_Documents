...
== Driving Roll 
The driving roll is a xref:i-roll_playing_rules:CH14_Performance_Tables.adoc[Task Roll,window=_blank] where the player must beat a target on 1d100 or lose control of her vehicle.
...
include::i-roll_playing_rules:page$CH14_Performance_Tables.adoc[tag=target_rolls]
...
A xref:i-roll_playing_rules:CH16_Special_Rolls_Asshole.adoc[Sphincter Roll,window=_blank] is required to determine if there is a fire complication.
