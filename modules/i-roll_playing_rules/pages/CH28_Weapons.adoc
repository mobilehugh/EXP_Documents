...
It includes any action where the attack roll is trying attack a specific target.
...
==== Activation
Each device takes one unit of preparation before a attack roll can be made.
...
So most personas will only be able to add their bonus non-proficient to the grenade attack roll.
