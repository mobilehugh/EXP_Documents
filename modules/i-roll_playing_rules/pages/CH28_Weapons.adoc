...
Aliens and robots can have multiple Strike attacks per unit.
...
The player also adds her damage adjuster for Strike attack to the damage inflicted (one-half her STR).

== Fling Attacks
*Non-powered projectile attacks.*

Fling attacks depend on the persona's muscle power to inflict damage.
...
Aliens and robots can have multiple attacks per turn with their Fling attacks.
...
Damage::
Damage indicates how many hit points the weapon removes from the target's hit points.
The player also adds her damage adjuster for Fling attack to the damage inflicted (one-quarter of her STR).
...
Shoot weapons do not require the muscle power of the persona.
...
Shoot weapons are the classic guns and lazer weapons from sciency fiction and action movies.
Most Shoot weapons are artifacts like guns or lasers. 
...
Mundane Shoot weapons are listed below. 
...
== Sotto - 2 and E Attacks
*Powered projectile attacks.*

Sotto - 2 and E attacks function the same as Shoot attacks but have more than one attack roll per unit.
...
It is also possible for an alien to have an evolved attack that functions like a Sotto - 2 or E attack. 

.*Attack Rolls per Unit*
. Shoot one attack roll per unit
. Sotto - 2 two attack rolls per unit
. Sotto-3 three attack rolls per unit
...
Flotto attacks function the same as Shoot attacks but have more than one attack roll per unit.
These attack types do not require any Strength from the persona to inflict damage or make multiple attack rolls.
Combatants can be quite far apart and be able to damage each other.

NOTE: *The former name of Flotto Attacks was Type F, and before that was Weapon Type Special*
...
It is also possible for an alien to have an evolved attack that functions like a Flotto attack. 

The player will make five attack rolls per unit when using a Flotto weapon.
...
Mundane Type AOE weapons function as Fling attacks.
