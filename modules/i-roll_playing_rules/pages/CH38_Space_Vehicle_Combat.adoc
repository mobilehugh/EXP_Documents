...
A successful attack roll must be made against the space vehicle's Defence Rating to inflict damage.
...
The hull supplies the space vehicle's Defence Rating used in combat.
The hull and Defence Rating have an intimate relationship.
In combat, the hull absorbs damage decreasing Defence Rating.

NOTE: *The Hull Defence Rating (DEF) protects the Hull. Once the Hull AR is is less than 420, the Hull takes direct damage rolls.*
