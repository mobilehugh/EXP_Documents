...
=== Attempts
The number of boarding attempts is equal to the number of ramming attempts, and the same calculations apply.

=== Chance per attempt
Boarding is more delicate and difficult than ramming.
