...
Initially, the level bonus plays a small role in the Skilled but eventually becomes the most significant contributor to the combat vocations.

include::ROOT:partial$CH04_Table_Anthro_CT_BP_Lvl.adoc[]

== Raw Bonus
A persona is not effective using unfamiliar weapons.
When the persona uses unfamiliar weapons, the player can only add a portion of the Skilled to her attack roll.
