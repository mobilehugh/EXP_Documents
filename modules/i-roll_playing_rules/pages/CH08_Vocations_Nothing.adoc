...
The nothing with the higher SOCwill get their way.
...
== Nothing Wealth
Unlike the other vocations xref:i-roll_playing_rules:CH23_Money.adoc[Money] is very important to nothings.
This vocation receives money directly from the  the xref:iii-hardware:CH53_Treasure.adoc[Treasure Tables].
...
The treasure system is complicated and not located here.
Jump over to  xref:iii-hardware:CH53_Treasure.adoc[Treasure] to generate the numbers.

// you have forgotten target blank!!!! 
