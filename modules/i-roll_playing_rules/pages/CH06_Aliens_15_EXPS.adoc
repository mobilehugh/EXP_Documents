...
The alien increases her bonus proficient and maximum roll for each new experience level.
...
An alien with a Type B spittle attack and a 12 DEX would add 12 to her Bonus Proficient and Maximum Roll for each new EXPS Level.
