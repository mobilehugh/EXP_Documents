...
The alien increases her Skilled Bonus and Maximum Roll for each new experience level.
...
An alien with a Type B spittle attack and a 12 DEX would add 12 to her Skilled Bonus and Maximum Roll for each new EXPS Level.
