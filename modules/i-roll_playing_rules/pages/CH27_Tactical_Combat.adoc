...
If any of the following attack types don't sound familiar review them at xref:i-roll_playing_rules:CH28_Weapons.adoc[Attack Types,window=_blank].
...
For a detailed explanation of attack tables jump to xref:i-roll_playing_rules:CH09_Combat_Tables.adoc[Attack Tables,window=_blank].
...
TIP: Too many numbers? Try the xref:ii-role_playing_rules:CH26_Theatrical_Combat.adoc[Theatrical Combat System,window=_blank].
...
Get more info at xref:i-roll_playing_rules:CH03_AttributesHPS.adoc[Hit Points]
====
...
* Strike weapon (icepick), she adds her Force Bonus of 6 to the damage score.
* Fling weapon (harpoon), she adds her Force Bonus of 3 to the damage score.
* Shoot weapon (crossbow), she adds her Force Bonus of 0 the damage score.
...
For more details about Defence Rating jump to xref:i-roll_playing_rules:CH29_Armour_Rating.adoc[Defence Rating,window=_blank].
