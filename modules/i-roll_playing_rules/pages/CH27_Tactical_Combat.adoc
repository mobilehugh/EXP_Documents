...
The persona's Strength determines the damage adjustment.
Type A attacks require Strength to inflict damage and therefore have the highest damage adjustment.
