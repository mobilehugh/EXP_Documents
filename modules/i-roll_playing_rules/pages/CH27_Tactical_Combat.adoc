...
A successful attack requires a successful "attack roll."
...
NOTE: *An attacker generates a attack roll by rolling a kilo-die (hence roll
to hit).*

The higher the attack roll the better.
The attack roll must be greater that the target's defences. 
...
The attack roll is made against a location and not a persona.
