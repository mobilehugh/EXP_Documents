...
=== Sotto
*Powered multiple projectile attacks.*
Sotto attacks are a subset of Shoot attacks, and use the Shoot row of the Attack Table.
Sotto attacks do not require the user's muscle power to inflict damage. 
These attacks supply their own energy to inflict damage.
The personas can be many hexes apart and still be able to damage each other.
Sotto-2 weapons get two attacks per turn.
Sotto-3 weapons get three attacks per turn.
Examples are semi-automatic rifles, quill shooting aliens and hair-trigger energy weapons.
The term arises from frequently shortening of semi-auto to sotto. 

=== Flotto
*Powered full auto projectile attacks.*
These attacks are fully automated (F stands for fully automatic).
Flotto attacks do not require the user's muscle power to inflict damage, and one action results in multiple attacks. 
The attack supplies its energy to inflict damage and make multiple attacks.
The personas can be many hexes apart and still be able to damage each other.
Flotto weapons attack as Shoot weapons.
Flotto weapons spray projectiles delivering lots or no damage at all.
...
Type AOE attacks as Strike, B or C depending on its delivery method.
The persona throws Fling AOE attacks at the target hex (hand grenade).
The persona shoots Shoot AOE attacks at the target hex (grenade launcher).
Strike AOE would be a suicide vest.
...
The Fling Skilled Bonus is +175, and her final attack roll is 775.
...
The player rolls an attack using a kilodie.
The player refers to the nameless nomad's combat table.
The ice pick can only be used in close quarters and is a Strike attack. 
...
The Strike attack Raw Bonus (Raw) is +35, and her final attack roll is 535.
...
The laser pistol is a Shoot attack. 
The nomad has proficiency with a laser pistol.
The player can add the Shoot attack Skilled Bonus (Skilled) to her attack roll.
The player's attack roll is 800 on the kilodie.
The Shoot Skilled Bonus is +230, and her final attack roll is 1030.
...
Strike attacks require Strength to inflict damage and therefore have the highest Force Bonus.
Shoot attacks are self-powered and have no Force Bonus at all.

When the player wins an attack roll with a Strike weapon (icepick), she adds six hit points to the damage score.
When the player wins an attack roll with a Fling weapon (harpoon), she adds three hit points to the damage score.
When the player wins an attack roll with a Shoot weapon (lazer pistol), she adds nothing to the damage score.
