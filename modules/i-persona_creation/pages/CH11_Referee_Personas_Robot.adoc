...
Machinae are life forms that are inorganic and fabricated.
...
A successful to hit roll damages the robot as it would any other persona.
...
Robot power sources are science fantasy supercells that allow the robot to operate.
