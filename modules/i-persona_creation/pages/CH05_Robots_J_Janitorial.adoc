...
The commercial type, on the other hand, is tended to work in a pre-programmed factory which is highly regulated and supposedly self-sufficient.
Commercial bots roll their size on the outdoor table, while the domestics use the indoor table.
