...
The relationship between CON and HPS is detailand directly influences structural integrity as well.
The CON is used to determine the persona's hed in HPS.
