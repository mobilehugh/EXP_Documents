...
This mean almost any vehicle from xref:iv-hardware:CH54_Vehicles.adoc[Vehicles]. 
...
.*Exatmo Transport Robot Fabrication Info (T-E)*
[width="75%",cols="2*<"]
|===
...
This mean almost any vehicle from xref:iv-hardware:CH52_Space_Vehicle.adoc[Space-Vehicles]. 
