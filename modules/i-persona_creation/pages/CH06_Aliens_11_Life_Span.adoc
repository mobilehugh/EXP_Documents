...
Determining the alien's life-span is done in two parts.
...
This part determines what percentage of the alien's life will be spent as a child, an adolescent, an adult, or as an elder member of the family.
The effects of these different stages are the same for all aging personas and are discussed in xref:ii-non_combat_rules:CH13_Health.adoc[Health].

include::ROOT:partial$CH06_Table_Alien_Lifespan.adoc[]

== Alien Life Stages
The alien life stages are quite superficial indeed.
...
If a player were to have rolled 82 on the Alien Lifespan table, then her alien would have an age between 160 and 250 years old.
...
Note that the aged category must be rolled before the elder category can be determined.
The alien's start age should be about 29 to 30 years and on its 169th year, it will be in the elder category and at 197 years in the aged category.
After 200 years, it has exceeded its life expectancy.
For the effects of these age changes, see Chapter 13: Health.

include::ROOT:partial$CH06_Table_Example_of_Alien_Life_Stages.adoc[]
