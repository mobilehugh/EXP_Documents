...
== Nothing Wealth
Unlike the other vocations xref:ii-roll_playing_rules:CH23_Money.adoc[Money] is very important to nothings.
This vocation receives money directly from the  the xref:iv-hardware:CH53_Treasure.adoc[Treasure Tables].
...
Jump over to  xref:iv-hardware:CH53_Treasure.adoc[Treasure] to generate the numbers.
