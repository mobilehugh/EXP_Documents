...
The rules presented here are guidelines, as all rules are, and common sense and fun should prevail.
The referee will need to make many snap judgement calls.
Some players will adamantly transfer their car experience into the game.
People are willing to accept faux science rules about lazer cannons but not so when it comes to vehicles.
Does wind affect my lazer rifle?
My persona hunted flying womp mice why can't I use my BP?
Can our supersonic vehicle outrun that sonic pistol attack?

The referee and players should not underestimate the power of the Sphincter dice to assist decisions.

// not for regular driving
// not for car chases

// table top minis and hexes
// can these combatants meet table top and minis
// tremendous distances
// smaller sized hexes and smaller tokens
// managing flying or burrowing vehicles

// running away

// vehicle to vehicle
// targeting at vehicle
// targeting from vehicle



// alien speed minimum speed
