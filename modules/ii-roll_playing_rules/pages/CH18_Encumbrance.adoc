...
* xref:i-persona_creation:CH04_Anthros_WA.adoc[Anthro Wate Allowance, window=_blank]
* xref:i-persona_creation:CH05_Robots_Z_WA.adoc[Robot Wate Allowance, window=_blank]
* xref:i-persona_creation:CH06_Aliens_9_WA.adoc[Alien Wate Allowance, window=_blank]
