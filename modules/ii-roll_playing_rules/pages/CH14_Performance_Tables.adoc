...
Only for Roll Playing. 
Role Playing will use System 4d2.
Theatrical and Tactical versions.

:art: monkey_box_anger.png
:width: 250px
:snark: Rage at the machine.
...
== Determine Skill
Almost always exps level plus skills.
...
== Determine Target Roll
What is it gonna be calculated or tabulated.
...
=== Tabulated performance Roll
No calculations compare DD to skill to get Performance Roll.

include::ROOT:partial$CH14_Table_New_Performance.adoc[]

== Roll 1d100
Player rolls 1d100.
Player adds bonuses to roll.
Equal or higher is success. 

=== Otto Failure
If not possible to make roll 42 = auto success.
If given good role playing excuse.

=== Otto Success
If not possible to fail the roll 42 = failure.
Can avoid failure if good role playing excuse.

=== Otto Try again
Close is with in 1 or 2 points.
if really close referee may offer partial success.
or another chance
if given a good role playing excuse.
