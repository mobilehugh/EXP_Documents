...
A janitorial bot has the following attributes: AWE 12 CHA 11 CON 12 DEX 10 INT 12 MSTR 0 PSTR 16.
...
== Bonus Proficient (BP)
This number is added to the to hit rolls for weapons that the persona is skilled with.
The higher the BP more likely the persona is to hit her target and inflict damage. 
In game terms when the player rolls a kilodie she adds the BP to the to hit roll. 
...
Attribute and level bonuses are combined into a "to hit roll" bonus. 
...
== Maximum Roll (MR)
The maximum roll is the best to hit roll that the player can make for her persona.
If a player's total roll is 1042 and her MR is 884 her to hit roll is reduced to 884.
