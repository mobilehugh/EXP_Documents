...
Types of support equipment are: batteries, ammunition, fuel, manuals, and spare parts
Support equipment does not include brassieres, or jockstraps.
Support equipment is generally useless on its own.

Many toys require support equipment: guns need ammo; detectors need batteries; vehicles need fuel; everything needs instructions;
...
include::ROOT:partial$CH55_Table_Amount_of_Support_Equipment.adoc[]
...
==== Ammunition For Existing Artifact 
...
**8) Broadcast: Broadcast cells are actually power receivers that convert transmissions from a power source into energy.
...
*1) AI Computer*:AI computer software is designated for the MOM series of artificially intelligent computers described under computers in http://expgame.com/?page_id=343ai-computers[Chapter 48: Miscellaneous Equipment].
