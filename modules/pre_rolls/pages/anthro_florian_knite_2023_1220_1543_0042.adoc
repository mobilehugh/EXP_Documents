...
:title_description: a muscular humanoid with a flower head wearing a tank top and holding a techno energy sword 
:title_prefix: This persona looks like


:pdf_file: anthro_night_shadii.pdf
