...
|41-45
|xref:pre_rolls:rp_anthro_florian_nomad.adoc[Florian Nomad, window=_blank]

|46-60
|xref:pre_rolls:rp_anthro_humanoid_civilian_fodder.adoc[Fodder Civilian,window=_blank]

|61-70
|xref:pre_rolls:rp_anthro_humanoid_merc_fodder.adoc[Fodder Mercenary,window=_blank]
...
|xref:pre_rolls:rp_anthro_humanoid_merc_fodder.adoc[Mercenary,window=_blank]
|xref:pre_rolls:rp_anthro_florian_nomad.adoc[Florian Nomad, window=_blank]

|xref:pre_rolls:rp_anthro_ursidae_mercenary.adoc[Mercenary,window=_blank]
|xref:pre_rolls:rp_anthro_humanoid_civilian_fodder.adoc[Fodder Civilian,window=_blank]

|xref:pre_rolls:rp_anthro_florian_nomad.adoc[Nomad, window=_blank]
|xref:pre_rolls:rp_anthro_humanoid_merc_fodder.adoc[Fodder Mercenary,window=_blank]
