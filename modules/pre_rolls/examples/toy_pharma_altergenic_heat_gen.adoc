...
//For more information about the phenomic mutation xref:wetware:phenomics.adoc#_heat_generation[skin structure change jump here,window=_blank, rel="noopener noreferrer"].
