...
//* xref:pre_rolls:toy_biorepair_cardio_vest.adoc[Cardio Vest,window=_blank, rel="noopener noreferrer"]
//* xref:pre_rolls:toy_biorepair_injury_detector.adoc[Injury Detector,window=_blank, rel="noopener noreferrer"]
//* xref:pre_rolls:toy_biorepair_resipirator.adoc[Respirator,window=_blank, rel="noopener noreferrer"]
//* xref:pre_rolls:toy_biorepair_stasis_bag.adoc[Stasis Bag,window=_blank, rel="noopener noreferrer"]
