...
Resolving combat using the tactical combat rules are a hybrid of old-school war game and 20th-century roleplaying.
...
The transformation to combat rules transforms the game from roleplaying to solo war game.
...
There is an entire industry of miniatures supporting roleplaying games.
