...
Resolving combat using the tactical combat rules are a hybrid of old-school war game and 20th-century role-playing.
...
NOTE: If prolonged real-time resolution of combat is unappealing, consider the xref:role_playing_system:combat_rules.adoc[Theatrical Combat System,window=_blank, rel="noopener noreferrer"].
...
For more info about the 1d1000 jump to xref:roll_playing_system:kilo_die_mechanic.adoc[Kilodie Mechanic,window=_blank, rel="noopener noreferrer"].

== Attack Types
EXP has an enormous variety of weapons.
A review of attack types is needed to understand attack tables and attack rolls.
For a more detailed explanation jump to xref:combat:attack_types.adoc[Attack Types,window=_blank, rel="noopener noreferrer"].
...
If any of the following attack types don't sound familiar review them at xref:combat:attack_types.adoc[Attack Types,window=_blank, rel="noopener noreferrer"].
...
== Attack Table
The attack table blends skills, attributes, and experience into numbers that are added to the players's Attack Roll.
...
For a detailed explanation of attack tables jump to xref:combat:attack_table_details.adoc[Attack Tables,window=_blank, rel="noopener noreferrer"].
...
TIP: Too many numbers? Try the xref:role_playing_system:combat_rules.adoc[Theatrical Combat System,window=_blank, rel="noopener noreferrer"].
...
For more information about lucky shots jump to xref:uncombat:critical_checks.adoc[Critical Checks,window=_blank, rel="noopener noreferrer"].
...
to get more information about hit points and damage xref:attributes:hit_points.adoc[jump here.,window=_blank, rel="noopener noreferrer"]
====
...
For more details about Defence Rating jump to xref:combat:defence_rating.adoc[Defence Rating,window=_blank, rel="noopener noreferrer"].
...
You can take the time to learn more by jumping to xref:combat:time_in_combat.adoc[Combat Time,window=_blank, rel="noopener noreferrer"].
...
To learn more about movement move over to xref:combat:move_in_combat.adoc[Combat Movement,window=_blank, rel="noopener noreferrer"].
...
xref:combat:initiative.adoc[Initiative,window=_blank, rel="noopener noreferrer"].
