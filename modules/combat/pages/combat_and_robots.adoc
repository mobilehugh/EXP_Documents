...
.. xref:robots:control_factor.adoc[Control Factor,window=_blank, rel="noopener noreferrer"] rolls may be required.
...
For a robot to intentionally harm a persona from her fabricator type would require a xref:robots:control_factor.adoc[Control Factor,window=_blank, rel="noopener noreferrer"] Roll.
