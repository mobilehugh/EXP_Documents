...
The https://en.wikipedia.org/wiki/Hexagon[hexagon,window=_blank, rel="noopener noreferrer"] is a six-sided polygon of great beauty.
...
Tactical combat movement requires a https://en.wikipedia.org/wiki/Hex_map[hexagon surface,window=_blank, rel="noopener noreferrer"] and https://shorturl.at/otFGJ[tokens,window=_blank, rel="noopener noreferrer"] to keep track of movement. 

== Time
Each turn of combat in EXP is called a unit.
This time measurement is 2 seconds long.
For more details about time in EXP, jump to xref:combat:time_in_combat.adoc[Combat Time,window=_blank, rel="noopener noreferrer"].
...
If the debate becomes heated, this would be an excellent opportunity to use xref:uncombat:sphincter_rolls.adoc[Sphincter Roll,window=_blank, rel="noopener noreferrer"]. 
...
For exotic terrains like zero gravity or exatmo, jump to  xref:uncombat:terrains.adoc[Exotic Terrain,window=_blank, rel="noopener noreferrer"].
