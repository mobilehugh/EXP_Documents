...
Vehicles are the atypical vehicles that one finds planetside.
...
Jump to xref:hardware:vehicles.adoc[Inatmo Vehicle,window=_blank, rel="noopener noreferrer"]. 
...
For spacecraft combat, jump  to xref:combat:combat_and_exatmo_vehicle_intro.adoc[Spacecraft Combat,window=_blank, rel="noopener noreferrer"].
...
For uncombat driving shenanigans jump to  xref:uncombat:driving.adoc[Driving, window=_blank, rel="noopener noreferrer"]. 
...
EXP is not responsible for misuse of the https://en.wikipedia.org/wiki/Pythagorean_theorem[Pythagorean theorem,window=_blank, rel="noopener noreferrer"].
...
Vehicles do not have armour unless otherwise specified.
...
Vehicles have a random damage location like robots and spacecraft. 
...
Vehicles in EXP are randomly created and do not follow mundane terran car tropes.
...
To learn collision avoidance rules jump to  xref:uncombat:driving.adoc[Driving,window=_blank, rel="noopener noreferrer"]. 
...
. Collision result as per xref:uncombat:driving.adoc[Driving,window=_blank, rel="noopener noreferrer"]
...
.*Params of Boarding*
. Navigate to jump range xref:uncombat:driving.adoc[Driving,window=_blank, rel="noopener noreferrer"]
