...
For uncombat driving shenanigans jump to  xref:roll_playing_system:CH17_Driving.adoc[Driving, window=_blank]. 
...
To learn collision avoidance rules jump to  xref:roll_playing_system:CH17_Driving.adoc[Driving,window=_blank]. 
...
. Collision result as per xref:roll_playing_system:CH17_Driving.adoc[Driving,window=_blank]
...
.*Params of Boarding*
. Navigate to jump range xref:roll_playing_system:CH17_Driving.adoc[Driving,window=_blank]
