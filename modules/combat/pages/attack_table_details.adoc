...
* xref:anthros:attack_table.adoc[Anthro Attack Table,window=_blank, rel="noopener noreferrer"]
* xref:robots:attack_table.adoc[Robot Attack Table,window=_blank, rel="noopener noreferrer"]
* xref:aliens:attack_table.adoc[Alien Attack Table,window=_blank, rel="noopener noreferrer"]
