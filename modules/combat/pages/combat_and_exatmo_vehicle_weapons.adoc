= Exatmo Vehicle Combat Tools

These are the details of exatmo vehicle attacks and defences function. 
The actual devices are brought into being when the exatmo vehicle is generated. 
...
Consider a space vehicle with a level 2 computer employing ECM Attack Assist.
