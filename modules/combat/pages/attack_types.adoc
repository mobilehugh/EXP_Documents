...
These personalized differences are in the xref::CH09_Combat_Tables.adoc[Attack Table,window=_blank] section.

include::combat:partial$attack_type_details.adoc[]
