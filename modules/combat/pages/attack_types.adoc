...
These personalized differences are in the xref:combat:attack_table_details.adoc[Attack Table,window=_blank, rel="noopener noreferrer"] section.
...
Exotic, dangerous tech weapons are described in xref:hardware:guns.adoc[Guns,window=_blank, rel="noopener noreferrer"].
...
Sotto weapons are usually artifact weapons found in the xref:hardware:guns.adoc[Guns,window=_blank, rel="noopener noreferrer"] section.
...
Flotto weapons are usually artifact weapons found in the xref:hardware:guns.adoc[Guns,window=_blank, rel="noopener noreferrer"] section.
...
xref:combat:area_attacks.adoc[Area of Effect,window=_blank, rel="noopener noreferrer"].

NOTE: a static hexagon has a Defense of 542

=== Area Weapons
Most Area Attacks are weapons like xref:hardware:grenades.adoc[Grenades,window=_blank, rel="noopener noreferrer"] or
