...
. Reflect these actions on a https://en.wikipedia.org/wiki/Hex_map[hex mat,window=_blank, rel="noopener noreferrer"] using https://t.ly/Clfy-[minis,windows=_blank]
...
For more details about uncombat time in EXP, jump to xref:uncombat:time_and_movement.adoc[Time and Movement,window=_blank, rel="noopener noreferrer"].
...
For details of tactical combat movement jump to xref:combat:move_in_combat.adoc[Combat Movement,window=_blank, rel="noopener noreferrer"].
