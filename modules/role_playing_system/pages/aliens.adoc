...
For more information about mutation types jump to xref:wetware:a_introduction.adoc[Mutations,window=_blank, rel="noopener noreferrer"].
...
Every biologist gets two xref:vocations:biologist.adoc#biologist_skills[biologist skills,window=_blank, rel="noopener noreferrer"].
...
For more detail about knites jump to xref:vocations:knite.adoc[knites,window=_blank, rel="noopener noreferrer"].
...
The player can add a xref:vocations:mechanic.adoc#_mechanic_abilities[mechanic ability,window=_blank, rel="noopener noreferrer"] if she randomly chose this vocation. 
Every mechanic gets two xref:vocations:mechanic.adoc#_mechanic_skills[mechanic skills,window=_blank, rel="noopener noreferrer"].
...
The player can add a xref:vocations:mercenary.adoc#_mercenary_abilities[mercenary ability,window=_blank, rel="noopener noreferrer"] if she randomly chose this vocation. 
Every mercenary gets two xref:vocations:mercenary.adoc#_mercenary_skills[mercenary skills,window=_blank, rel="noopener noreferrer"].
...
The player can add a xref:vocations:nomad.adoc#_nomadic_abilities[nomad ability,window=_blank, rel="noopener noreferrer"] if she randomly chose this vocation. 
Every nomad gets two xref:vocations:nomad.adoc#_nomadic_biomes[nomad biomes,window=_blank, rel="noopener noreferrer"].
...
Nothings lack abilities or skills, but they do have a xref:vocations:nothing.adoc#_career[career,window=_blank, rel="noopener noreferrer"]and some xref:vocations:nothing.adoc#_nothing_wealth[money,window=_blank, rel="noopener noreferrer"].
...
The player can add CON to her persona's attributes if she randomly chose this vocation. 
The player can add a xref:vocations:spie.adoc#_spie_abilities[spie ability,window=_blank, rel="noopener noreferrer"] if she randomly chose this vocation. 
Every spie gets two xref:vocations:spie.adoc#_spie_tricks[spie tricks,window=_blank, rel="noopener noreferrer"].
...
The player can add a xref:vocations:veterinarian.adoc#_vet_abilities[vet ability,window=_blank, rel="noopener noreferrer"] if she randomly chose this vocation. 
Every vet gets two xref:vocations:veterinarian.adoc#_vet_skills[vet skills,window=_blank, rel="noopener noreferrer"].
...
To generate a toy for the persona jump to xref:hardware:a_introduction.adoc#_toy_type[Hardware,window=_blank, rel="noopener noreferrer"].
...
For more detail than you ever wanted jump to xref:aliens:name.adoc[Alien Name,window=_blank, rel="noopener noreferrer"].
