...
====
The Role Playing System uses the xref:role_playing_system:CH26_Fourdeetwo.adoc[4D2 Mechanic,window=_blank].
====
...
====
For a detailed description of combat jump to xref:role_playing_system:CH26_Theatrical_Combat.adoc[Theatrical Combat System,window=_blank].
====
...
====
For a detailed description of Tasks jump to xref:role_playing_system:CH26_Theatrical_Performance.adoc[Theatrical Tasks,window=_blank].
====
...
For more info about shifts jump to xref:role_playing_system:CH26_Fourdeetwo.adoc#_shifts[Shifts,window=_blank].
