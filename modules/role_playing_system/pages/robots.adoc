...
* Peripherals: None.
* To read the complete owner's manual jump to xref:robots:series_android.adoc[Android,window=_blank, rel="noopener noreferrer"].
...
* To read the complete owner's manual, jump to xref:robots:series_combot.adoc#_expendable_combot[Expendable Combot,window=_blank, rel="noopener noreferrer"].
...
* To read the complete owner's manual, jump to xref:robots:series_combot.adoc#_defensive_combot[Defensive Combot,window=_blank, rel="noopener noreferrer"].
...
* To read the complete owner's manual, jump to xref:robots:series_combot.adoc#_light_offensive_combot[Light Combot,window=_blank, rel="noopener noreferrer"].
...
* To read the complete owner's manual, jump to xref:robots:series_combot.adoc#_heavy_offensive_combot[Heavy Combot,window=_blank, rel="noopener noreferrer"].
...
* To read the complete owner's manual jump to xref:robots:series_datalyzer.adoc[Datalyzer,window=_blank, rel="noopener noreferrer"].
...
** One Defensive Peripheral
* To read the complete owner's manual, jump to xref:robots:series_exploration.adoc#_extra_planetary_exploration_robot[Exatmo Explorations,window=_blank, rel="noopener noreferrer"].
...
** One Peripheral, Basic
* To read the complete owner's manual, jump to xref:robots:series_exploration.adoc#_planetary_exploration_robot[Planetary Explorations,window=_blank, rel="noopener noreferrer"].
...
** Two Defensive Peripherals.
** One Offensive Peripheral, Table One.
* To read the complete owner's manual jump to xref:robots:series_hobbot.adoc[Hobbot,window=_blank, rel="noopener noreferrer"].
...
** One Offensive Peripheral, Table One
* To read the complete owner's manual jump to xref:robots:series_industrial.adoc#_industrial_builder_robot[Builder,window=_blank, rel="noopener noreferrer"].
...
* To read the complete owner's manual jump to xref:robots:series_industrial.adoc#_industrial_lifter_robot[Lifter,window=_blank, rel="noopener noreferrer"].
...
* To read the complete owner's manual jump to xref:robots:series_industrial.adoc#_industrial_mover_robot[Mover,window=_blank, rel="noopener noreferrer"].
...
** One Peripheral, Basic
* To read the complete owner's manual, jump to xref:robots:series_janitorial.adoc#_commercial_janitorial_robot[Commercial Janitor,window=_blank, rel="noopener noreferrer"].
...
** One Peripheral, Basic
* To read the complete owner's manual, jump to xref:robots:series_janitorial.adoc#_domestic_janitorial_robot[Domestic Janitor,window=_blank, rel="noopener noreferrer"].
...
** Repair tools.
** Two Peripheral, Basic
* To read the complete owner's manual jump to xref:robots:series_maintenance.adoc[Maintenance,window=_blank, rel="noopener noreferrer"].
...
* To read the complete owner's manual jump to xref:robots:series_policing.adoc#_civilian_policing_robot[Civilian,window=_blank, rel="noopener noreferrer"].
...
* To read the complete owner's manual jump to xref:robots:series_policing.adoc#_riobot_policing_robot[Riobot,window=_blank, rel="noopener noreferrer"].
...
* Peripherals: Grapple.
* To read the complete owner's manual jump to xref:robots:series_policing.adoc#_detective_policing_robot[Detective,window=_blank, rel="noopener noreferrer"].
...
** One Peripheral, Basic
** Two Defensive Peripherals
* To read the complete owner's manual jump to xref:robots:series_rescue.adoc#_containment_rescue_robot[Containment,window=_blank, rel="noopener noreferrer"].
...
** One Offensive Peripheral, Table One.
* To read the complete owner's manual jump to xref:robots:series_rescue.adoc#_retrieval_rescue_robot[Retrieval,window=_blank, rel="noopener noreferrer"].
...
* To read the complete owner's manual jump to xref:robots:series_social.adoc[Social,window=_blank, rel="noopener noreferrer"].
...
** One Peripheral, Basic
* To read the complete owner's manual jump to xref:robots:series_transport.adoc#_inatmo_transport_robot[Inatmo Transport,window=_blank, rel="noopener noreferrer"].
...
** One Peripheral, Basic
* To read the complete owner's manual jump to xref:robots:series_transport.adoc#_exatmo_transport_robot[Exatmo Transport,window=_blank, rel="noopener noreferrer"].
...
* To read the complete owner's manual jump to xref:robots:series_veterinarian.adoc#_diagnostic_vet_robot[Diagnostics,window=_blank, rel="noopener noreferrer"].
...
** One Peripheral, Basic
* To read the complete owner's manual jump to xref:robots:series_veterinarian.adoc#_interventional_vet_robot[Interventional,window=_blank, rel="noopener noreferrer"].
...
For more detail than you ever wanted jump to xref:robots:name.adoc[robot name,window=_blank, rel="noopener noreferrer"].
