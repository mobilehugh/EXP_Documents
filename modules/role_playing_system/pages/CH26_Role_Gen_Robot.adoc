...
* Defensive: None.
* Offensive: One.
* To read the complete owner's manual, jump to xref:robots:series_combat.adoc#_expendable_combot[Expendable Combot,window=_blank].
...
* Defensive: Two.
* Offensive: None.
* To read the complete owner's manual, jump to xref:robots:series_combat.adoc#_defensive_combot[Defensive Combot,window=_blank].
...
* To read the complete owner's manual, jump to xref:robots:series_combat.adoc#_light_offensive_combot[Light Combot,window=_blank].
...
* To read the complete owner's manual, jump to xref:robots:series_combat.adoc#_heavy_offensive_combot[Heavy Combot,window=_blank].
...
* Defensive: None.
* Offensive: None ever.
* To read the complete owner's manual jump to xref:robots:series_veterinary.adoc#_diagnostic_vet_robot[Diagnostics,window=_blank].
...
* Defensive: None.
* Offensive: None ever.
* To read the complete owner's manual jump to xref:robots:series_veterinary.adoc#_interventional_vet_robot[Interventional,window=_blank].
