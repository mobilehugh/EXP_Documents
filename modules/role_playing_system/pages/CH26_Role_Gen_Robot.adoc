...
* Defensive: None.
* Offensive: None.
* To read the complete owner's manual jump to xref:roll_playing_system:CH05_Robots_A_Android.adoc[Android,window=_blank].
...
* Defensive: None.
* Offensive: One.
* To read the complete owner's manual, jump to xref:roll_playing_system:CH05_Robots_C_Combat.adoc#_expendable_combot[Expendable Combot,window=_blank].
...
* Defensive: Two.
* Offensive: None.
* To read the complete owner's manual, jump to xref:roll_playing_system:CH05_Robots_C_Combat.adoc#_defensive_combot[Defensive Combot,window=_blank].
...
* To read the complete owner's manual, jump to xref:roll_playing_system:CH05_Robots_C_Combat.adoc#_light_offensive_combot[Light Combot,window=_blank].
...
* To read the complete owner's manual, jump to xref:roll_playing_system:CH05_Robots_C_Combat.adoc#_heavy_offensive_combot[Heavy Combot,window=_blank].
...
* Peripherals: One plus one non-defective Psionic Mutation.
* Defensive: One.
* Offensive: None.
* To read the complete owner's manual jump to xref:roll_playing_system:CH05_Robots_D_Datalyzer.adoc[Datalyzer,window=_blank].
...
* Defensive: One.
* Offensive: None.
* To read the complete owner's manual, jump to xref:roll_playing_system:CH05_Robots_E_Explorations.adoc#_extra_planetary_exploration_robot[Exatmo Explorations,window=_blank].
...
* Defensive: None.
* Offensive: None.
* To read the complete owner's manual, jump to xref:roll_playing_system:CH05_Robots_E_Explorations.adoc#_planetary_exploration_robot[Planetary Explorations,window=_blank].
...
* Defensive: Two.
* Offensive: One.
* To read the complete owner's manual jump to xref:roll_playing_system:CH05_Robots_H_Hobbot.adoc[Hobbot,window=_blank].
...
* Defensive: None.
* Offensive: One.
* To read the complete owner's manual jump to xref:roll_playing_system:CH05_Robots_I_Industrial.adoc#_industrial_builder_robot[Builder,window=_blank].
...
* Defensive: None.
* Offensive: None.
* To read the complete owner's manual jump to xref:roll_playing_system:CH05_Robots_I_Industrial.adoc#_industrial_lifter_robot[Lifter,window=_blank].
...
* Defensive: None.
* Offensive: None.
* To read the complete owner's manual jump to xref:roll_playing_system:CH05_Robots_I_Industrial.adoc#_industrial_mover_robot[Mover,window=_blank].
...
* Defensive: None.
* Offensive: None.
* To read the complete owner's manual, jump to xref:roll_playing_system:CH05_Robots_J_Janitorial.adoc#_commercial_janitorial_robot[Commercial Janitor,window=_blank].
...
* Defensive: None.
* Offensive: None.
* To read the complete owner's manual, jump to xref:roll_playing_system:CH05_Robots_J_Janitorial.adoc#_domestic_janitorial_robot[Domestic Janitor,window=_blank].
...
* Defensive: None.
* Offensive: None.
* To read the complete owner's manual jump to xref:roll_playing_system:CH05_Robots_M_Maintenance.adoc[Maintenance,window=_blank].
...
* To read the complete owner's manual jump to xref:roll_playing_system:CH05_Robots_P_Policing.adoc#_civilian_policing_robot[Civilian,window=_blank].
...
* Offensive: None.
* To read the complete owner's manual jump to xref:roll_playing_system:CH05_Robots_P_Policing.adoc#_riobot_policing_robot[Riobot,window=_blank].
...
* Defensive: None.
* Offensive: None.
* To read the complete owner's manual jump to xref:roll_playing_system:CH05_Robots_P_Policing.adoc#_detective_policing_robot[Detective,window=_blank].
...
* To read the complete owner's manual jump to xref:roll_playing_system:CH05_Robots_R_Rescue.adoc#_containment_rescue_robot[Containment,window=_blank].
...
* Defensive: Two.
* Offensive: One.
* To read the complete owner's manual jump to xref:roll_playing_system:CH05_Robots_R_Rescue.adoc#_retrieval_rescue_robot[Retrieval,window=_blank].
...
* Defensive: None.
* Offensive: None.
* To read the complete owner's manual jump to xref:roll_playing_system:CH05_Robots_S_Social.adoc[Social,window=_blank].
...
* Defensive: None.
* Offensive: None.
* To read the complete owner's manual jump to xref:roll_playing_system:CH05_Robots_T_Transport.adoc#_inatmo_transport_robot[Inatmo Transport,window=_blank].
...
* Defensive: None.
* Offensive: None.
* To read the complete owner's manual jump to xref:roll_playing_system:CH05_Robots_T_Transport.adoc#_exatmo_transport_robot[Exatmo Transport,window=_blank].
...
* Defensive: None.
* Offensive: None ever.
* To read the complete owner's manual jump to xref:roll_playing_system:CH05_Robots_V_Veterinarian.adoc#_diagnostic_vet_robot[Diagnostics,window=_blank].
...
* Defensive: None.
* Offensive: None ever.
* To read the complete owner's manual jump to xref:roll_playing_system:CH05_Robots_V_Veterinarian.adoc#_interventional_vet_robot[Interventional,window=_blank].
...
Every nomad gets two xref:roll_playing_system:CH08_Vocations_Nomad.adoc#_nomadic_biomes[nomad biomes,window=_blank].
...
For more detail than you ever wanted jump to xref:roll_playing_system:CH05_Robots_Z_Name.adoc[robot name,window=_blank].
