...
If actual number amounts are needed xref:roll_playing_system:incidentals.adoc#_start_money[jump here,window=_blank, rel="noopener noreferrer"]
...
If mundane equipment is part of the milieu xref:roll_playing_system:incidentals.adoc#_start_equipment[jump here,window=_blank, rel="noopener noreferrer"]
