...
The Roll-Playing System has a plethora of complex dice rolls. 
...
====
The Role-Playing System uses the xref:role_playing_system:four_dee_two_mechanic.adoc[4D2 Mechanic,window=_blank, rel="noopener noreferrer"].
====
...
====
For a detailed description of combat jump to xref:role_playing_system:combat_rules.adoc[Theatrical Combat System,window=_blank, rel="noopener noreferrer"].
====
...
====
For a detailed description of Tasks jump to xref:role_playing_system:task_rules.adoc[Theatrical Tasks,window=_blank, rel="noopener noreferrer"].
====

== Attribute Rolls
A player makes an attribute roll for her persona when an action challenges a specific attribute.
...
For more info about shifts jump to xref:role_playing_system:four_dee_two_mechanic.adoc#_shifts[Shifts,window=_blank, rel="noopener noreferrer"].
...
== Negotiations
Players can only use role-play to resolve negotiations in the Role-Playing System.
