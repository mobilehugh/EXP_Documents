...
The mutant uses her MND instead of her DEX on the xref:i-roll_playing_rules:CH03_AttributesDEX.adoc#_moverate[Movement Rate,window=_blank] table.
...
She can lift ten times her xref:i-roll_playing_rules:CH18_Encumbrance.adoc[Wate Allowance,window=_blank] using her MND instead of STR.
