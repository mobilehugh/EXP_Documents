...
. <<_mental_mutation_attribute_explanations,Psionic Mutation Attribute Explanations>>


== Psionic Mutation Type
...
This includes psionic mutations and physical mutations of the target.
...
== Psionic Mutation Attribute Explanations
