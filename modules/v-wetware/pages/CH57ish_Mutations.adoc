...
Psionic mutations function through the thinkspace of the xref:vi-appendices:Appy_C_Mythos_Generic.adoc#_the_spaces[Spaces,window=_blank].
...
The attribute that powers psionic mutations is xref:i-roll_playing_rules:CH03_AttributesMND.adoc[Mind,window=_blank].
