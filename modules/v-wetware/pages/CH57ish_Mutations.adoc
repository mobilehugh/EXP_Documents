...
The persona manipulates the world through her brain and her mental strength attribute.
...
The attribute that powers mental mutations is xref:i-roll_playing_rules:CH03_AttributesMSTR.adoc[Mental Strength,window=_blank].
...
Using level-adjusted attributes is the most common way to implement level improvements, i.e., MSTR + EXPS Level or CON + EXPS Level.