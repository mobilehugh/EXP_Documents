...
A mutant that launches six quills would inflict 6d8 damage plus her type B Force Bonus.
...
There is no difference between the intensity of poison or Type B Force Bonus made by different sized salvos.
