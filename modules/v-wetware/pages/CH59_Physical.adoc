...
The duration of effect is determined by the xref:hardware:CH50_Pharmaceuticals.adoc[Pharma,window=_blank]. 
...
. Determine insertion xref:hardware:An_index_hardware.adoc#_toy_type[Type,window=_blank]
