...
//physical mutations have a tell
...
include::ROOT:partial$CH59_Table_Oversized_Body_Part.adoc[]
...
The player can choose the colour (not black) or generate it at xref:iv-software:CH55_Appearances.adoc#_colour_your_whirled[Colour,window=_blank].
...
The mutant can fall 1h per Adjusted PSTR and sustain no falling damage.
Falling damage is reduced by half.
Type A attacks, explosions, pressure waves, and vehicle crashes all halve the damage inflicted.
...
The beam is her head's size and usually has a distinct xref:iv-software:CH55_Appearances.adoc#_colour_your_whirled[Colour,window=_blank].
...
The player needs to win an attack roll, but the target's armour rating is only 500 plus DEX bonus.
...
She will quickly regenerate to HPS Max, appearing as good as new.
...
Or the player can let the dice decide by jumping to xref:iv-software:CH55_Appearances.adoc#_colour_your_whirled[Colour,window=_blank].
...
If a fevered discussion brings the players to an impasse, they should consult the xref:i-roll_playing_rules:CH16_Special_Rolls_Asshole.adoc[Sphincter Dice,window=_blank].
...
ShShape change allows the mutant to rearrange her body.
...
Shrinking does not alter her wate, attributes or skill performance.
Besides allowing her to fit into tight spaces, the mutant gets an armour rating bonus of +75.
Her clothes will drape around her like a tent. 

The mutant can increase her size by up to 150%  for her normal size. 
Enlarging does not alter her wate, attributes or skill performance.
Besides allowing her to reach the top shelf, the mutant gets a damage adjustment bonus of +50% non-powered attacks. 
...
The armour rating changes affect the base armour rating of the mutant.
So plated skin increases the base armour rating from 500 to 650.
The impact is purely on armour rating, and the skin structure change offers not other special abilities.
Often mutants with this mutation are averse to wearing armour out of pride or comfort

include::ROOT:partial$CH59_Table_Skin_Structure_Change.adoc[]

=== Smoke Screen 

[horizontal]
Range:: 1h per Unit Duration
Duration:: 1u per 3 Adjusted PSTR
...
The plume of smoke can have a strong xref:i-roll_playing_rules:CH06_Aliens_12_Biology.adoc#_aroma[Aroma,window=_blank] and distinct xref:iv-software:CH55_Appearances.adoc#_colour_your_whirled[Colour,window=_blank].
...
A 2nd level mutant with a 10 PSTR could create a cloud of 4 hexes in radius.
...
[horizontal]
Range:: 1h per 2 Adjusted PSTR
Duration:: Special
Frequency:: 1 per 2 Adjusted CON
General Bonus:: 

Sonic attack allows the mutant to create noises so loud they are destructive. 
...
The further away the target is, the less damage the sonic attack inflicts. 
A 2nd level mutant with a 10 PSTR has a radius of effect of 6 hexes.

include::ROOT:partial$CH59_Table_Sonic_Attack_Volume.adoc[]

The sonic energy damages every target in the area of effect. 
...
The sonic attack can shut down organic and inorganic sensors.
...
The sonic attack damages everything in the area of effect with a sonic blast of force.
The mutant's fellow expedition members are also affected by the sonic attack.
...
include::ROOT:partial$CH59_Table_Poison_Type.adoc[]
