...
The quills layer is thick and offers an armour rating bonus of +101, but the mutant cannot wear armour.
...
If the player has rolled a purely cosmetic mutation, she should get another roll on the physical mutation table.

include::ROOT:partial$CH59_Table_Strange_New_Body_Part.adoc[]
...
The strange new mouth functions like any other cakehole and is considered cosmetic.
...
The pincer bite is a type A weapon and inflicts 1-8 (1d8) hit points in damage.
...
Spike is a type A weapon and inflicts 1 to 12 (1d12) HPS in damage.
...
The shell's armour rating is 777. 
...
include::ROOT:partial$CH59_Table_Undersized_Body_Part.adoc[]

=== Vibrations 

[horizontal]
Range:: Touch
Duration:: 1h per Adjusted DEX
Frequency:: 1h per Adjust DEX
General Bonus:: Combat Ratio +5
...
The vibration punch is a type A attack that inflicts 3-12 (3d4) hit points of damage.
The player adds +97 to any attack rolls made with vibrating hands.
The vibrations can also be conducted through metallic type A weapons turning them into organic vibro weapons.
...
She increases her damage adjustment by 50%.
