...
Adaptation allows the mutant to develop immunity to any threat in the physical space.
Her body will adapt to poisons, radiation, and diseases.
...
A deci-die roll less than twice the mutant's adjusted INT will indicate that the mutant has temporarily adapted to the attack.
...
The attack roll is made as a type C attack.
...
If a successful attack roll is made the bolt will inflict 3-12 (3d4) hit points of damage plus 1 hit point per experience level.
A attack roll is made as a type C weapon.
...
I.e., if the fat cell accumulation is on the persona's face they would not suffer any AWE penalty or attack roll penalty.
