...
To generate the artillery piece jump to xref:iv-hardware:CH43_Artillery.adoc#_artillery_type[Artillery].
...
If the bomb does not have a missile the persona gets a 1-3 (1d3) increase to their mental strength. To generate the bomb type jump to xref:iv-hardware:CH44_Bombs.adoc#_bomb_type[Bombs].
...
In addition to the above jump to xref:iv-hardware:CH48_Misc_Equip.adoc#_communicators[Communicators].
...
To generate the computer equipment jump to xref:iv-hardware:CH48_Misc_Equip.adoc#_computers[Computers].
...
Energy weapons have an unlimited power supply from the armour's power plant.
To determine the rifle type jump to xref:iv-hardware:CH46_Guns.adoc#_gun_type[Guns].
...
Miscellaneous Equipment:: 
Any bizarre device could be rolled in xref:iv-hardware:CH48_Misc_Equip.adoc#_miscellaneous_equipment_type[Miscellaneous Equipment].
