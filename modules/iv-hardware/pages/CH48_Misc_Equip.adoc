...
For instance the power plug could be connected between the wall outlet in a building, and the battery holder in a lazer rifle to give the lazer rifle unlimited ammunition.
...
The battery recharger will be able to recharge #3-18 batteries at once (limited number of holders).
...
For instance glue, tape and soldering irons are all joiners.
...
All older chronological cycles can be recalled upon request.
