...
Neither type of computer requires great technical expertise, and the two types are discussed in the following paragraphs.
...
Roll on the referee persona http://expgame.com/?page_id=2577-2-personality[Personality Table], in Chapter 8, if you desire your MOM computer to have a personality trait.
