...
=== Type
This describes what kind of base vehicle the primary format is.
...
=== Wate
The vehicle wate is simply a guideline that indicates the vehicle's unloaded wate in tonnes.
The referee may have to adjust the wate depending on what is attached to the vehicle.

=== Passengers
The number of passengers refers to the number of seats that are present to safely carry personas.
...
=== Cargo
Cargo can be listed as a flat number, and this is the number of tonnes that the vehicle can safely transport.
...
Use the acceleration of the vehicle as a comparison between t0 vehicles and all should be wellish.
