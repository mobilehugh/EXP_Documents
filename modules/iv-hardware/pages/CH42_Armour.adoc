...
The armour rating (AR) is increased from the mundane base by 30 to 120 (3d4 times 10).
...
The referee can arbitrarily wear the flexion covering out if it is being abused.
Roll on the Flexion Covering Type to determine the type, restrictiveness, wate, and value.
...
Concussion::  Concuflect appears as a bulky down parka.
...
Electro:: Electroflec coverings reduce the chance of taking damage from electrical attacks by grounding the deadly current.
...
Energy:: Enerflec reduces the chance to be hit by personal energy weapons (such as fusion, fission and plasma guns).
...
Inertia::  Inerflec has a slickery covering that makes low velocity striking and puncturing weapons less likely to hit.
...
Lazer::  Reflec is the most well known of all the flexion coverings.
...
Projectile::  Proflec is a hardened covering composed of a thin layer of ballistic cloth.
...
Vibro::  Vibroflec is an intricate weave of microscopic (the present catchphrase is nano'), high tensile threads which are designed to make vibro attacks more likely to skip off'
...
The civilian vac suit is the virtual life preserver of outer space.
...
The industrial vac suit was designed to do outside repair work for space vehicles while exatmo.
...
While exatmo, the military vac suit is virtually undetectable to anything other than direct visual sight.
