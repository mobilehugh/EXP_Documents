...
Therefore armour WATE is listed as a percentaggla the body wate of the persona that the armour was designed for.
...
The various flexion coverings appear as beltless, pocketless ponchos, parkas or trenchcoats.
...
The helmet could have a _gun_+++<i>+++, +++</i>+++medical equipment, or scope installed.
...
The type of artifact shield and it's benefits are determined on Table 42.7: Shield Armour Type+++<i>+++.
+++</i>+++All special properties of the armour that apply to the shield are listed on the table.
...
The vac suit, or space suit, is the standard protection worn by anthropomrphs expecting to survive zero atmosphere.
