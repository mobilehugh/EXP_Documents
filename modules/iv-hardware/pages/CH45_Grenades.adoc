...
There is a 50% chance that the gravruptor grenade will add 1-6 g to the local terrain.
...
The magnetic disruptor grenade will generate an attraction for a specific type of material.
...
This grenade can have lethal effects, as great big chunks of plastic, or metal, will be racing across the area of effect.
...
Each time a molecular disruptor is used the Extent of Disruption must be determined.

The table lists both damage and disintegration values.
...
^&8211;^Such grenades are dangerous to the expedition because they can easily hop their way back to home ranks.
...
This means that organic targets will have to http://expgame.com/?page_id=275saving-throw[make a]http://expgame.com/?page_id=275saving-throw[save vs.
