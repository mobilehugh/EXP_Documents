...
This is the root of the science fantasy milieu of EXP.
...
* xref:CH47_Medical.adoc[Medical Equipment,window=_blank]
* xref:CH48_Misc_Equip.adoc[Miscellaneous Equipment,window=_blank]
** xref:i-persona_creation:CH11_Referee_Personas_Robot.adoc[Robot, window=_blank]
...
* xref:CH52_Space_Vehicle.adoc[Vehicles - Exatmo,window=_blank]
* xref:CH54_Vehicles.adoc[Vehicles - Inatmo,window=_blank]
...
Jump to xref:v-software:CH55_Support.adoc[Support Equipment,window=_blank] for more details.
...
Jump to xref:v-software:CH56_Tech_Level.adoc[Tech Levels,window=_blank] for more details.
