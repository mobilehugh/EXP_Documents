...
For more detailed information see the base rifletype in chapter 46.
...
The cryocannon freezes everything within its 6 hex #by 100 hex area of effect.
...
Plastix artillery is the bane of all troopers stormin'
in plastix armour.
...
The protein disrupter has no effect on inorganic targets, and is unimpeded by walls, force fields, or spacevehicle hulls.
For more detailed information see the base rifle type in chapter 46.#
