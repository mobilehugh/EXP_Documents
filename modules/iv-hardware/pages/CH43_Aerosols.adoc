...
To randomly determine this jump to xref:ii-roll_playing_rules:CH16_Special_Rolls_Asshole.adoc[Sphincter Rolls].
A loss in a sphincter roll will indicated that the device is partially disintegrated.
Jump to xref:ii-roll_playing_rules:CH21_Artifact_Damage.adoc#_extent_of_damage[Equipment Damage] to determine the extent of damage.
...
Consult the xref:ii-roll_playing_rules:CH16_Special_Rolls_Asshole.adoc[Sphincter Dice] to determine if a particular attempt to destroy the web works. 
