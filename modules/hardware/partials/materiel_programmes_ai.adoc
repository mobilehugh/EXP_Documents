...
|34
|Compiler
|Add 1-2 xref:referee_personas:ai_rp.adoc#_peripherals[Peripherals,window=_blank, rel="noopener noreferrer"]
...
|91-93
|STEP
|Ignore anthro safety xref:referee_personas:ai_rp.adoc#_exp_ai_mythos[STEP MOM.window=_blank, rel="noopener noreferrer"]
