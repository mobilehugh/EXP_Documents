...
|Irrationality
|Permanent
|Roll xref:referee_personas:anthro_rp.adoc#_irrationality[Irrationality,window=_blank, rel="noopener noreferrer"]. Lose 1d6 on INT and MND.
...
|Nausea
|2-16 (2d8) Days 
|Half all attributes except HPM.
