...
Regardless of the special drive type, the vessel travels through xref:appendices:Appy_C_Mythos_Generic.adoc#_the_spaces[hyperspace,window=_blank].. 
...
For more information about fuel and energy jump to the generic mythos section -> xref:appendices:Appy_C_Mythos_Generic.adoc#_energy_and_power[Energy and Power,window=_blank].
