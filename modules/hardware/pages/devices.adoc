...
This comms laboratory is part of a space vehicle and requires a ship's computer and a ship's power plant to operate.
...
A tesseract box can be fitted with a xref:hardware:CH52_Space_Vehicle.adoc#_special_drives[Special Drive,window=_blank].
Since the box has a special relationship with hyperspace, its jump drive can travel further than usual jump drives.
The box cannot have any other kind of space vehicle drive, as the box has far too much wate.
