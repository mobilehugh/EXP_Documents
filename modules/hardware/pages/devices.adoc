...
If no obvious description comes to mind jump to xref:software:CH55_Appearances.adoc[Appearances,window=_blank].
...
A failed organic object will acquire 0-3 (1d4-1) xref:wetware:CH59_Physical.adoc#_defective_mutations[Defective Phenomic Mutations,window=_blank].
...
It is also reasonable to have support equipment align with existing expedition artifacts.
...
Take a jump over to xref:software:CH55_Support.adoc[Support Equipment,window=_blank].
