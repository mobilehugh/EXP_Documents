...
If no obvious description comes to mind jump to xref:hardware:appearance.adoc[Appearances,window=_blank, rel="noopener noreferrer"].
...
Whether or not ammo fits an available weapon can be determined by xref:uncombat:sphincter_rolls.adoc[Sphincter Roll,window=_blank, rel="noopener noreferrer"]
...
If the pack were disabled for 14 units there would be a 14% chance of the backpack's anti grav unit being xref:combat:equipment_damage.adoc#_extent[damaged,window=_blank, rel="noopener noreferrer"].
...
To fabricate an AI, jump to xref:referee_personas:ai_rp.adoc[Autonomous Intelligence,window=_blank, rel="noopener noreferrer"].
...
A failed organic object will acquire 0-3 (1d4 - 1) xref:wetware:phenomics.adoc#_defective_mutations[Defective Phenomic Mutations,window=_blank, rel="noopener noreferrer"].
...
The boots move at 21-30 (1d10 + 20) hexes per unit and allow the wearer to fly through the air.
...
The pack moves at 21-40 (1d20 + 20) hexes per unit and allows the wearer to fly through the air.
...
The Kirlian Talisman is a concentration symbol employed by xref:vocations:knite.adoc[Knite Vocation,window=_blank, rel="noopener noreferrer"].
...
Jump to xref:uncombat:critical_checks.adoc#_critical_hit[Critical Hits,window=_blank, rel="noopener noreferrer"].
...
Take a jump over to xref:hardware:materiel.adoc[Materiel,window=_blank, rel="noopener noreferrer"].
...
These rooms are not in the physical space but may exist in the interstitium of physical space (aka xref:appendices:generic_mythos.adoc#_the_spaces[hyperspace,window=_blank, rel="noopener noreferrer"]).
...
A tesseract box can be fitted with a xref:hardware:spacecraft.adoc#_special_drives[Special Drive,window=_blank, rel="noopener noreferrer"].
