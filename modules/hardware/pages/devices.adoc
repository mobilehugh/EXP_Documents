...
To avoid traps or alarms, the player must win a 5 DD task roll. 
...
To avoid traps or alarms, the player must win a 9 DD task roll.
...
Off-label use (other than bombs) requires a 6DD task roll.
