...
To refresh on how money works in EXP jump to xref:uncombat:money.adoc[Money,window=_blank, rel="noopener noreferrer"].
...
Jump to xref:hardware:junque.adoc[Junque,window=_blank, rel="noopener noreferrer"] to generate a relic for the treasure value. 
