...
If flashy colours, appendages and strange shapes are your jam jump to xref:software:CH55_Appearances.adoc[Appearances,window=_blank].  
...
For a fancy smoke colour, jump to the xref:software:CH55_Appearances.adoc#_colour_your_whirled[Colour your whirled,window=_blank].
...
To determine the paint colour and pattern, jump to the xref:software:CH55_Appearances.adoc#_colour_your_whirled[Colour your whirled,window=_blank].
...
To determine the smog colour jump to the xref:software:CH55_Appearances.adoc#_colour_your_whirled[Colour your whirled,window=_blank].
