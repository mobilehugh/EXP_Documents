...
If the player wins the sphincter roll the artifact suffers a xref:roll_playing_system:combat:breaking_things.adoc#_extent_of_damage[Equipment Damage,window=_blank] to determine the extent of damage.
