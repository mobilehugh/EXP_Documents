...
If the player wins the sphincter roll the artifact suffers a xref:combat:combat:breaking_things.adoc#_extent[Equipment Damage,window=_blank] to determine the extent of damage.
