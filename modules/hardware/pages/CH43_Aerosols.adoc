...
If the player wins the sphincter roll the artifact suffers a xref:combat:breaking_things.adoc#_extent[Equipment Damage,window=_blank] to determine the extent of damage.
