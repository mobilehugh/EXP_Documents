...
Jump here for the gory details of xref:combat:attack_types.adoc[Attack Types,window=_blank, rel="noopener noreferrer"]
...
==== Value 
The value indicates the MSRP (Money Suggested for role-playing) of the miscellaneous weapon in eps. 
...
The referee and players can consult xref:combat:hit_locations.adoc[Hit Locations,window=_blank, rel="noopener noreferrer"] to determine what horror transpires.
...
If you need a random colour for the lite sabre then jump to xref:hardware:appearance.adoc#_colour_your_whirled[Colour,window=_blank, rel="noopener noreferrer"].
...
For help with amputation location jump to with xref:combat:hit_locations.adoc[Hit Locations,window=_blank, rel="noopener noreferrer"].
...
==== Kirlian Focus Tool
A solid lite sabre is the preferred xref:vocations:knite.adoc[Knite's,window=_blank, rel="noopener noreferrer"]  weapon.
Those lite sabres that act as a xref:hardware:devices.adoc#_kirlian_talisman[Kirlian Talisman,window=_blank, rel="noopener noreferrer"] for Knites are ancient and of limited number. 
...
To determine the grenade type jump to xref:hardware:grenades.adoc#_grenade_type[Grenade Type,window=_blank, rel="noopener noreferrer"].
...
Rigging a grenade on a passenger rocket is a Easy (24) mechanic task, or a normal (42) mercenary task.
...
For more info about temporal attacks jump to xref:uncombat:health.adoc#_aging[Aging,window=_blank, rel="noopener noreferrer"].
