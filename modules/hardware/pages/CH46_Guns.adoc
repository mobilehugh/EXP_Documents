...
:date: 1991
:license: CC BY-SA 4.0
:description: Four futuristic fifles in a row.

include::ROOT:partial$articulate.adoc[]

.*Gun Checklist*
. <<_gun_type,Gun Type>>
. <<_gun_parameters,Gun Parameters>>
...
:date: 1991
:license: CC BY-SA 4.0
:description: Pistol with chamber for holding gas on body.
...
:date: 1953
:license: CC BY-SA 4.0
:description: Drawing of toy pistol from patent office 1953.
...
:date: 1953
:license: CC BY-SA 4.0
:description: Drawing of toy rifle from patent office 1953.
...
An antimat rifle launches a microparticle of antimatter suspended in a lattice of electrons.
This lattice will shatter when it hits a liquid or solid.
...
If hit location is important jump to xref:roll_playing_system:CH36_Hit_Locations.adoc[Hit Location].
If there is trouble deciding if matter is contiguous or not jump to xref:roll_playing_system:CH16_Special_Rolls_Asshole.adoc[Sphincter Dice]
...
:date: 1953
:license: CC BY-SA 4.0
:description: Drawing of futuristic pistol from Tom Corbett TV show merchandise.
...
:date: 1953
:license: CC BY-SA 4.0
:description: Drawing of futuristic rifle from Tom Corbett TV show merchandise.
...
For a discussion of full auto (flotto) attacks jump to xref:roll_playing_system:CH28_Weapons.adoc#_type_f_attacks[Flotto Attacks].
...
To compare personas competing by attribute jump to xref:roll_playing_system:CH16_Special_Rolls_Attributes.adoc#_attribute_competition[Attribute Competition].
...
For more info about radiation attacks jump to xref:roll_playing_system:CH16_Special_Rolls_Saves.adoc#_radiation_attacks[Radiation Attacks].
...
For all the deets jump to xref:roll_playing_system:CH28_Weapons.adoc[Attack Types,window=_blank].
...
include::ROOT:partial$CH46_Table_Weapon_Calibre.adoc[]
