...
The player can randomly determine the additional TOY via the xref:hardware:a_introduction.adoc#_toy_type[Toy Type,window=_blank, rel="noopener noreferrer"].
