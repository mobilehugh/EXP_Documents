...
Motorized movement allows the exoskeleton to run away at triple xref:roll_playing_system:CH03_AttributesDEX.adoc#_moverate[Movement Rate,window=_blank] rate and not less than 15 hexes per unit.
