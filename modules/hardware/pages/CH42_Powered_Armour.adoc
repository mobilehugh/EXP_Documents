...
.STR + 4-10 (2d4+2)
****
In armour STR = 12 + (2d4+2) = 12 + 8 = 20
****
...
To determine the aerosol type jump to xref:hardware:CH43_Aerosols.adoc#_aerosol_type[Aerosols,window=_blank].
...
To determine the light piece of miscellaneous equipment jump to xref:hardware:CH48_Misc_Equip.adoc#_miscellaneous_equipment_type[Miscellaneous Equipment,window=_blank].
...
To generate the artillery piece jump to xref:hardware:CH43_Artillery.adoc#_artillery_type[Artillery,window=_blank].
...
For further communication acccessories jump to xref:hardware:CH48_Misc_Equip.adoc#_communicators[Communicators,window=_blank].
...
xref:roll_playing_system:CH18_Encumbrance.adoc[Encumbrance,window=_blank]
