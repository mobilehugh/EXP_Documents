...
While other artifacts require an entire xref:roll_playing_system:CH14_Performance_Tables.adoc#_research_teams[Research Teams,window=_blank].
...
If there is a dispute whether a mutation is a freak of nature or an evolutionary trait, consult the xref:roll_playing_system:CH16_Special_Rolls_Asshole.adoc[Sphincter Dice,window=_blank].
...
Whether the beam works on a robot with computer virus requires xref:roll_playing_system:CH16_Special_Rolls_Asshole.adoc[Sphincter Dice,window=_blank].
...
If there is any questions about limb sizing or matching consult the xref:roll_playing_system:CH16_Special_Rolls_Asshole.adoc[Sphincter Dice,window=_blank].
...
Jump to xref:v-wetware:CH59_Physical.adoc#_mutation_type[Phenomic Mutations]  
...
It is strongly recommended to build a xref:roll_playing_system:CH14_Performance_Tables.adoc#_research_teams[Research Team,window=_blank] when using a cerebro converter.
...
Jump to xref:roll_playing_system:CH21_Artifact_Damage.adoc#_extent_of_damage[Equipment Damage,window=_blank]. 
...
Jump to xref:roll_playing_system:CH11_Referee_Personas_Anthro.adoc#_introverted[mild insanity,window=_blank] for some inspiration.
...
It is strongly recommended to build a xref:roll_playing_system:CH14_Performance_Tables.adoc#_research_teams[Research Team,window=_blank] when using cloning equipment.
...
It is strongly recommended to build a xref:roll_playing_system:CH14_Performance_Tables.adoc#_research_teams[Research Team,window=_blank] when using analyzing drugs.
...
xref:roll_playing_system:CH14_Performance_Tables.adoc#_research_teams[Research Teams] may be required for fancy rare medications.
...
Jump to xref:roll_playing_system:CH04__Families.adoc[Families,window=_blank] for more info.
...
xref:roll_playing_system:CH14_Performance_Tables.adoc#_research_teams[Research Teams,window=_blank] are recommended when running a rejuv chamber.
