...
This mutation can be a xref:wetware:CH59_Physical.adoc#_combat_mutations[Physical Combat Mutation,window=_blank], or a xref:wetware:CH59_Physical.adoc#_non_combat_mutations[Physical Non-Combat Mutation,window=_blank].
...
Jump to xref:wetware:CH58_Mental.adoc#_mutation_type[Psionic Mutations]  
...
Jump to xref:wetware:CH59_Physical.adoc#_mutation_type[Phenomic Mutations]  
...
The persona must win a mental attack roll or suffer a xref:wetware:CH58_Mental.adoc#_defective_mutations[Defective Psionic Mutation,window=_blank].
...
The impacts of tech level on artifacts is cover in xref:software:CH56_Tech_Level.adoc[Tech Level,window=_blank].
