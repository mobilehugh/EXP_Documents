...
If colour and other appointments are needed jump to xref:hardware:appearance.adoc[Appearances,window=_blank, rel="noopener noreferrer"].
...
Communication:: 
The communication device is generated at xref:hardware:devices.adoc#_communicators[communicators,window=_blank, rel="noopener noreferrer"].
...
Jump to xref:hardware:guns.adoc#_generate_type[Gun,window=_blank, rel="noopener noreferrer"] to generate the pistol.
...
Jump to xref:hardware:biorepair.adoc#_veterinary_equipment_type[Biorepair,window=_blank, rel="noopener noreferrer"].
...
Jump to xref:hardware:devices.adoc#_generate_type[Device,window=_blank, rel="noopener noreferrer"].

Scope:: 
There is no limit to the type of scope in a helmet.
Roll from the list of scope artifacts found in xref:hardware:devices.adoc#_scopes[Scopes,window=_blank, rel="noopener noreferrer"].

Visual Aid:: 
The persona will be able to flip the vizaud up and down using a stylish visor.
Roll from the list of visual aid artifacts found in xref:hardware:devices.adoc#_visual_aids[Visual Aids,window=_blank, rel="noopener noreferrer"]
...
Jump to xref:hardware:biomech.adoc[Biomech,window=_blank, rel="noopener noreferrer"].
...
Powered Shield::
A powered shield is an attachment for an upper limb of xref:hardware:biomech.adoc[Biomech,window=_blank, rel="noopener noreferrer"].
...
The accessories for a powered shield are generated at xref:hardware:biomech.adoc#_upper_limbs[Upper Limbs,window=_blank, rel="noopener noreferrer"].
