...
If colour and other appointments are needed jump to xref:software:CH55_Appearances.adoc[Appearances,window=_blank].
...
Jump to xref:hardware:CH47_Medical.adoc#_veterinary_equipment_type[Biorepair,window=_blank].
...
Jump to xref:hardware:CH48_Misc_Equip.adoc#_miscellaneous_equipment_type[Device,window=_blank].
...
Jump to xref:hardware:CH42_Powered_Armour.adoc[Biomech,window=_blank].
...
Powered Shield::
A powered shield is an attachment for an upper limb of xref:hardware:CH42_Powered_Armour.adoc[Biomech,window=_blank].
