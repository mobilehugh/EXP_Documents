...
Spacecraft, vehicles, robots and other powerful items stop startifact generation.
...
If a spacecraft defeats the purpose of the entire campaign, roll again.
If the player table is looking for artifacts that focus on combat, uncombat, or cool stuff jump to xref:hardware:generation.adoc[TOY Generation].
...
Did alien civilizations leave their garbage behind under https://en.wikipedia.org/wiki/Stargate[pyramids,window=_blank, rel="noopener noreferrer"]?
Or is it both?
...
For the mini-game of artifact identification xref:uncombat:artifact_id.adoc[jump here.,window=_blank, rel="noopener noreferrer"]
