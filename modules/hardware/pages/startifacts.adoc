...
NOTE: If it wrecks the game, roll again.
...
For the mini-game of artifact identification xref:roll_playing_system:CH20_Artifact_ID.adoc[jump here.,window=_blank]
