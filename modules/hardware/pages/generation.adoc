...
The referee can make the plethora of 1d100 (deci-die) rolls needed to generate an artifact.
The referee will often involve the players to make the deci-die rolls. 
...
== Startifacts
Specifically looking for toys for fresh personas jump to xref:hardware:startifacts.adoc[Startifacts,window=_blank, rel="noopener noreferrer"].