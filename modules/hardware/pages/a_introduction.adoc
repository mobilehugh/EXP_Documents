...
In our mundane terra's olden daze, there was a game show dedicated to https://en.wikipedia.org/wiki/What_in_the_World[identifying things,window=_blank, rel="noopener noreferrer"].
...
Jump to xref:hardware:materiel.adoc[Materiel,window=_blank, rel="noopener noreferrer"] for more details.
...
Jump to xref:hardware:tech_level.adoc[Tech Levels,window=_blank, rel="noopener noreferrer"] for more details.
