...
Communication:: 
The communication device is generated at xref:hardware:CH48_Misc_Equip.adoc#_communicators[communicators,window=_blank].
...
Jump to xref:hardware:CH46_Guns.adoc#_gun_type[Gun,window=_blank] to generate the pistol.
...
Jump to xref:hardware:CH47_Medical.adoc#_veterinary_equipment_type[Vet Equipment,window=_blank].
...
Jump to xref:hardware:CH48_Misc_Equip.adoc#_miscellaneous_equipment_type[Miscellaneous Equipment,window=_blank].

Scope:: 
There is no limit to the type of scope in a helmet.
Roll from the list of scope artifacts found in xref:hardware:CH48_Misc_Equip.adoc#_scopes[Scopes,window=_blank].

Visual Aid:: 
The persona will be able to flip the vizaud up and down using a stylish visor.
Roll from the list of visual aid artifacts found in xref:hardware:CH48_Misc_Equip.adoc#_visual_aids[Visual Aids,window=_blank]
...
Jump to xref:hardware:CH42_Powered_Armour.adoc[Powered Armour,window=_blank].
...
Powered Shield::
A powered shield is an attachment for an upper limb of xref:hardware:CH42_Powered_Armour.adoc[Powered Armour,window=_blank].
...
The accessories for a powered shield are generated at xref:hardware:CH42_Powered_Armour.adoc#_upper_limbs[Upper Limbs,window=_blank].
