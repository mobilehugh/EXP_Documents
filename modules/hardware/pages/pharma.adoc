...
Make a jump over to xref:hardware:appearance.adoc#_colour_your_whirled[Colour,window=_blank, rel="noopener noreferrer"].
...
Jump to xref:wetware:psionics.adoc#_mutation_type[Psionic Mutations,window=_blank, rel="noopener noreferrer"] to generate a fresh new mutation. 
...
Jump to xref:wetware:phenomics.adoc[Phenomic Mutations,window=_blank, rel="noopener noreferrer"] to generate the mutation.
...
If a pharmacologic impasse arises the players  should consult the xref:uncombat:sphincter_rolls.adoc[Sphincter Roll,window=_blank, rel="noopener noreferrer"].
...
An alien metabolism type would create a limb that resembles an xref:aliens:alien_shape.adoc#_terrain_types[Alien Body Part,window=_blank, rel="noopener noreferrer"].
