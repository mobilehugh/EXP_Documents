...
== Vocation Equipment
Vocation equipment is what a persona needs to carry out her vocation skills and tasks.
...
For all the gore preventing details jump to xref:combat:defence_rating.adoc[Defence Rating,window=_blank, rel="noopener noreferrer"].
