...
An antimat pistol launches a microparticle of antimatter suspended in a lattice of electrons.
...
:date: 2016-2021
:license: Copyright JEShields Stock Art. jeshields.com
:description: Pisto with magazine, scope, stock and extended barrel.
