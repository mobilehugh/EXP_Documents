...
To determine the right device or gadget jump to xref:hardware:devices.adoc#_generate_type[Device,window=_blank].
...
To determine the device equipment jump to xref:hardware:devices.adoc#_generate_type[Devices,window=_blank].
...
To determine the device jump to xref:hardware:devices.adoc#_generate_type[Devices,window=_blank].
