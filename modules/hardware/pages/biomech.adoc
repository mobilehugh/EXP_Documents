...
:art: powered_amour_puppy.png
:width: 450px
:snark: In dog we trust.
:artist: aimage. Dolly 3. prompt HM 
:date: 2024
:license: CC BY-SA 4.0
:description: Humanoid in biomech armour suit kneeling over and engaging skinny dog on leash.
include::ROOT:partial$articulate.adoc[]

// todo must create a base explanation of AR, R, Wate etc. 
...
The persona's jump distance is five times further than her usual xref:combat:move_in_combat.adoc#_jumping[Jump,window=_blank]. 
...
If this is a random accessory jump to xref:hardware:CH48_Misc_Equip.adoc#_communicators[Communicators,window=_blank].

Aerosol::
An aerosol attack can be spray from the biomech armour's helmet.
There will be 1-12 (1d12) aerosol charges available.
To determine the aerosol type jump to xref:hardware:aerosols.adoc#_generate_type[Aerosols,window=_blank].
...
To determine the *pistol* type jump to xref:hardware:CH46_Guns.adoc#_gun_type[Guns,window=_blank].
...
To determine the light piece of miscellaneous equipment jump to xref:hardware:CH48_Misc_Equip.adoc#_miscellaneous_equipment_type[Device,window=_blank].
...
To determine the type of scope jump over to xref:hardware:CH48_Misc_Equip.adoc#_scopes[Scopes,window=_blank].
...
If this vizaud is a random accessory, jump to xref:hardware:CH48_Misc_Equip.adoc#_visual_aids[Visual Aids,window=_blank].
...
Generate the random detector by jumping to xref:hardware:CH48_Misc_Equip.adoc#_detectors[Detectors,window=_blank].
...
Miscellaneous equipment is the most diverse accessory found in the biomech armour's arm.
...
To determine the miscellaneous equipment jump to xref:hardware:CH48_Misc_Equip.adoc#_miscellaneous_equipment_type[Miscellaneous Equipment,window=_blank].
...
Veterinarian equipment is rolled in xref:hardware:CH47_Medical.adoc#_veterinary_equipment_type[Biorepair,window=_blank].
...
To generate the artillery piece jump to xref:hardware:artillery.adoc#_artillery_type[Artillery,window=_blank].
...
If the bomb does not have a missile, the persona gets a 1-3 (1d3) increase to their Mind. To generate the bomb type jump to xref:hardware:CH44_Bombs.adoc#_bomb_type[Bombs].
...
For further communication accessories jump to xref:hardware:CH48_Misc_Equip.adoc#_communicators[Communicators,window=_blank].
...
To generate the computer equipment jump to xref:hardware:CH48_Misc_Equip.adoc#_computers[Computers,window=_blank].
...
Energy weapons have an unlimited power supply from the armour's power plant.
To determine the rifle type jump to xref:hardware:CH46_Guns.adoc#_gun_type[Guns,window=_blank].
...
There is no wate restriction on miscellaneous equipment on the body of biomech armour.
To determine the miscellaneous equipment jump to xref:hardware:CH48_Misc_Equip.adoc#_miscellaneous_equipment_type[Miscellaneous Equipment,window=_blank].
...
xref:uncombat:encumbrance.adoc[Encumbrance,window=_blank]

Biorepair Equipment:: 
This biomech armour has a built-in veterinary artifact built into its body.
Veterinarian equipment is rolled in xref:hardware:CH47_Medical.adoc#_veterinary_equipment_type[Vet Equipment,window=_blank].
...
Motorized movement allows the exoskeleton to run away at triple xref:anthros:movement_rate.adoc[Movement Rate,window=_blank] rate and not less than 15 hexes per unit.
