...
Veterinarian equipment is rolled in xref:hardware:biorepair.adoc#_veterinary_equipment_type[Biorepair,window=_blank].
...
Veterinarian equipment is rolled in xref:hardware:biorepair.adoc#_veterinary_equipment_type[Vet Equipment,window=_blank].
