...
If this is a random accessory jump to xref:hardware:devices.adoc#_communicators[Communicators,window=_blank].
...
To determine the light piece of miscellaneous equipment jump to xref:hardware:devices.adoc#_miscellaneous_equipment_type[Device,window=_blank].
...
To determine the type of scope jump over to xref:hardware:devices.adoc#_scopes[Scopes,window=_blank].
...
If this vizaud is a random accessory, jump to xref:hardware:devices.adoc#_visual_aids[Visual Aids,window=_blank].
...
Generate the random detector by jumping to xref:hardware:devices.adoc#_detectors[Detectors,window=_blank].
...
To determine the miscellaneous equipment jump to xref:hardware:devices.adoc#_miscellaneous_equipment_type[Miscellaneous Equipment,window=_blank].
...
For further communication accessories jump to xref:hardware:devices.adoc#_communicators[Communicators,window=_blank].
...
To generate the computer equipment jump to xref:hardware:devices.adoc#_computers[Computers,window=_blank].
