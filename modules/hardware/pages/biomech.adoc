...
== Helmet
Head accessories are baked-in parts of biomech armour's helmet.
...
Communication:: 
Head communications have a range of 10 kilometres and can only with other biomech armour radios.
