...
. <<_miscellaneous_equipment_parameters,Miscellaneous Equipment Parameters>>
...
If the pack were disabled for 14 units there would be a 14% chance of the backpack's anti grav unit being xref:roll_playing_system:combat:breaking_things.adoc#_extent_of_damage[damaged,window=_blank].
...
To fabricate an AI, jump to xref:wetware:CH69_AI.adoc[Autonomous Intelligence,window=_blank].
...
Jump to xref:roll_playing_system:CH16_Special_Rolls_Critical.adoc#_critical_hit[Critical Hits,window=_blank].
