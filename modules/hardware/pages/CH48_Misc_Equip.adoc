...
If the pack were disabled for 14 units there would be a 14% chance of the backpack's anti grav unit being xref:roll_playing_system:CH21_Artifact_Damage.adoc#_extent_of_damage[damaged,window=_blank].
