...
The Kirlian Talisman is a concentration symbol employed by xref:roll_playing_system:CH08_Vocations_Knite.adoc[Knite Vocation,window=_blank].
...
These rooms are not in the physical space but may exist in the interstitium of physical space (aka xref:appendices:Appy_C_Mythos_Generic.adoc#_the_spaces[hyperspace,window=_blank]).
