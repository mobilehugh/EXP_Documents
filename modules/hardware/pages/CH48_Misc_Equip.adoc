...
This artifact doubles the parameters of non-combat mutation effects.
A non-combat mutation with a range of 10 hexes would have a range of 20 hexes.
...
The unique ability of the scope works in non-combat situations.
