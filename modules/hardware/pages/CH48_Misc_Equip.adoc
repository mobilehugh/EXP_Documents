...
If the pack were disabled for 14 units there would be a 14% chance of the backpack's anti grav unit being xref:combat:breaking_things.adoc#_extent[damaged,window=_blank].
