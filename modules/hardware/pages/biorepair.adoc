...
This mutation can be a xref:wetware:CH59_Physical.adoc#_combat_mutations[Phenomic Combat Mutation,window=_blank], or a xref:wetware:CH59_Physical.adoc#_non_combat_mutations[Phenomic Uncombat Mutation,window=_blank].
...
A pharma box fabricates pharmaceuticals like a pharmacy in a drum.
The box comes with a random and limited list of supplies.
There is no limit to the number of pharmaceuticals the pharma box can learn.
The pharma box does *not* analyze and copy pharma.
The pharma box is not a pharmaceutical photocopier. 
