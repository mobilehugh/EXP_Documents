...
Irrationalities in EXP are roleplay irritations and not mundane terran mental illnesses.
...
The must roll against a mind attack of 42 or suffer a xref:wetware:psionics.adoc#_defective_mutations[Defective Psionic Mutation,window=_blank].
The competency of the veterinarian can be subtracted from the target roll, however the challenge cannot be less than 12. 
