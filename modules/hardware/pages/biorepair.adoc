...
While other artifacts require an entire xref:uncombat:task_rolls.adoc#_research_teams[Research Teams,window=_blank, rel="noopener noreferrer"].
...
If there is a dispute whether a mutation is a freak of nature or an evolutionary trait, consult the xref:uncombat:sphincter_rolls.adoc[Sphincter Roll,window=_blank, rel="noopener noreferrer"].
...
Working around a phenomic mutation is a normal (42) task, and working around a psionic mutation is a tough (126) task.
If a vet wanted to eliminate a mutant's pus-producing organ while retaining her symbiotic attachment, the player must win a normal (42) task roll.
...
Whether the beam works on a robot with computer virus requires xref:uncombat:sphincter_rolls.adoc[Sphincter Roll,window=_blank, rel="noopener noreferrer"].
...
Attaching a basic unit is a hard (100) task.
Reasons for failure could be sizing, anthro type or technique.
If there is any questions about limb sizing or matching consult the xref:uncombat:sphincter_rolls.adoc[Sphincter Roll,window=_blank, rel="noopener noreferrer"].
...
This mutation can be a xref:wetware:phenomics.adoc#_combat_mutations[Phenomic Combat Mutation,window=_blank, rel="noopener noreferrer"], or a xref:wetware:phenomics.adoc#_non_combat_mutations[Phenomic Uncombat Mutation,window=_blank, rel="noopener noreferrer"].
...
The organs can come from tissue culture vats, harvested from clones, criminals, or alien life forms.
...
Typically, the biorganic replacement will be a basic unit requiring surgical insertion by a veterinarian.
Inserting a basic replacement is a tough (126) difficulty task and may require a surgical theatre.

25% of the time, the biorganic replacement will be a luxury unit that is self-inserting.
The luxury unit still requires a veterinarian, but success is guaranteed and requires not operating theatre.
The value of a biorganic replacement is ten times that of a basic unit.

The tech level of a biorganic replacement improves the likelihood of insertion and luxuriousness.
The referee may add the tech level to the chance that the replacement is a luxury unit.
The player may add the tech level of the replacement to her 
...
The persona's skin functions the same as a xref:hardware:armour#_civilian[Civilian Vac Suit,window=_blank, rel="noopener noreferrer"]. 
...
Cerebro conversion is a dangerous procedure for the personas, players and the referee.
...
==== Receiver Rejection
The donor consciousness is being forced into the receiver's brain. 
The receiver consciousness is fighting for its existence.
The more powerful the receiver's consciousness, the more difficult it is to wipe.
It is possible that receiver consciousness may be too powerful to be cerebro converted.

Receiver rejection is a modified attribute challenge that the donor consciousness must win.

==== Overcoming Rejection
.Donor (INT + MND + 1d20) > Receiver (INT + MND + LVL)
****
Donor with 10 INT and 10 MND versus 5th level receiver with 10 INT and 10 MND +
Donor must roll 5 or higher on the 1d20 or the conversion fails. 
****

==== Task Roll
For the cerebral conversion to be a success,  a vet must win a task roll.
A cerebro converter can assist any veterinarian in other cerebral task rolls.
The cerebro converter may be used to remove a bad memory, or insert a piece of knowledge. 
It is strongly recommended to build a xref:uncombat:task_rolls.adoc#_research_teams[Research Team,window=_blank, rel="noopener noreferrer"] when using a cerebro converter.

The difficulty of the task roll depends the type of cerebro conversion the vet is doing.
A typical cerebro converter will be tech level ten.
Transferring a donor to another anthro is tough difficulty (126), and unethical.
Transferring a donor into storage (organic or inorganic) is impossible difficulty (168).

.*Tech Level Converter Bonus*
* TL < 10: +30
* TL 10 - 19: +40 to +49 (20 + TL) 
* TL 20 - 25: +70 to +80 (20 + TL + TL

==== Malfunction Roll
The cerebro converter has a chance of breaking down under the duress of a conversion.
The chance of machine failure and damage is 1% and if the player rolls 42 on a 1d100 the converter has suffered a malfunction
Jump to xref:combat:equipment_damage.adoc#_extent[Equipment Damage,window=_blank, rel="noopener noreferrer"]. 
If the machine suffers critical damage or is destroyed, the conversion is a failure.

==== Failures 
A cerebro conversion failure can lead to adverse effects like insanity and death.
A failure at any step (donation, task or malfunction) prevents conversion.
A conversion failure may result in a adverse effect. 

If the donation fails, the veterinarian must win her task roll to prevent a adverse effect.
If the machine malfunctions, the mechanic must win her task roll to prevent a adverse effect.

If the donation was successful, but the vet lost her task roll, there is no adverse effect.
If the donation was successful, but there was a machine malfunction, there is a adverse effect.
...
Death is the most dangerous possible adverse effect of the cerebro converter.
The player of the donor consciousness must win against a mind attack of 42 or die.
The competency of the veterinarian can be subtracted from the target roll, however the challenge cannot be less than 12. 
If the player fails the roll, the cerebro converter creates one vegetative husk and one lifeless husk.
...
Jump to xref:referee_personas:anthro_rp.adoc#_introverted[mild irrationality,window=_blank, rel="noopener noreferrer"] for some inspiration.
...
The player of the donor consciousness must win against a mind attack of 42 or be mind wiped
The competency of the veterinarian can be subtracted from the target roll, however the challenge cannot be less than 12. 
...
The must roll against a mind attack of 42 or suffer a xref:wetware:psionics.adoc#_defective_mutations[Defective Psionic Mutation,window=_blank, rel="noopener noreferrer"].
The competency of the veterinarian can be subtracted from the target roll, however the challenge cannot be less than 12. 
A more generous referee will allow the player to roll a psionic (no defective) mutation for her persona. 
Abuse of this malfunction will eventually lead to psionic defects.
...
There are references to the tech level of the cloning equipment. 
Any tech level less than 10 is low tech, and any tech level greater than 15 is high tech. 
...
==== Task Roll
For cloning to be a success, the player must win a task roll.
The biologist has a cloning skill with a bizarre difficulty of 210.
When using cloning equipment the player gets a bonus that depends it's tech level.
Low tech cloning equipment (TL < 10) can only add the stated +20 to the roll.
Better than low tech cloning equipment (TL > 9) can add their tech level to roll as well.
If the tech level is greater than 19 the tech level can be added twice to roll 

.*Tech Level Cloning Bonus*
* TL < 10: +20
* TL 10 - 19: +30 to +39 (20 + TL) 
* TL 20 - 25: +60 to +70 (20 + TL + TL)

It is strongly recommended to build a xref:uncombat:task_rolls.adoc#_research_teams[Research Team,window=_blank, rel="noopener noreferrer"] when using cloning equipment.

==== Cloning Duration
The cloning process takes less time the higher the tech level.
Low tech cloning may take months to brew up a clone.
Normal tech (TL 10 - 15) takes weeks to complete the clone.
Super high tech cloning may take days. 
Formerly there was a terran biblical minimum of 7 days to make a clone.

Artificially speeding up the cloning process increases the chance of failure.
If the players want to speed clone they can transfer the bonus for speed. 
So the time to clone can be halved if they half their cloning equipment bonus. 


==== Malfunction Roll
The cloning equipment has a chance of breaking down under the complex process of cloning.
The chance of machine failure is 1%.
If the player rolls a 42 on 1d100 the cloning equipment has malfunctioned.
Jump to xref:combat:equipment_damage.adoc#_extent[Equipment Damage,window=_blank, rel="noopener noreferrer"]. 
...
[horizontal]
Duration:: Power Source
Bonuses:: +30 on all vet task rolls
Wate:: 55kg
EXPS:: 3000
Value:: 950000
...
A patient that has been dead for 6 hours would have to beat a 6 DD task roll.
Each day is another 24 DD for the task roll. 
Clearly personas that have been long deceased cannot be resurrected with the life ray. 
...
Bonuses:: +25 on pharma task rolls
Wate:: 10kg + Battery
EXPS:: 250
Value:: 50000
...
The bonus offered on task rolls increases with the tech level of the pharma analyzer.

.*Tech Level Pharma Bonus*
* TL < 10: +20
* TL 10 - 19: +30 to +39 (20 + TL) 
* TL 20 - 25: +60 to +70 (20 + TL + TL)
...
The preventing adverse effects has a difficulty equal to the chance of an adverse effect.
For example, fabricating an altergenic without adverse effect would be difficulty 42.
...
Jump to xref:roll_playing_system:families.adoc[Families,window=_blank, rel="noopener noreferrer"] for more info.
...
Creating a poison box would require a research team and is normal (24) difficulty task roll. 
...
The mutant can defend against the intrusion by winning a mind roll against the competency of the veterinarian.
The probing takes 1 to 100 units of melodramatic agony.
If the mutant fails their mind roll, the veterinarian must still win a task roll.
To detect psionic mutations is easy (24) difficulty.
To diagnose a psionic mutation is hard (84) difficulty. 
A biologist can use this device as well, but suffers a +20 increase in the difficulty score. 
...
The difficulty of the task roll is determined by the skill being attempted. 
The rejuv chamber will make the likelihood of success much higher. 

.*Tech Level Rejuv Chamber Bonus*
* TL < 10: +42
* TL 10 - 19: +52 to +61 (20 + TL) 
* TL 20 - 25: +82 to +92 (20 + TL + TL)

If the player fails the task roll the rejuv chamber will forge ahead and complete the task. 
The device moves flesh around instead of creating new tissue; essentially robbing Peter to pay Paul. 
Essentially any persona can use a rejuv chamber but there is an attribute cost to do so. 
The attribute reduced is randomly determined.

include::hardware:partial$rejuv_chamber_attribute_cost.adoc[]

Only treatments that require the restoration of points (HPS, attributes) will eat an attribute.
...
Treatment duration depends on what helps the story best. 
...
The player must win an easy (24) task roll or the contents rapidly spoil. 
...
The quick fix is a temporary healing skill best done by veterinarians.
...
Using a vedi wrap successfully is automatic. 
However getting multiple uses out of vedi wrap is a veterinarian task.
A veterinarian can extend a vedi wrap to cover multiple wounds allowing one vedi wrap multiple uses.
The first re-use is easy (24), second re-use is normal (42), third re-use is hard (84) and so on.

Veterinarians can transform a vedi wrap to heal different injury types.
A thermal burn vedi wrap could heal a chemical burn.
This a normal (42) task roll, but this wrap cannot be re-used.
...
Vets enjoy a +42 bonus on any acute care task rolls (quick fixes, poison cures, etc.).
