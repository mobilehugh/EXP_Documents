...
To avoid being stunned, the player must win a xref:anthros:generate_hit_points.adoc#_damage_system_shock[Damage System Shock,window=_blank] roll (anthros only).
