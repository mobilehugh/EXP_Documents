...
For a discussion of full auto (flotto) attacks jump to xref:roll_playing_system:CH28_Weapons.adoc#_type_f_attacks[Flotto Attacks,window=_blank].
...
For more info about radiation attacks jump to xref:roll_playing_system:CH16_Special_Rolls_Saves.adoc#_radiation_attacks[Radiation Attacks,window=_blank].
