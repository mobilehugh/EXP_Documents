...
The player makes 5 attack rolls in one unit.
...
To be able to operate artillery the persona must make a successful Performance Table* *roll to understand the device, aim it, and then make a attack roll.
