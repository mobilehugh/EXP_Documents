...
For a discussion of full auto (flotto) attacks jump to xref:i-roll_playing_rules:CH28_Weapons.adoc#_type_f_attacks[Flotto Attacks,window=_blank].
...
Weapon Type:: Shoot, Shoot-2, Shoot-3
Range:: 1250h (13h)
Area of Effect:: 2-12h (2d6)
Damage:: 15-150 (15d10)
Magazine:: 6 per Battery
