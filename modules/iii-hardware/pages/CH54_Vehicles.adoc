...
For more info about fuel jump to the generic mythos -> xref:vi-appendices:Appy_C_Campaign_Mythos.adoc#_energy_and_power[Energy and Power,window=_blank].
...
****
Rolling 6 and 4 gives adaptability +2. +8 on the mechanic's maneuver roll.
****
