...
The referee and players can consult xref:roll_playing_system:CH36_Hit_Locations.adoc[Hit Locations,window=_blank] to determine what horror transpires.
...
For help with amputation location jump to with xref:roll_playing_system:CH36_Hit_Locations.adoc[Hit Locations,window=_blank].
...
==== Kirlian Focus Tool
A solid lite sabre is the preferred xref:roll_playing_system:CH08_Vocations_Knite.adoc[Knite's,window=_blank]  weapon.
...
For more info about temporal attacks jump to xref:roll_playing_system:CH13_Health.adoc#_aging[Aging,window=_blank].
...
Jump here for the gory details of xref:roll_playing_system:CH28_Weapons.adoc[Attack Types,window=_blank]
