...
include::ROOT:partial$CH49_Table_lite_Saber_Type.adoc[]
...
The spinning wheel of death must be cranked for 4 units before it can be launched.
...
The handle will burrow for 2-5 units, inflicting 4-40 (4d10) hit points of damage each unit.
When the bulk of the wheel (the venetian blind-like slats) hits the target, the victim takes an additional 10-100 (10d10) HPS of damage.
Only then will the wheel grind to a halt.
Once it has stopped spinning the flying wheel can be recovered, cleaned off and used again.
Hit location makes no difference to the damage, but survival may be dependent on this.
Referee personas, except Canon Referee Personas, are automatically killed by this weapon.
...
The garotte will amputate whatever appendage it is wrapped around in a further 1-4 units.
...
// insert updated weapon type descriptions
