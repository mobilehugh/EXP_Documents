...
Miscellaneous weapons are the unique high tech weapons that do not fit into typical weapon types.
...
When its lid is opened everything within a 1 hex radius will be sucked into oblivion. 
The containment device disappears on activation but is unharmed.

disappearing like spiraling pieces of light.
...
When the hole is contained in the barbecue shaped super gravulator, it can be moved safely at 2 h/u.
