...
For example an ambushed robot or suit of powered armour would only get one to hit roll to inflict 3d10 damage, but an incapacitated robot or immobilized powered armour could be cut to shreds.
...
The dehydrator straddles the edge of sciency fiction and science fantasy.
