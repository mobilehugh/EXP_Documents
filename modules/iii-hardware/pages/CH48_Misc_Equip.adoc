...
This artifact does not change the persona's mental strength attribute.
...
The persona increases her mental strength by 50% when making mental attacks.
For psionic defence, the headband doubles the persona's MSTR.
