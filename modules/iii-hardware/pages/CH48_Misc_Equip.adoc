...
The player's attack roll plus the attack bonus can exceed the persona's maximum roll (MR).
...
For Type A attacks, the range extender allows the weapon to make a Type B attack with a range of PSTR in hexes.
