...
A failed organic object will acquire 0-3 (1d4-1) xref:v-wetware:CH59_Physical.adoc#_defective_mutations[Defective Phenomic Mutations,window=_blank].
...
These rooms are not in the physical space but may exist in the interstitium of physical space (aka xref:vi-appendices:Appy_C_Mythos_Generic.adoc#_the_spaces[hyperspace,window=_blank]).
...
A tesseract box can be fitted with a xref:iii-hardware:CH52_Space_Vehicle.adoc#_special_drives[Special Drive,window=_blank].
