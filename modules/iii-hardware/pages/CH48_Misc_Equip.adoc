...
The player must win a Type A attack with the override to inject the override coding.
...
The player must win a Type C attack with the override to inject the override coding.
For docile, non-evasive, robots there is no need for the attack roll.
...
For Type A attacks, the range extender allows the weapon to make a Type B attack with a range of STR in hexes.
