...
This device has a 10 hex radius.
...
Robots::
If this device is used there is a 50% chance that the next encounter will be robotic.
...
This attractors' value is triple the listed value at 100 000.

Communications::
Any electromagnetic waves transporting data that travel within the 5 kilometer radius of this black box will be redirected towards the device.
...
Aliens::
When this device is used, there is a 50% chance that the next encounter will be of the specified type.
...
Energy::
Any energy weapon's projectile that passes through this artifact's 10 hex radius of effect will have a 50% chance of being redirected towards the energy attractor.
...
Lazers::
Any lazer projectile that passes within the 10 hex radius of the attractor will have a 50% chance of diverting towards the attractor.
...
Projectiles::
Projectiles flying within the 10 hex radius of the attractor have 50% chance of changing direction towards the attractor.
...
The computerized, automated, robotic lock pick is designed to unlock mechanical locks.
The auto lock pick does not damage the lock or door, and avoids tripping alarms.
