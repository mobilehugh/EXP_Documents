...
xref:roll_playing_system:CH21_Artifact_Damage.adoc#_extent_of_damage[damage,window=_blank] 
...
Consult the xref:roll_playing_system:CH16_Special_Rolls_Asshole.adoc[Sphincter Dice,window=_blank] to determine if a particular attempt to destroy the web works. 
