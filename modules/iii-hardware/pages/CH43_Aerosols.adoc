...
The player attacking makes a  xref:roll_playing_system:CH16_Special_Rolls_Asshole.adoc[Sphincter Roll,window=_blank] to determine the aerosol's effect.
If the player wins the sphincter roll the artifact suffers a xref:roll_playing_system:CH21_Artifact_Damage.adoc#_extent_of_damage[Equipment Damage,window=_blank] to determine the extent of damage.
...
== Aerosol Parameters
For details on the special elements of aerosol combat jump to xref:roll_playing_system:CH30_Area_of_Effect_Weapons.adoc#_aerosols[Aerosol Combat,window=_blank].
