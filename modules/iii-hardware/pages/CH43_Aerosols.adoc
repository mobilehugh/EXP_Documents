...
:description: Drawing of aerosol melting away a humanoid face.
...
To get a simple or zany colour jump to xref:iv-software:CH55_Appearances.adoc#_colour_your_whirled[Colour].
...
To generate the colour jump to xref:iv-software:CH55_Appearances.adoc#_colour_your_whirled[Colour].
...
Jump to xref:iv-software:CH55_Appearances.adoc#_colour_your_whirled[Colour] to generate a colour of string. 
