...
. <<_aerosol_parameters,Aerosol Parameters>>
...
The player attacking makes a  xref:i-roll_playing_rules:CH16_Special_Rolls_Asshole.adoc[Sphincter Roll,window=_blank] to determine the aerosol's effect.
If the player wins the sphincter roll the artifact suffers a xref:i-roll_playing_rules:CH21_Artifact_Damage.adoc#_extent_of_damage[Equipment Damage,window=_blank] to determine the extent of damage.
...
To get a simple or zany colour jump to xref:iv-software:CH55_Appearances.adoc#_colour_your_whirled[Colour,window=_blank].
...
Take a little trip over to xref:iii-hardware:CH50_Pharmaceuticals.adoc#_pharmaceutical_type[pharmaceuticals,window=_blank] 
...
To generate the colour jump to xref:iv-software:CH55_Appearances.adoc#_colour_your_whirled[Colour,window=_blank].
...
Jump to xref:iv-software:CH55_Appearances.adoc#_colour_your_whirled[Colour,window=_blank] to generate a colour of string. 
...
Each pack of aerosols will have a distinctive cannister xref:iv-software:CH55_Appearances.adoc#_colour_your_whirled[Colour,window=_blank].

Aside from their distinct colouring, aerosols lack labelling and safety information.

== Aerosol Parameters
For details on the special elements of aerosol combat jump to xref:i-roll_playing_rules:CH30_Area_of_Effect_Weapons.adoc#_aerosols[Aerosol Combat,window=_blank].
