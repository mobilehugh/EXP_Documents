...
Insanities in EXP are persona task irritations and not mundane terran mental illnesses.
...
The degree of difficulty for the task roll depends on the tech level of the drug analyzer.
