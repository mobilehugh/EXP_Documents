...
Treatments take place over 1-4 (1d4) days
...
If there is a dispute brewing over whether the anti-mutation beam is appropriate, or not, consult the http://expgame.com/?page_id=275sphincter-dice[sphincter dice], as described in chapter 16, Special Rolls.
...
If the tourniquet is improperly placed (e.g., around an anthros neck) safety mechanisms will ensure that it disconnects itself.
...
Sizing and limb type is determined by the the http://expgame.com/?page_id=275sphincter-dice[sphincter dice].
