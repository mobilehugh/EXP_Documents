...
AWE, CHA, CON, DEX, STR and HPS remain the same.
...
AWE, CHA, CON, DEX, INT, STR and HPS maximum will lose 0 to 3 points (d4-1).
...
The rejuv chamber can repair AWE, CHA CON, DEX, STR and HPS Total.
The rejuv chamber cannot repair INT, MND or HPS Max. 
...
It attacks as a type A weapon but has no STR bonus.
