...
Jump to xref:v-wetware:CH58_Mental.adoc#_mutation_type[Psionic Mutations]  
...
The persona must win a mental attack roll or suffer a xref:v-wetware:CH58_Mental.adoc#_defective_mutations[Defective Psionic Mutation,window=_blank].
...
AWE, CHA, CON, DEX, INT, STR and HPMimum will lose 0 to 3 points (d4-1).
...
There is one light for physical mutations and one light for psionic mutations.
...
The box is an elaborate detector that will betray the presence of any psionic mutations (but not physical mutations) or manipulations of a psionic nature.
