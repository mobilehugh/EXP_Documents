...
Regardless of the special drive type, the vessel travels through xref:vi-appendices:Appy_C_Mythos_Generic.adoc#_the_spaces[hyperspace,window=_blank].. 
...
For more information about fuel and energy jump to the generic mythos section -> xref:vi-appendices:Appy_C_Mythos_Generic.adoc#_energy_and_power[Energy and Power,window=_blank].
...
A software package may physically bolt onto the space vehicles or be auto-downloaded from https://github.com/misterquetoo/EXP_Documents[GitHub].
...
Ship repair and maintenance performance rolls get a bonus of +5 per level of the ship's computer.
...
Life support, gravity, armour rating, hull and shield (if present) are all part of the <<_life_support_onion,Life Support Onion>>.
...
=== Armour Rating 
The armour rating indicates the strength of the space vehicle's hull.
The armour rating is in addition to the shape and structure that the hull offers. 
The hull and armour rating have an intimate relationship.
The armour rating protects the hull and makes its appearance as the hull strength during hull creation.

The armour rating of the hull determines the structural resilience of the hull during combat. 
Attack rolls must be higher than the hull's armour rating to damage the vessel.
Damage reduces armour rating.
Once the armour rating drops to 420, it no longer protects the hull.

The armour rating is a component of the life support system.
Life support, gravity, armour rating, hull and shield (if present) are all part of the <<_life_support_onion,Life Support Onion>>.
...
=== Shields
The shields protect the hull armour rating from energy and kinetic attacks.
...
To create the airlock gun jump to xref:iii-hardware:CH46_Guns.adoc#_gun_type[Guns,window=_blank]
...
For more information about vac suits jump xref:iii-hardware:CH42_Armour.adoc#_vac_suit[Vac Suits,window=_blank].
...
The spacecruiser has 100 tonnes displacement, armour rating of 700, exatmo drive 10, fuel level 5, computer level 4
