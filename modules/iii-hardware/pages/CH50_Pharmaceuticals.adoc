...
Trauma::
This cure removes any abnormal decreases to the patient's hit point maximum (HPM or HPS Max).
If there is no injury to the persona's hit points max, the patient's hit point max increases by 10%
Each time a trauma cure increases the patient's HPS Max, the cure's safety level halves.
...
If a pharmacologic impasse arises the players should consult the xref:i-roll_playing_rules:CH16_Special_Rolls_Asshole.adoc[Sphincter Dice,window=_blank].
...
An alien metabolism type would create a limb that resembles an xref:i-roll_playing_rules:CH06_Aliens_8_Shape.adoc#_terrain_types[Alien Body Part,window=_blank].
...
Narcotics temporarily impair the persona's awareness, dexterity, intelligence and mental strength attributes.
For the duration of the impairment, the persona's AWE, DEX, and INT drop by 1-6 (1d6) points, and her mental strength drops by half.
...
==== Hit Points
Healing pharma instantly improves the persona's hit point total (HPS Total) but does not affect the maximum hit point (HPS Max).
...
A patient with 50 HPS Max taking a 50% heal jumps right to 25 HPS Total.
...
This pharmaceutical gives the persona a permanent mental or physical mutation.
...
Mental::
The persona has acquired a mental mutation.
...
Jump to xref:v-wetware:CH58_Mental.adoc#_mutation_type[Mental Mutations,window=_blank] to generate a fresh new mutation. 
*This mutation cannot be a defect.*

Physical::
The persona has acquired a physical mutation.
The physical mutation will take a few nights of sleep to grow in.
The mutation's growth can be itchy, painful or unseemly.
Jump to xref:v-wetware:CH59_Physical.adoc[Physical Mutations,window=_blank] to generate the mutation.
...
This pharmaceutical gives the persona a temporary mental or physical mutation effect.
The persona transiently acquires either a physical or mental mutation.
...
Mental::
The persona has acquired a mental mutation effect.
...
Physical::
The persona has acquired a physical mutation effect.
The physical mutation violently explodes out of the persona's body.
The process is painful and unseemly.
Jump to xref:v-wetware:CH59_Physical.adoc[Physical Mutations,window=_blank] to generate the mutation.
*This mutation cannot be a defect.*
When the duration ends, the physical mutation withers away and falls off.
...
For example, a physical strength increase would require a strength training regimen or may suddenly appear in a life or death PSTR test.
...
The player can determine the pharmaceutical's effect by winning a vet performance roll.
