...
For a discussion of full auto (flotto) attacks jump to xref:i-roll_playing_rules:CH28_Weapons.adoc#_type_f_attacks[Flotto Attacks].
...
For all the deets jump to xref:i-roll_playing_rules:CH28_Weapons.adoc[Attack Types,window=_blank].
