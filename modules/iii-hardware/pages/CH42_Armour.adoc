...
Communication:: 
The communication device is generated at xref:iii-hardware:CH48_Misc_Equip.adoc#_communicators[communicators].
...
Gun:: The weapon is rolled in  xref:iii-hardware:CH46_Guns.adoc#_gun_type[Gun], and is limited to a pistol, or a pistol version of the gun rolled.
The gun is part of the helmet, and it is triggered by the wearer's head actions.

Veterinarian Equipment:: Veterinarian equipment is rolled in xref:iii-hardware:CH47_Medical.adoc#_veterinary_equipment_type[Vet Equipment].
...
Scope:: Roll from the list of scope artifacts found in xref:iii-hardware:CH48_Misc_Equip.adoc#_scopes[Scopes].
...
Visual Aid:: Roll from the list of visual aid artifacts found in xref:iii-hardware:CH48_Misc_Equip.adoc#_visual_aids[Visual Aids]
...
Jump over to the chapter devoted to xref:iii-hardware:CH42_Powered_Armour.adoc[Powered Armour].
...
Powered Shield::
A powered shield is an attachment for an upper limb of xref:iii-hardware:CH42_Powered_Armour.adoc[Powered Armour].
...
The accessories for a powered shield are generated at xref:iii-hardware:CH42_Powered_Armour.adoc#_upper_limbs[Upper Limbs].
