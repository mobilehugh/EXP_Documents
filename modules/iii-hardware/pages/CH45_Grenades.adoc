...
A physical strength attribute roll is required if the referee feels something could fly out of a persona's grip.
...
The target's size determines its armour rating, and bigger targets are easier to hit.
The target does not use its regular combat armour rating and must use the target size AR.
The target's armour rating should decrease, which follows the spirit of grenades being area of effect attacks.
