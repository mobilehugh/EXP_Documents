...
Armour rating is covered more thoroughly in  xref:combat:defence_rating.adoc[Defence Rating,window=_blank, rel="noopener noreferrer"].
...
Body armour may exist for a species that has creator level in xref:aliens:society.adoc[Tool Usage,window=_blank, rel="noopener noreferrer"].
