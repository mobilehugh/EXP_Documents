...
=== Extreme Life Spans
If the player wishes to dabble in ages that are extremely short or extremely long jump to xref:referee_personas:alien_rp.adoc#_life_span[Life Spans,window=_blank] in Referee Personas. 
