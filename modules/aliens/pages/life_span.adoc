...
=== Extreme Life Spans
If the player wishes to dabble in ages that are extremely short or extremely long jump to xref:referee_personas:alien_rp.adoc#_life_span[Life Spans,window=_blank, rel="noopener noreferrer"] in Referee Personas. 
...
For the attribute adjustments levied for breaching life stages jump to xref:uncombat:health.adoc#_aging[Aging,window=_blank, rel="noopener noreferrer"]. 

include::aliens:partial$life_span_stages.adoc[]

== Persona Age
After all the above machinations, how old is the player's persona?
The player must choose an age from late youth to young adult. 
...
The player can choose a start age between late youth (25 years old) and young adult (40 years old). 
...
For the effects of these age changes jump to  jump to xref:uncombat:health.adoc#_aging[Aging,window=_blank, rel="noopener noreferrer"]. 
