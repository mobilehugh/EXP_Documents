...
To create a de novo coat colour jump to xref:hardware:appearance.adoc#_colour_your_whirled[Colour,window=_blank, rel="noopener noreferrer"].
...
For a detailed rendering jump to xref:aliens:movement.adoc[Alien Movement,window=_blank, rel="noopener noreferrer"].
