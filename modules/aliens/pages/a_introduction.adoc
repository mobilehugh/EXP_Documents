...
. xref:appendices:printables.adoc[Get Alien Persona Record, window=_blank, rel="noopener noreferrer"]
.. Save a tree and use https://xournalpp.github.io/[Xournal, window=_blank, rel="noopener noreferrer"]
. xref:aliens:attributes.adoc[Attributes, window=_blank, rel="noopener noreferrer"]
. xref:aliens:size.adoc[Size, window=_blank, rel="noopener noreferrer"]
. xref:aliens:hit_points_generation.adoc[Hit Points, window=_blank, rel="noopener noreferrer"]
. xref:aliens:attack_frequency.adoc[Attack Frequency, window=_blank, rel="noopener noreferrer"]
. xref:aliens:attack_type.adoc[Attack Type, window=_blank, rel="noopener noreferrer"]
. xref:aliens:attack_damage.adoc[Attack Damage, window=_blank, rel="noopener noreferrer"]
. xref:aliens:attack_table.adoc[Attack Table, window=_blank, rel="noopener noreferrer"]
. xref:aliens:defence_rating.adoc[Defence Rating, window=_blank, rel="noopener noreferrer"]
. xref:aliens:alien_shape.adoc[Shape, window=_blank, rel="noopener noreferrer"]
. xref:aliens:movement.adoc[Movement Rate, window=_blank, rel="noopener noreferrer"]
. xref:aliens:wate_allowance.adoc[Wate Allowance, window=_blank, rel="noopener noreferrer"]
. xref:aliens:evolutations.adoc[Evolutations, window=_blank, rel="noopener noreferrer"]
. xref:aliens:life_span.adoc[Life Span, window=_blank, rel="noopener noreferrer"]
. xref:aliens:biology.adoc[Biology, window=_blank, rel="noopener noreferrer"]
. xref:aliens:society.adoc[Society, window=_blank, rel="noopener noreferrer"]
. xref:aliens:tool_usage.adoc[Tool Usage, window=_blank, rel="noopener noreferrer"]
. xref:aliens:name.adoc[Name, window=_blank, rel="noopener noreferrer"]
